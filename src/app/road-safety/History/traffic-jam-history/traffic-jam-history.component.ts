...
@Component({
  selector: 'app-traffic-jam-history',
  templateUrl: './traffic-jam-history.component.html',
  styleUrls: ['./traffic-jam-history.component.css']
})
export class TrafficJamHistoryComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor(
    ...
    private webServer: TrafficJamHistoryService,
