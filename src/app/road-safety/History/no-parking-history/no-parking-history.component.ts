...
@Component({
  selector: 'app-no-parking-history',
  templateUrl: './no-parking-history.component.html',
  styleUrls: ['./no-parking-history.component.css']
})
export class NoParkingHistoryComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor(
    ...
    private webServer: NoParkingHistoryService,
