...
export class DashboardService {
  ...
  DatewiseTotalViolationsDetails(fromDate: any, toDate: any) {
    return this.http.post(this.IP + "/cam_wise_violations_count_by_date", {
      from_date: fromDate,
      to_date: toDate,
    });
  }
  ...
  DatewisePPEViolationsDetails(fromDate: any, toDate: any) {
    return this.http.post(this.IP + "/cam_wise_PPE_violations_by_date", {
      from_date: fromDate,
      to_date: toDate,
    });
  }
  ...
  DatewiseRAViolationsDetails(fromDate: any, toDate: any) {
    return this.http.post(this.IP + "/cam_wise_RA_violations_by_date", {
      from_date: fromDate,
      to_date: toDate,
    });
  }
  ...
  DatewiseCCViolationsDetails(fromDate: any, toDate: any) {
    return this.http.post(this.IP + "/cam_wise_CR_violations_by_date", {
      from_date: fromDate,
      to_date: toDate,
    });
  }
