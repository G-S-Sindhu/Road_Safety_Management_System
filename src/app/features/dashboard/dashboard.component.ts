...
export class DashboardComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    this.camerasStatusAndViolationsInterval = setInterval(() => {
      ...
      if (!this.isDatewise) {
        this.service.GetLiveViolationsCount().subscribe(
          (response: any) => {
            if (response.success) {
              if (!this.isDatewise) {
  ...
  GetLicenseDetails() {
    this.service.GetLicenseDetails().subscribe(
      (licenseDetails: any) => {
  ...
  OpenECDetailsModal(modal: any) {
    ...
    this.service.EnabledCamDetails().subscribe(
      (ECDetails: any) => {
  ...
  OpenDCDetailsModal(modal: any) {
    ...
    this.service.DisabledCamDetails().subscribe(
      (DCDetails: any) => {
  ...
  OpenNWCDetailsModal(modal: any) {
    ...
    this.service.NotWorkingCamDetails().subscribe(
      (NWCDetails: any) => {
    ...
    if (this.selectedMoments.startDate || this.selectedMoments.endDate) {
      ...
      this.service
        ...
        .subscribe(
          (datewiseViolCount: any) => {
            ...
            if (
              this.selectedMoments.startDate.date() == new Date().getDate() &&
      ...
      this.service
        .GetDatewiseViolationsCount(
          ...
          this.service.dateTransform(new Date())
        )
        .subscribe(
          (datewiseViolCount: any) => {
            if (datewiseViolCount.success) {
  ...
  OpenAllViolationsModal(modal: any) {
    ...
    if (this.isDatewise) {
      ...
      this.service.TotalViolationsDetails().subscribe(
        (totalViolDetails: any) => {
  ...
  RAViolationsModal(modal: any) {
    ...
    if (this.isDatewise) {
      this.service
        .DatewiseRAViolationsDetails(
          this.selectedMoments.startDate.format("YYYY-MM-DD HH:mm:ss"),
          this.selectedMoments.endDate.format("YYYY-MM-DD HH:mm:ss")
        )
        .subscribe(
          (datewiseRAViolDetails: any) => {
      ...
      this.service.RAViolationsDetails().subscribe(
        (RAViolDetails: any) => {
  ...
  PPEViolationsModal(modal: any) {
    ...
    if (this.isDatewise) {
      this.service
        .DatewisePPEViolationsDetails(
          this.selectedMoments.startDate.format("YYYY-MM-DD HH:mm:ss"),
          this.selectedMoments.endDate.format("YYYY-MM-DD HH:mm:ss")
        )
        .subscribe(
          (datewisePPEViolDetails: any) => {
      ...
      this.service.PPEViolationsDetails().subscribe(
        (PPEViolDetails: any) => {
  ...
  CCViolationsModal(modal: any) {
    ...
    if (this.isDatewise) {
      this.service
        .DatewiseCCViolationsDetails(
          this.selectedMoments.startDate.format("YYYY-MM-DD HH:mm:ss"),
          this.selectedMoments.endDate.format("YYYY-MM-DD HH:mm:ss")
        )
        .subscribe(
          (datewiseCCVoilDetails: any) => {
      ...
      this.service.CCViolationsDetails().subscribe(
        (CCViolDetails: any) => {
