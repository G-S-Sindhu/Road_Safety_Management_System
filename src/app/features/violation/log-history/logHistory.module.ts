...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: "Parking",
        loadChildren: () =>
          import("../parking-violations/parking-violations.module").then(
            (m) => m.ParkingViolationsModule
          ),
      },
      {
        path: "Traffic_Jam",
        loadChildren: () =>
          import("../traffic-jam-violations/traffic-jam-violations.module").then(
            (m) => m.TrafficJamViolationsModule
          ),
      },
    ],
  },
