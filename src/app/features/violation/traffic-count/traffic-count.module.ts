...
@NgModule({
    ...
    imports:[CommonModules,RouterModule.forChild(routes),NgbModule,NgChartsModule, NgxDaterangepickerMd,TabViewModule,TreeSelectModule, TreeTableModule,TableModule
  ],
