...
@Component({
  selector: 'app-traffic-jam-violations',
  templateUrl: './traffic-jam-violations.component.html',
  styleUrls: ['./traffic-jam-violations.component.css']
})
export class TrafficJamViolationsComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor(
    ...
    private webServer: TrafficJamViolationsService,
