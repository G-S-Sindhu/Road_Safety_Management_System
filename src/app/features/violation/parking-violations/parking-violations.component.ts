...
@Component({
  selector: 'app-parking-violations',
  templateUrl: './parking-violations.component.html',
  styleUrls: ['./parking-violations.component.css']
})
export class ParkingViolationsComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor(
    ...
    private webServer: ParkingViolationsService,
