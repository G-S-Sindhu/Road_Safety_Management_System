...
export class configService {
  ...
  public IP: any;
  public IP_ESI: any;
  public mech_app_start_api:any
  public socket_ip: any;
  ...
  steamDataDelay;
  checkApplicationStatusInterval:any=5000
  startEsiApi;
  logInterval;
  unplannedInterval;
  aiSolutionsList: any = {
  ...
  constructor() {
    ...
    this.socket_ip = this.config.Socket_IP;
    this.mech_app_start_api=this.config.mech_app_start_api
    ...
    this.checkApplicationStatusInterval=this.config.checkApplicationStatusInterval
  }
