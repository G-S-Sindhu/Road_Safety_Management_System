...
/*jshint ignore:start*/
(function () {
  function qa(h, m) { h.prototype = db(m.prototype); h.prototype.constructor = h; h.base = m.prototype } function db(h) { function m() { } m.prototype = h; return new m } function Wa(h, m, F) {
    "millisecond" === F ? h.setMilliseconds(h.getMilliseconds() + 1 * m) : "second" === F ? h.setSeconds(h.getSeconds() + 1 * m) : "minute" === F ? h.setMinutes(h.getMinutes() + 1 * m) : "hour" === F ? h.setHours(h.getHours() + 1 * m) : "day" === F ? h.setDate(h.getDate() + 1 * m) : "week" === F ? h.setDate(h.getDate() + 7 * m) : "month" === F ? h.setMonth(h.getMonth() + 1 * m) : "year" === F && h.setFullYear(h.getFullYear() +
      1 * m); return h
  } function ca(h, m) { var F = !1; 0 > h && (F = !0, h *= -1); h = "" + h; for (m = m ? m : 1; h.length < m;)h = "0" + h; return F ? "-" + h : h } function Ga(h) { if (!h) return h; h = h.replace(/^\s\s*/, ""); for (var m = /\s/, F = h.length; m.test(h.charAt(--F));); return h.slice(0, F + 1) } function Ca(h) {
    h.roundRect = function (h, F, r, v, sa, E, w, A) {
      w && (this.fillStyle = w); A && (this.strokeStyle = A); "undefined" === typeof sa && (sa = 5); this.lineWidth = E; this.beginPath(); this.moveTo(h + sa, F); this.lineTo(h + r - sa, F); this.quadraticCurveTo(h + r, F, h + r, F + sa); this.lineTo(h +
        r, F + v - sa); this.quadraticCurveTo(h + r, F + v, h + r - sa, F + v); this.lineTo(h + sa, F + v); this.quadraticCurveTo(h, F + v, h, F + v - sa); this.lineTo(h, F + sa); this.quadraticCurveTo(h, F, h + sa, F); this.closePath(); w && this.fill(); A && 0 < E && this.stroke()
    }
  } function Qa(h, m) { return h - m } function O(h) { var m = ((h & 16711680) >> 16).toString(16), F = ((h & 65280) >> 8).toString(16); h = ((h & 255) >> 0).toString(16); m = 2 > m.length ? "0" + m : m; F = 2 > F.length ? "0" + F : F; h = 2 > h.length ? "0" + h : h; return "#" + m + F + h } function eb(h, m) {
    var F = this.length >>> 0, r = Number(m) || 0, r = 0 > r ? Math.ceil(r) :
      Math.floor(r); for (0 > r && (r += F); r < F; r++)if (r in this && this[r] === h) return r; return -1
  } function r(h) { return null === h || "undefined" === typeof h } function Da(h) { h.indexOf || (h.indexOf = eb); return h } function fb(h) { if (U.fSDec) h[ja("`eeDwdouMhrudods")](ja("e`u`@ohl`uhnoHuds`uhnoDoe"), function () { U._fTWm && U._fTWm(h) }) } function Xa(h, m, F) {
    F = F || "normal"; var r = h + "_" + m + "_" + F, v = Ya[r]; if (isNaN(v)) {
      try {
        if (!ta) {
          var sa = document.body; ta = document.createElement("span"); ta.innerHTML = ""; var E = document.createTextNode("Mpgyi"); ta.appendChild(E);
          sa.appendChild(ta)
        } ta.style.display = ""; V(ta, { position: "absolute", left: "0px", top: "-20000px", padding: "0px", margin: "0px", border: "none", whiteSpace: "pre", lineHeight: "normal", fontFamily: h, fontSize: m + "px", fontWeight: F }); v = Math.round(ta.offsetHeight); ta.style.display = "none"
      } catch (w) { v = Math.ceil(1.1 * m) } v = Math.max(v, m); Ya[r] = v
    } return v
  } function I(h, m) {
    var F = []; if (F = {
    ...
    }[h || "solid"]) for (var r = 0; r < F.length; r++)F[r] *= m; else F = []; return F
  } function J(h, m, F, v, Y) { v = v || []; Y = r(Y) ? gb ? { passive: !1, capture: !1 } : !1 : Y; v.push([h, m, F, Y]); return h.addEventListener ? (h.addEventListener(m, F, Y), F) : h.attachEvent ? (v = function (m) { m = m || window.event; m.preventDefault = m.preventDefault || function () { m.returnValue = !1 }; m.stopPropagation = m.stopPropagation || function () { m.cancelBubble = !0 }; F.call(h, m) }, h.attachEvent("on" + m, v), v) : !1 } function hb(h) {
    if (h._menuButton) h.exportEnabled ?
      (V(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), La(h._menuButton), h._menuButton.title = h._cultureInfo.menuText) : wa(h._menuButton); else if (h.exportEnabled && v) {
        var m = !1; h._menuButton = document.createElement("button"); xa(h, h._menuButton, "menu"); h._toolBar.appendChild(h._menuButton); J(h._menuButton, "touchstart", function (h) { m = !0 }, h.allDOMEventHandlers); J(h._menuButton, "click", function () {
        ...
        position: "absolute", zIndex: 1, userSelect: "none", MozUserSeelct: "none", WebkitUserSelect: "none", msUserSelect: "none", cursor: "pointer", right: "0px", top: "25px", minWidth: "120px", outline: 0, fontSize: "14px", fontFamily: "Arial, Helvetica, sans-serif", padding: "5px 0px 5px 0px", textAlign: "left",
        lineHeight: "10px", backgroundColor: h.toolbar.itemBackgroundColor, boxShadow: "2px 2px 10px" + F
        ...
        F.innerHTML = h._cultureInfo.saveJPGText, F.style.backgroundColor = h.toolbar.itemBackgroundColor, F.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(F), J(F, "touchstart", function (h) { m = !0 }, h.allDOMEventHandlers), J(F, "mousemove", function () { m || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover) }, h.allDOMEventHandlers, !0), J(F, "mouseout", function () { m || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) },
          h.allDOMEventHandlers, !0), J(F, "click", function () { h.exportChart({ format: "jpeg", fileName: h.exportFileName }); wa(h._dropdownMenu) }, h.allDOMEventHandlers, !0), F = document.createElement("div"), V(F, { padding: "12px 8px 12px 8px" }), F.innerHTML = h._cultureInfo.savePNGText, F.style.backgroundColor = h.toolbar.itemBackgroundColor, F.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(F), J(F, "touchstart", function (h) { m = !0 }, h.allDOMEventHandlers), J(F, "mousemove", function () {
            m || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover,
              this.style.color = h.toolbar.fontColorOnHover)
          }, h.allDOMEventHandlers, !0), J(F, "mouseout", function () { m || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) }, h.allDOMEventHandlers, !0), J(F, "click", function () { h.exportChart({ format: "png", fileName: h.exportFileName }); wa(h._dropdownMenu) }, h.allDOMEventHandlers, !0))
  } function Za(h, m, F) {
    h *= la; m *= la; h = F.getImageData(h, m, 2, 2).data; m = !0; for (F = 0; 4 > F; F++)if (h[F] !== h[F + 4] | h[F] !== h[F + 8] | h[F] !== h[F + 12]) { m = !1; break } return m ?
      h[0] << 16 | h[1] << 8 | h[2] : 0
  } function ma(h, m, F) { return h in m ? m[h] : F[h] } function Ma(h, m, F) { if (v && $a) { var r = h.getContext("2d"); Na = r.webkitBackingStorePixelRatio || r.mozBackingStorePixelRatio || r.msBackingStorePixelRatio || r.oBackingStorePixelRatio || r.backingStorePixelRatio || 1; la = Ra / Na; h.width = m * la; h.height = F * la; Ra !== Na && (h.style.width = m + "px", h.style.height = F + "px", r.scale(la, la)) } else h.width = m, h.height = F } function ib(h) {
    if (!jb) {
      var m = !1, r = !1; "undefined" === typeof ra.Chart.creditHref ? (h.creditHref = ja("iuuqr;..b`ow`rkr/bnl."),
        h.creditText = ja("B`ow`rKR/bnl")) : (m = h.updateOption("creditText"), r = h.updateOption("creditHref")); if (h.creditHref && h.creditText) {
    ...
    var r = document.createElement("canvas"); r.setAttribute("class", "canvasjs-chart-canvas"); Ma(r, h, m); v || "undefined" === typeof G_vmlCanvasManager || G_vmlCanvasManager.initElement(r); return r
  } function V(h, m) { for (var r in m) h.style[r] = m[r] } function xa(h, m, r) {
    m.getAttribute("state") || (m.style.backgroundColor = h.toolbar.itemBackgroundColor, m.style.color = h.toolbar.fontColor, m.style.border = "none", V(m, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" })); m.getAttribute("state") !==
      r && (m.setAttribute("state", r), m.setAttribute("type", "button"), V(m, { padding: "5px 12px", cursor: "pointer", "float": "left", width: "40px", height: "25px", outline: "0px", verticalAlign: "baseline", lineHeight: "0" }), m.setAttribute("title", h._cultureInfo[r + "Text"]), m.innerHTML = "<img src='" + kb[r].image + "' alt='" + h._cultureInfo[r + "Text"] + "' />", V(m.childNodes[0], { height: "95%", pointerEvents: "none" }))
  } function La() { for (var h = null, m = 0; m < arguments.length; m++)h = arguments[m], h.style && (h.style.display = "inline") } function wa() {
    for (var h =
      null, m = 0; m < arguments.length; m++)(h = arguments[m]) && h.style && (h.style.display = "none")
  } function Sa(h, m, r, v, Y) { if (null === h || "undefined" === typeof h) return "undefined" === typeof r ? m : r; h = parseFloat(h.toString()) * (0 <= h.toString().indexOf("%") ? m / 100 : 1); "undefined" !== typeof v && (h = Math.min(v, h), "undefined" !== typeof Y && (h = Math.max(Y, h))); return !isNaN(h) && h <= m && 0 <= h ? h : "undefined" === typeof r ? m : r } function W(h, m, F, v, Y) {
    ...
    "undefined" ===
      typeof Y && (Y = 0); this._padding = Y; this._x1 = h; this._y1 = m; this._x2 = r; this._y2 = v; this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding
  } function ka(h, m) { ka.base.constructor.call(this, "TextBlock", null, m, null, null); this.ctx = h; this._isDirty = !0; this._wrappedText = null; this._initialize() } function Ta(h, m) { Ta.base.constructor.call(this, "Toolbar", "toolbar", m, null, h); this.chart = h; this.canvas = h.canvas; this.ctx = this.chart.ctx; this.optionsName = "toolbar" } function za(h, m) {
    ...
    this.pool =
      []
  } function Ja(h) { var m; h && Ka[h] && (m = Ka[h]); Ja.base.constructor.call(this, "CultureInfo", null, m, null, null) } var Ha = !1, U = {}, v = !!document.createElement("canvas").getContext, ra = {
    Chart: {
      ...
      enabled: !0, shared: !1, animationEnabled: !0, content: null, contentFormatter: null, reversed: !1, backgroundColor: v ? "rgba(255,255,255,.9)" : "rgb(255,255,255)", borderColor: null,
    ...
    P, ga, X, $, Z; ga = "#333333"; X = "#000000"; P = "#666666"; Z = $ = "#000000"; var ea = 20, A = 14, Va = {
      colorSet: "colorSet1", backgroundColor: "#FFFFFF", title: { fontFamily: Fa, fontSize: 32, fontColor: ga, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: Fa, fontSize: A, fontColor: ga, fontWeight: "normal", verticalAlign: "top", margin: 5 }], data: [{ indexLabelFontFamily: w, indexLabelFontSize: A, indexLabelFontColor: ga, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }], axisX: [{
        titleFontFamily: w, titleFontSize: ea, titleFontColor: ga,
        titleFontWeight: "normal", labelFontFamily: w, labelFontSize: A, labelFontColor: X, labelFontWeight: "normal", lineThickness: 1, lineColor: P, tickThickness: 1, tickColor: P, gridThickness: 0, gridColor: P, stripLines: [{ labelFontFamily: w, labelFontSize: A, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: { labelFontFamily: w, labelFontSize: A, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: Z, color: $, thickness: 1, lineDashType: "dash" }, scaleBreaks: {
          type: "zigzag",
          spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid"
        }
      }], axisX2: [{
        titleFontFamily: w, titleFontSize: ea, titleFontColor: ga, titleFontWeight: "normal", labelFontFamily: w, labelFontSize: A, labelFontColor: X, labelFontWeight: "normal", lineThickness: 1, lineColor: P, tickThickness: 1, tickColor: P, gridThickness: 0, gridColor: P, stripLines: [{ labelFontFamily: w, labelFontSize: A, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: {
          labelFontFamily: w,
          labelFontSize: A, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: Z, color: $, thickness: 1, lineDashType: "dash"
        }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
      }], axisY: [{
        titleFontFamily: w, titleFontSize: ea, titleFontColor: ga, titleFontWeight: "normal", labelFontFamily: w, labelFontSize: A, labelFontColor: X, labelFontWeight: "normal", lineThickness: 1, lineColor: P, tickThickness: 1, tickColor: P, gridThickness: 1, gridColor: P, stripLines: [{
          labelFontFamily: w,
          labelFontSize: A, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1
        }], crosshair: { labelFontFamily: w, labelFontSize: A, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: Z, color: $, thickness: 1, lineDashType: "dash" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
      }], axisY2: [{
        titleFontFamily: w, titleFontSize: ea, titleFontColor: ga, titleFontWeight: "normal", labelFontFamily: w, labelFontSize: A,
      ...
      }], legend: { fontFamily: w, fontSize: 14, fontColor: ga, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" }, toolTip: { fontFamily: w, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1 }, toolbar: { itemBackgroundColor: "white", itemBackgroundColorOnHover: "#2196f3", buttonBorderColor: "#2196f3", buttonBorderThickness: 1, fontColor: "black", fontColorOnHover: "white" }
    }; X = ga = "#F5F5F5"; P = "#FFFFFF"; $ = "#40BAF1"; Z = "#F5F5F5"; var ea = 20, A = 14, ab = {
      colorSet: "colorSet2", title: {
        fontFamily: w,
        fontSize: 33, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5
      }, subtitles: [{ fontFamily: w, fontSize: A, fontColor: "#3A3A3A", fontWeight: "normal", verticalAlign: "top", margin: 5 }], data: [{ indexLabelFontFamily: w, indexLabelFontSize: A, indexLabelFontColor: "#666666", indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }], axisX: [{
        titleFontFamily: w, titleFontSize: ea, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: w, labelFontSize: A, labelFontColor: "#666666", labelFontWeight: "normal",
        lineThickness: 1, lineColor: "#BBBBBB", tickThickness: 1, tickColor: "#BBBBBB", gridThickness: 1, gridColor: "#BBBBBB", stripLines: [{ labelFontFamily: w, labelFontSize: A, labelFontColor: "#FFA500", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FFA500", thickness: 1 }], crosshair: { labelFontFamily: w, labelFontSize: A, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black", color: "black", thickness: 1, lineDashType: "dot" }, scaleBreaks: {
          type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1,
          lineDashType: "solid"
        }
      }], axisX2: [{
        titleFontFamily: w, titleFontSize: ea, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: w, labelFontSize: A, labelFontColor: "#666666", labelFontWeight: "normal", lineThickness: 1, lineColor: "#BBBBBB", tickColor: "#BBBBBB", tickThickness: 1, gridThickness: 1, gridColor: "#BBBBBB", stripLines: [{ labelFontFamily: w, labelFontSize: A, labelFontColor: "#FFA500", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FFA500", thickness: 1 }], crosshair: {
          labelFontFamily: w, labelFontSize: A,
          labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black", color: "black", thickness: 1, lineDashType: "dot"
        }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
      }], axisY: [{
        titleFontFamily: w, titleFontSize: ea, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: w, labelFontSize: A, labelFontColor: "#666666", labelFontWeight: "normal", lineThickness: 0, lineColor: "#BBBBBB", tickColor: "#BBBBBB", tickThickness: 1, gridThickness: 1, gridColor: "#BBBBBB",
        stripLines: [{ labelFontFamily: w, labelFontSize: A, labelFontColor: "#FFA500", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FFA500", thickness: 1 }], crosshair: { labelFontFamily: w, labelFontSize: A, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black", color: "black", thickness: 1, lineDashType: "dot" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
      }], axisY2: [{
        titleFontFamily: w, titleFontSize: ea, titleFontColor: "#666666", titleFontWeight: "normal",
        ...
        scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
      }], legend: { fontFamily: w, fontSize: 14, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" }, toolTip: { fontFamily: w, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1 }, toolbar: { itemBackgroundColor: "white", itemBackgroundColorOnHover: "#2196f3", buttonBorderColor: "#2196f3", buttonBorderThickness: 1, fontColor: "black", fontColorOnHover: "white" }
    }; X = ga = "#F5F5F5"; P = "#FFFFFF";
  $ = "#40BAF1"; Z = "#F5F5F5"; ea = 20; A = 14; Fa = {
    colorSet: "colorSet12", backgroundColor: "#2A2A2A", title: { fontFamily: Fa, fontSize: 32, fontColor: ga, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: Fa, fontSize: A, fontColor: ga, fontWeight: "normal", verticalAlign: "top", margin: 5 }], toolbar: { itemBackgroundColor: "#666666", itemBackgroundColorOnHover: "#FF7372", buttonBorderColor: "#FF7372", buttonBorderThickness: 1, fontColor: "#F5F5F5", fontColorOnHover: "#F5F5F5" }, data: [{
      indexLabelFontFamily: w, indexLabelFontSize: A,
      indexLabelFontColor: X, indexLabelFontWeight: "normal", indexLabelLineThickness: 1
    }], axisX: [{
      titleFontFamily: w, titleFontSize: ea, titleFontColor: X, titleFontWeight: "normal", labelFontFamily: w, labelFontSize: A, labelFontColor: X, labelFontWeight: "normal", lineThickness: 1, lineColor: P, tickThickness: 1, tickColor: P, gridThickness: 0, gridColor: P, stripLines: [{ labelFontFamily: w, labelFontSize: A, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: {
        labelFontFamily: w,
        labelFontSize: A, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: Z, color: $, thickness: 1, lineDashType: "dash"
      }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
    }], axisX2: [{
      titleFontFamily: w, titleFontSize: ea, titleFontColor: X, titleFontWeight: "normal", labelFontFamily: w, labelFontSize: A, labelFontColor: X, labelFontWeight: "normal", lineThickness: 1, lineColor: P, tickThickness: 1, tickColor: P, gridThickness: 0, gridColor: P, stripLines: [{
        labelFontFamily: w,
        labelFontSize: A, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1
      }], crosshair: { labelFontFamily: w, labelFontSize: A, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: Z, color: $, thickness: 1, lineDashType: "dash" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
    }], axisY: [{
      titleFontFamily: w, titleFontSize: ea, titleFontColor: X, titleFontWeight: "normal", labelFontFamily: w, labelFontSize: A,
      labelFontColor: X, labelFontWeight: "normal", lineThickness: 1, lineColor: P, tickThickness: 1, tickColor: P, gridThickness: 1, gridColor: P, stripLines: [{ labelFontFamily: w, labelFontSize: A, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: { labelFontFamily: w, labelFontSize: A, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: Z, color: $, thickness: 1, lineDashType: "dash" }, scaleBreaks: {
        type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1,
        lineDashType: "solid", color: "#111111"
      }
    }], axisY2: [{
      titleFontFamily: w, titleFontSize: ea, titleFontColor: X, titleFontWeight: "normal", labelFontFamily: w, labelFontSize: A, labelFontColor: X, labelFontWeight: "normal", lineThickness: 1, lineColor: P, tickThickness: 1, tickColor: P, gridThickness: 1, gridColor: P, stripLines: [{ labelFontFamily: w, labelFontSize: A, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: {
        labelFontFamily: w, labelFontSize: A, labelFontColor: "#000000",
        labelFontWeight: "normal", labelBackgroundColor: Z, color: $, thickness: 1, lineDashType: "dash"
      }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
    }], legend: { fontFamily: w, fontSize: 14, fontColor: ga, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" }, toolTip: { fontFamily: w, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1, fontColor: X, backgroundColor: "rgba(0, 0, 0, .7)" }
  ...
  var ea = 20, A = 14, bb = {
    light1: Va, light2: ab, dark1: Fa, dark2: {
      colorSet: "colorSet2", backgroundColor: "#32373A", title: { fontFamily: w, fontSize: 32, fontColor: ga, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: w, fontSize: A, fontColor: ga, fontWeight: "normal", verticalAlign: "top", margin: 5 }], toolbar: { itemBackgroundColor: "#666666", itemBackgroundColorOnHover: "#FF7372", buttonBorderColor: "#FF7372", buttonBorderThickness: 1, fontColor: "#F5F5F5", fontColorOnHover: "#F5F5F5" }, data: [{
        ...
        indexLabelFontSize: A, indexLabelFontColor: X, indexLabelFontWeight: "normal", indexLabelLineThickness: 1
      }], axisX: [{
        titleFontFamily: w, titleFontSize: ea, titleFontColor: X, titleFontWeight: "normal", labelFontFamily: w, labelFontSize: A, labelFontColor: X, labelFontWeight: "normal", lineThickness: 1, lineColor: P, tickThickness: 1, tickColor: P, gridThickness: 0, gridColor: P, stripLines: [{ labelFontFamily: w, labelFontSize: A, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: {
          labelFontFamily: w,
          labelFontSize: A, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: Z, color: $, thickness: 1, lineDashType: "dash"
        ...
        titleFontFamily: w, titleFontSize: ea, titleFontColor: X, titleFontWeight: "normal", labelFontFamily: w, labelFontSize: A, labelFontColor: X, labelFontWeight: "normal", lineThickness: 0, lineColor: P, tickThickness: 1, tickColor: P, gridThickness: 1, gridColor: P, stripLines: [{ labelFontFamily: w, labelFontSize: A, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: {
          labelFontFamily: w, labelFontSize: A, labelFontColor: "#000000",
          labelFontWeight: "normal", labelBackgroundColor: Z, color: $, thickness: 1, lineDashType: "dash"
        }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
      }], legend: { fontFamily: w, fontSize: 14, fontColor: ga, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" }, toolTip: { fontFamily: w, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1, fontColor: X, backgroundColor: "rgba(0, 0, 0, .7)" }
    ...
    U.fSDec = function (h) { for (var m = "", r = 0; r < h.length; r++)m += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(r)); return m }; delete ra[U.fSDec("Bi`su")][U.fSDec("bsdehuIsdg")]; U.pro = { sCH: ra[U.fSDec("Bi`su")][U.fSDec("bsdehuIsdg")] }; U.pos = ["cm",
      "cs", "um"]; U._fTWm = function (h) {
  ...
  })(); var gb = function () { var h = !1; try { var m = Object.defineProperty && Object.defineProperty({}, "passive", { get: function () { h = !0; return !1 } }); window.addEventListener && (window.addEventListener("test", null, m), window.removeEventListener("test", null, m)) } catch (r) { h = !1 } return h }(), Ya = {}, ta = null, lb = function () {
    this.ctx.clearRect(0, 0, this.width, this.height); this.backgroundColor && (this.ctx.fillStyle = this.backgroundColor, this.ctx.fillRect(0,
      0, this.width, this.height))
  }, ya = function (h) { h.width = 1; h.height = 1; h.getContext("2d") && h.getContext("2d").clearRect(0, 0, 1, 1) }, mb = function (h, m, r) { m = Math.min(this.width, this.height); return Math.max("theme4" === this.theme ? 0 : 300 <= m ? 12 : 11, Math.round(m * (h / 400))) }, Ba = function () {
    var h = /D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g, m = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), r = "Sun Mon Tue Wed Thu Fri Sat".split(" "), v = "January February March April May June July August September October November December".split(" "),
      Y = "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "), w = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g, E = /[^-+\dA-Z]/g; return function (A, I, Q) {
        var P = Q ? Q.days : m, O = Q ? Q.months : v, J = Q ? Q.shortDays : r, K = Q ? Q.shortMonths : Y; Q = ""; var U = !1; A = A && A.getTime ? A : A ? new Date(A) : new Date; if (isNaN(A)) throw SyntaxError("invalid date"); "UTC:" === I.slice(0, 4) && (I = I.slice(4), U = !0); Q = U ? "getUTC" : "get"; var V = A[Q + "Date"](), N = A[Q + "Day"](),
          ba = A[Q + "Month"](), a = A[Q + "FullYear"](), d = A[Q + "Hours"](), c = A[Q + "Minutes"](), b = A[Q + "Seconds"](), e = A[Q + "Milliseconds"](), f = U ? 0 : A.getTimezoneOffset(); return Q = I.replace(h, function (l) {
            switch (l) {
              case "D": return V; case "DD": return ca(V, 2); case "DDD": return J[N]; case "DDDD": return P[N]; case "M": return ba + 1; case "MM": return ca(ba + 1, 2); case "MMM": return K[ba]; case "MMMM": return O[ba]; case "Y": return parseInt(String(a).slice(-2)); case "YY": return ca(String(a).slice(-2), 2); case "YYY": return ca(String(a).slice(-3),
                3); case "YYYY": return ca(a, 4); case "h": return d % 12 || 12; case "hh": return ca(d % 12 || 12, 2); case "H": return d; case "HH": return ca(d, 2); case "m": return c; case "mm": return ca(c, 2); case "s": return b; case "ss": return ca(b, 2); case "f": return ca(String(e), 3).slice(0, 1); case "ff": return ca(String(e), 3).slice(0, 2); case "fff": return ca(String(e), 3).slice(0, 3); case "t": return 12 > d ? "a" : "p"; case "tt": return 12 > d ? "am" : "pm"; case "T": return 12 > d ? "A" : "P"; case "TT": return 12 > d ? "AM" : "PM"; case "K": return U ? "UTC" : (String(A).match(w) ||
                  [""]).pop().replace(E, ""); case "z": return (0 < f ? "-" : "+") + Math.floor(Math.abs(f) / 60); case "zz": return (0 < f ? "-" : "+") + ca(Math.floor(Math.abs(f) / 60), 2); case "zzz": return (0 < f ? "-" : "+") + ca(Math.floor(Math.abs(f) / 60), 2) + ca(Math.abs(f) % 60, 2); default: return l.slice(1, l.length - 1)
            }
          })
      }
  }(), ha = function (h, m, r) {
    if (null === h) return ""; if (!isFinite(h)) return h; h = Number(h); var v = 0 > h ? !0 : !1; v && (h *= -1); var Y = r ? r.decimalSeparator : ".", w = r ? r.digitGroupSeparator : ",", E = ""; m = String(m); var E = 1, A = r = "", I = -1, Q = [], P = [], O = 0, J = 0, K = 0, U = !1,
      V = 0, A = m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g); m = null; for (var N = 0; A && N < A.length; N++)if (m = A[N], "." === m && 0 > I) I = N; else { if ("%" === m) E *= 100; else if ("\u2030" === m) { E *= 1E3; continue } else if ("," === m[0] && "." === m[m.length - 1]) { E /= Math.pow(1E3, m.length - 1); I = N + m.length - 1; continue } else "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || (U = !0); 0 > I ? (Q.push(m), "#" === m || "0" === m ? O++ : "," === m && K++) : (P.push(m), "#" !== m && "0" !== m || J++) } U && (m = Math.floor(h), A = -Math.floor(Math.log(h) / Math.LN10 + 1), V = 0 === h ? 0 : 0 === m ? -(O +
        A) : String(m).length - O, E /= Math.pow(10, V)); 0 > I && (I = N); E = (h * E).toFixed(J); m = E.split("."); E = (m[0] + "").split(""); h = (m[1] + "").split(""); E && "0" === E[0] && E.shift(); for (U = A = N = J = I = 0; 0 < Q.length;)if (m = Q.pop(), "#" === m || "0" === m) if (I++, I === O) { var ba = E, E = []; if ("0" === m) for (m = O - J - (ba ? ba.length : 0); 0 < m;)ba.unshift("0"), m--; for (; 0 < ba.length;)r = ba.pop() + r, U++, 0 === U % A && (N === K && 0 < ba.length) && (r = w + r) } else 0 < E.length ? (r = E.pop() + r, J++, U++) : "0" === m && (r = "0" + r, J++, U++), 0 === U % A && (N === K && 0 < E.length) && (r = w + r); else "E" !== m[0] && "e" !==
          m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? "," === m ? (N++, A = U, U = 0, 0 < E.length && (r = w + r)) : r = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + r : m + r : (m = 0 > V ? m.replace("+", "").replace("-", "") : m.replace("-", ""), r += m.replace(/[0]+/, function (a) { return ca(V, a.length) })); w = ""; for (Q = !1; 0 < P.length;)m = P.shift(), "#" === m || "0" === m ? 0 < h.length && 0 !== Number(h.join("")) ? (w += h.shift(), Q = !0) : "0" === m && (w += "0", Q = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" ===
            m[0] && "'" === m[m.length - 1]) ? w += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? w += m : (m = 0 > V ? m.replace("+", "").replace("-", "") : m.replace("-", ""), w += m.replace(/[0]+/, function (a) { return ca(V, a.length) })); r += (Q ? Y : "") + w; return v ? "-" + r : r
  }, Oa = function (h) { var m = 0, r = 0; h = h || window.event; h.offsetX || 0 === h.offsetX ? (m = h.offsetX, r = h.offsetY) : h.layerX || 0 == h.layerX ? (m = h.layerX, r = h.layerY) : (m = h.pageX - h.target.offsetLeft, r = h.pageY - h.target.offsetTop); return { x: m, y: r } }, $a = !0,
    Ra = window.devicePixelRatio || 1, Na = 1, la = $a ? Ra / Na : 1, da = function (h, m, r, v, w, A, E, I, O, Q, U, P, J) {
  ...
  W.prototype.setOptions = function (h, m) { if (ra[this._defaultsKey]) { var r = ra[this._defaultsKey], v; for (v in r) "publicProperties" !== v && r.hasOwnProperty(v) && (this[v] = h && v in h ? h[v] : m && v in m ? m[v] : r[v]) } else Ha && window.console && console.log("defaults not set") }; W.prototype.get = function (h) {
    var m = ra[this._defaultsKey]; if ("options" === h) return this.options && this.options._isPlaceholder ? null : this.options; if (m.hasOwnProperty(h) || m.publicProperties && m.publicProperties.hasOwnProperty(h)) return this[h]; window.console &&
      window.console.log('Property "' + h + "\" doesn't exist. Please check for typo.")
  }; W.prototype.set = function (h, m, r) {
    r = "undefined" === typeof r ? !0 : r; var v = ra[this._defaultsKey]; if ("options" === h) this.createUserOptions(m); else if (v.hasOwnProperty(h) || v.publicProperties && v.publicProperties.hasOwnProperty(h) && "readWrite" === v.publicProperties[h]) this.options._isPlaceholder && this.createUserOptions(), this.options[h] = m; else {
    ...
    v = "undefined" === typeof v ? !0 : v; var w = ra[this._defaultsKey]; w.hasOwnProperty(h) || w.publicProperties && w.publicProperties.hasOwnProperty(h) && "readWrite" === w.publicProperties[h] ? (this.options._isPlaceholder && this.createUserOptions(), "undefined" === typeof this.options[h] && (this.options[h] =
  ...
  }; W.prototype.remove = function (h) { h = "undefined" === typeof h ? !0 : h; if (this.isOptionsInArray) { var m = this.parent.options[this.optionsName]; Da(m); var r = m.indexOf(this.options); 0 <= r && m.splice(r, 1) } else delete this.parent.options[this.optionsName]; h && (this.stockChart || this.chart || this).render() }; W.prototype.updateOption = function (h) {
    !ra[this._defaultsKey] && (Ha && window.console) && console.log("defaults not set"); var m = ra[this._defaultsKey], v = {}, w = this[h], A = this._themeOptionsKey,
  ...
  }; W.prototype.removeEventListener = function (h, m) { if (h && m && this._eventListeners[h]) for (var r = this._eventListeners[h], v = 0; v < r.length; v++)if (r[v].eventHandler === m) { r[v].splice(v, 1); break } }; W.prototype.removeAllEventListeners = function () { this._eventListeners = [] }; W.prototype.dispatchEvent = function (h, m, r) {
    if (h && this._eventListeners[h]) {
      m = m || {}; for (var v = this._eventListeners[h], w = 0; w < v.length; w++)v[w].eventHandler.call(v[w].context,
        m)
    ...
    function () { return { x1: this._x1 + this._leftOccupied, y1: this._y1 + this._topOccupied, x2: this._x2 - this._rightOccupied, y2: this._y2 - this._bottomOccupied, width: this._x2 - this._x1 - this._rightOccupied - this._leftOccupied, height: this._y2 - this._y1 - this._bottomOccupied - this._topOccupied } }; Ea.prototype.reset = function () { this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding }; qa(ka, W); ka.prototype._initialize = function () {
      ...
      this.text = h; this._isDirty = !0; this._wrappedText =
        null
    }; ka.prototype.measureText = function () { this._lineHeight = Xa(this.fontFamily, this.fontSize, this.fontWeight); if (null === this.maxWidth) throw "Please set maxWidth and height for TextBlock"; this._wrapText(this.ctx); this._isDirty = !1; return { width: this.width, height: this.height } }; ka.prototype._getLineWithWidth = function (h, m, r) {
      h = String(h); if (!h) return { text: "", width: 0 }; var v = r = 0, w = h.length - 1, A = Infinity; for (this.ctx.font = this._getFontString(); v <= w;) {
        var A = Math.floor((v + w) / 2), E = h.substr(0, A + 1); r = this.ctx.measureText(E).width;
        if (r < m) v = A + 1; else if (r > m) w = A - 1; else break
      } r > m && 1 < E.length && (E = E.substr(0, E.length - 1), r = this.ctx.measureText(E).width); m = !0; if (E.length === h.length || " " === h[E.length]) m = !1; m && (h = E.split(" "), 1 < h.length && h.pop(), E = h.join(" "), r = this.ctx.measureText(E).width); return { text: E, width: r }
    }; ka.prototype._wrapText = function () {
      var h = new String(Ga(String(this.text))), m = [], r = this.ctx.font, v = 0, w = 0; this.ctx.font = this._getFontString(); if (0 === this.frontSize) w = v = 0; else for (; 0 < h.length;) {
      ...
      } this._wrappedText = { lines: m, width: w, height: v }; this.width = w + (this.leftPadding + this.rightPadding); this.height = v + (this.topPadding + this.bottomPadding); this.ctx.font = r
    }; ka.prototype._getFontString = function () {
      var h; h = "" + (this.fontStyle ? this.fontStyle + " " :
        ""); h += this.fontWeight ? this.fontWeight + " " : ""; h += this.fontSize ? this.fontSize + "px " : ""; var r = this.fontFamily ? this.fontFamily + "" : ""; !v && r && (r = r.split(",")[0], "'" !== r[0] && '"' !== r[0] && (r = "'" + r + "'")); return h += r
    }; qa(Ta, W); qa(za, W); za.prototype.setLayout = function () {
      if (this.text) {
        var h = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, m = h.layoutManager.getFreeSpace(), v = m.x1, w = m.y1, A = 0, I = 0, E = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, K, J; "top" === this.verticalAlign ||
          "bottom" === this.verticalAlign ? (null === this.maxWidth && (this.maxWidth = m.width - 4 - E * ("center" === this.horizontalAlign ? 2 : 1)), I = 0.5 * m.height - this.margin - 2, A = 0) : "center" === this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = m.height - 4), I = 0.5 * m.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = m.width - 4), I = 0.5 * m.height - 4)); var Q; r(this.padding) || "number" !== typeof this.padding ? r(this.padding) || "object" !==
            typeof this.padding || (Q = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0, Q += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0) : Q = 2 * this.padding; this.wrap || (I = Math.min(I, 1.5 * this.fontSize + Q)); I = new ka(this.ctx, {
              ...
              backgroundColor: this.backgroundColor, maxWidth: this.maxWidth, maxHeight: I, cornerRadius: this.cornerRadius, text: this.text, padding: this.padding, textBaseline: "top"
            }); Q = I.measureText(); "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (w = m.y1 + 2, J = "top") : "bottom" === this.verticalAlign && (w = m.y2 - 2 - Q.height, J = "bottom"), "left" === this.horizontalAlign ? v = m.x1 + 2 : "center" === this.horizontalAlign ? v = m.x1 + m.width / 2 - Q.width / 2 : "right" === this.horizontalAlign && (v = m.x2 - 2 - Q.width - E), K = this.horizontalAlign,
              this.width = Q.width, this.height = Q.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (v = m.x1 + 2, w = m.y2 - 2 - (this.maxWidth / 2 - Q.width / 2), A = -90, J = "left", this.width = Q.height, this.height = Q.width) : "right" === this.horizontalAlign ? (v = m.x2 - 2, w = m.y1 + 2 + (this.maxWidth / 2 - Q.width / 2), A = 90, J = "right", this.width = Q.height, this.height = Q.width) : "center" === this.horizontalAlign && (w = h.y1 + (h.height / 2 - Q.height / 2), v = h.x1 + (h.width / 2 - Q.width / 2), J = "center", this.width = Q.width, this.height = Q.height), K = "center"); I.x =
                v; I.y = w; I.angle = A; I.horizontalAlign = K; this._textBlock = I; h.layoutManager.registerSpace(J, { width: this.width + ("left" === J || "right" === J ? this.margin + 2 : 0), height: this.height + ("top" === J || "bottom" === J ? this.margin + 2 : 0) }); this.bounds = { x1: v, y1: w, x2: v + this.width, y2: w + this.height }; this.ctx.textBaseline = "top"
      }
    }; za.prototype.render = function () { this._textBlock && this._textBlock.render(!0) }; qa(Ia, W); Ia.prototype.setLayout = za.prototype.setLayout; Ia.prototype.render = za.prototype.render; Ua.prototype.get = function (h, r) {
      var v =
        null; 0 < this.pool.length ? (v = this.pool.pop(), Ma(v, h, r)) : v = va(h, r); return v
    }; Ua.prototype.release = function (h) { this.pool.push(h) }; qa(Ja, W); var Pa = { addTheme: function (h, r) { bb[h] = r }, addColorSet: function (h, r) { Aa[h] = r }, addCultureInfo: function (h, r) { Ka[h] = r }, formatNumber: function (h, r, v) { v = v || "en"; if (Ka[v]) return ha(h, r || "#,##0.##", new Ja(v)); throw "Unknown Culture Name"; }, formatDate: function (h, r, v) { v = v || "en"; if (Ka[v]) return Ba(h, r || "DD MMM YYYY", new Ja(v)); throw "Unknown Culture Name"; } }; "undefined" !== typeof module &&
      "undefined" !== typeof module.exports ? module.exports = Pa : "function" === typeof define && define.amd ? define([], function () { return Pa }) : (window.CanvasJS && window.console && window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."), window.CanvasJS = window.CanvasJS ? window.CanvasJS : Pa); w = Pa.Chart = function () {
        function h(a, d) { return a.x - d.x } function m(a, d, c) {
          d = d || {}; r(c) ? (this.predefinedThemes = bb, this.optionsName =
          ...
          for (var c = [], b, e = 0; e < a.length; e++)if (0 == e) c.push(a[0]); else {
            var f, l, s; s = e - 1; f = 0 === s ? 0 : s - 1; l = s === a.length - 1 ? s : s + 1; b = Math.abs((a[l].x - a[f].x) / (0 === a[l].x - a[s].x ? 0.01 : a[l].x - a[s].x)) * (d - 1) /
              2 + 1; var C = (a[l].x - a[f].x) / b; b = (a[l].y - a[f].y) / b; c[c.length] = a[s].x > a[f].x && 0 < C || a[s].x < a[f].x && 0 > C ? { x: a[s].x + C / 3, y: a[s].y + b / 3 } : { x: a[s].x, y: a[s].y + b / 9 }; s = e; f = 0 === s ? 0 : s - 1; l = s === a.length - 1 ? s : s + 1; b = Math.abs((a[l].x - a[f].x) / (0 === a[s].x - a[f].x ? 0.01 : a[s].x - a[f].x)) * (d - 1) / 2 + 1; C = (a[l].x - a[f].x) / b; b = (a[l].y - a[f].y) / b; c[c.length] = a[s].x > a[f].x && 0 < C || a[s].x < a[f].x && 0 > C ? { x: a[s].x - C / 3, y: a[s].y - b / 3 } : { x: a[s].x, y: a[s].y - b / 9 }; c[c.length] = a[e]
          } return c
        } function A(a, d, c, b, e, f, l, s, C, k) {
          var n = 0; k ? (l.color = f, s.color = f) :
          ...
          P.base.constructor.call(this, "Legend", "legend", d, null, a); this.chart = a; this.canvas = a.canvas;
          ...
          ga.base.constructor.call(this, "Break", d, c, b, f); this.id = e; this.chart = a; this.ctx = this.chart.ctx; this.scaleBreaks = f; this.optionsName =
          ...
          Q.base.constructor.call(this, "StripLine", "stripLines", d, c, e); this.id = b; this.chart = a; this.ctx = this.chart.ctx; this.label = this.label; this.axis = e; this.optionsName = "stripLines"; this.isOptionsInArray = !0; this._thicknessType = "pixel"; null !== this.startValue && null !== this.endValue && (this.value = e.logarithmic ? Math.sqrt((this.startValue.getTime ? this.startValue.getTime() : this.startValue) * (this.endValue.getTime ? this.endValue.getTime() : this.endValue)) : ((this.startValue.getTime ? this.startValue.getTime() :
            this.startValue) + (this.endValue.getTime ? this.endValue.getTime() : this.endValue)) / 2, this._thicknessType = null)
        } function ca(a, d, c) { ca.base.constructor.call(this, "Crosshair", "crosshair", d, null, c); this.chart = a; this.ctx = this.chart.ctx; this.axis = c; this.optionsName = "crosshair"; this._thicknessType = "pixel" } function $(a, d) {
        ...
        } function Z(a) { this.chart = a; this.lastObjectId = 0; this.objectMap = []; this.rectangularRegionEventSubscriptions = []; this.previousDataPointEventObject = null; this.ghostCanvas = va(this.chart.width, this.chart.height); this.ghostCtx = this.ghostCanvas.getContext("2d"); this.mouseoveredObjectMaps = [] } function ja(a) {
          this.chart = a; this.ctx = this.chart.plotArea.ctx;
          this.animations = []; this.animationRequestId = null
        } qa(m, W); m.prototype.destroy = function () {
          ...
          for (; this.container && this.container.hasChildNodes();)this.container.removeChild(this.container.lastChild); for (; this._dropdownMenu && this._dropdownMenu.hasChildNodes();)this._dropdownMenu.removeChild(this._dropdownMenu.lastChild); this.container = this._canvasJSContainer = null; this.toolTip.container = null; this.canvas && ya(this.canvas); this.overlaidCanvas && ya(this.overlaidCanvas); this._preRenderCanvas && ya(this._preRenderCanvas); this._breaksCanvas && ya(this._breaksCanvas); this._eventManager && this._eventManager.ghostCanvas &&
            ya(this._eventManager.ghostCanvas); this._toolBar = this._dropdownMenu = this._menuButton = this._resetButton = this._zoomButton = null
          ...
          var a = this; this.updateOption("width"); this.updateOption("height"); this.updateOption("dataPointWidth"); this.updateOption("dataPointMinWidth"); this.updateOption("dataPointMaxWidth"); this.updateOption("interactivityEnabled"); this.updateOption("theme"); this.updateOption("colorSet") && (this.selectedColorSet = "undefined" !== typeof Aa[this.colorSet] ?
            Aa[this.colorSet] : Aa.colorSet1); this.updateOption("backgroundColor"); this.backgroundColor || (this.backgroundColor = "rgba(0,0,0,0)"); this.updateOption("culture"); this._cultureInfo = new Ja(this.options.culture); this.updateOption("animationEnabled"); this.animationEnabled = this.animationEnabled && v; this.updateOption("animationDuration"); this.updateOption("rangeChanging"); this.updateOption("rangeChanged"); this.updateOption("exportEnabled"); this.updateOption("exportFileName"); this.updateOption("zoomType"); this.toolbar =
              new Ta(this, this.options.toolbar); if (this.options.zoomEnabled || this.panEnabled) {
                if (this._zoomButton) V(this._zoomButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }), this._zoomButton.title = this._cultureInfo.zoomText; else {
                  var d = !1; wa(this._zoomButton = document.createElement("button")); xa(this, this._zoomButton, "pan"); this._zoomButton.title = this._cultureInfo.panText; this._toolBar.appendChild(this._zoomButton);
                  this._zoomButton.style.borderRight = this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor; J(this._zoomButton, "touchstart", function (a) { d = !0 }, this.allDOMEventHandlers); J(this._zoomButton, "click", function () { a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, xa(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, xa(a, a._zoomButton, "pan")); a.render() }, this.allDOMEventHandlers); J(this._zoomButton, "mousemove", function () {
                    ...
                    }), 0 >= navigator.userAgent.search("MSIE") && V(a._zoomButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }))
                  }, this.allDOMEventHandlers); J(this._zoomButton, "mouseout", function () {
                    d || (V(a._zoomButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && V(a._zoomButton.childNodes[0], {
                  ...
                  this.toolbar.buttonBorderColor, this._toolBar.appendChild(this._resetButton), J(this._resetButton, "touchstart", function (a) { d = !0 }, this.allDOMEventHandlers), J(this._resetButton, "click", function () {
                    a.toolTip.hide(); a.toolTip && a.toolTip.enabled && a.toolTip.dispatchEvent("hidden", { chart: a, toolTip: a.toolTip }, a.toolTip); a.zoomEnabled || a.panEnabled ? (a.zoomEnabled = !0, a.panEnabled = !1, xa(a, a._zoomButton, "pan"), a._defaultCursor = "default", a.overlaidCanvas.style.cursor = a._defaultCursor) : (a.zoomEnabled = !1, a.panEnabled =
                      !1); if (a.sessionVariables.axisX) for (var b = 0; b < a.sessionVariables.axisX.length; b++)a.sessionVariables.axisX[b].newViewportMinimum = null, a.sessionVariables.axisX[b].newViewportMaximum = null; if (a.sessionVariables.axisX2) for (b = 0; b < a.sessionVariables.axisX2.length; b++)a.sessionVariables.axisX2[b].newViewportMinimum = null, a.sessionVariables.axisX2[b].newViewportMaximum = null; if (a.sessionVariables.axisY) for (b = 0; b < a.sessionVariables.axisY.length; b++)a.sessionVariables.axisY[b].newViewportMinimum = null, a.sessionVariables.axisY[b].newViewportMaximum =
                        null; if (a.sessionVariables.axisY2) for (b = 0; b < a.sessionVariables.axisY2.length; b++)a.sessionVariables.axisY2[b].newViewportMinimum = null, a.sessionVariables.axisY2[b].newViewportMaximum = null; a.resetOverlayedCanvas(); 0 >= navigator.userAgent.search("MSIE") && V(a._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }); wa(a._zoomButton, a._resetButton); a.stockChart && (a.stockChart._rangeEventParameter = {
                  ...
                  J(this._resetButton, "mousemove", function () { d || (V(a._resetButton, { backgroundColor: a.toolbar.itemBackgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && V(a._resetButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" })) }, this.allDOMEventHandlers), J(this._resetButton, "mouseout", function () {
                    d || (V(a._resetButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                      0 >= navigator.userAgent.search("MSIE") && V(a._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }))
        ...
        m.prototype._initialize = function () {
          ...
          this.axisX = []; this.axisX2 = []; this.axisY = []; this.axisY2 = []; this._indexLabels = []; this._dataInRenderedOrder = []; this._events = []; this._eventManager && this._eventManager.reset(); this.plotInfo = { axisPlacement: null, plotTypes: [] }; this.layoutManager = new Ea(0, 0, this.width, this.height, this.isNavigator ? 0 : 2); this.plotArea.layoutManager && this.plotArea.layoutManager.reset(); this.data = []; this.title = null; this.subtitles = []; var a = 0, d = null; if (this.options.data) {
            for (var c = 0; c < this.options.data.length; c++)if (a++, !this.options.data[c].type ||
              ...
              var b = new X(this, this.options.data[c], a - 1, ++this._eventManager.lastObjectId); "error" === b.type && (b.linkedDataSeriesIndex = r(this.options.data[c].linkedDataSeriesIndex) ? c - 1 : this.options.data[c].linkedDataSeriesIndex, 0 > b.linkedDataSeriesIndex || b.linkedDataSeriesIndex >= this.options.data.length || "number" !== typeof b.linkedDataSeriesIndex || "error" === this.options.data[b.linkedDataSeriesIndex].type) && (b.linkedDataSeriesIndex = null); null === b.name &&
        ...
        m.prototype.setLayout = function () {
          ...
          var a = this._plotAreaElements; this.title && !this.title.dockInsidePlotArea && this.title.render(); for (var d = 0; d < this.subtitles.length; d++)this.subtitles[d].dockInsidePlotArea || this.subtitles[d].render(); this.legend.dockInsidePlotArea ||
            this.legend.render(); if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) E.render(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement); else if ("none" === this.plotInfo.axisPlacement) this.preparePlotArea(); else return; for (d = 0; d < a.length; d++)a[d].setLayout(), a[d].render(); var c = []; if (this.animatedRender) { var b = va(this.width, this.height); b.getContext("2d").drawImage(this.canvas, 0, 0, this.width, this.height) } ib(this); var a = this.ctx.miterLimit, e; this.ctx.miterLimit =
              3; v && this._breaksCanvas && (this._preRenderCtx.drawImage(this.canvas, 0, 0, this.width, this.height), this._preRenderCtx.drawImage(this._breaksCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx.globalCompositeOperation = "source-atop", this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), this._preRenderCtx.clearRect(0, 0, this.width, this.height)); for (d = 0; d < this.plotInfo.plotTypes.length; d++)for (var f = this.plotInfo.plotTypes[d], l = 0; l < f.plotUnits.length; l++) {
                  ...
                  C = null; s.targetCanvas && ya(s.targetCanvas); s.targetCanvas = null; this.animatedRender && (s.targetCanvas = va(this.width, this.height), s.targetCanvasCtx = s.targetCanvas.getContext("2d"), e = s.targetCanvasCtx.miterLimit, s.targetCanvasCtx.miterLimit = 3); "line" === s.type ? C = this.renderLine(s) : "stepLine" === s.type ? C = this.renderStepLine(s) : "spline" === s.type ? C = this.renderSpline(s) : "column" === s.type ? C = this.renderColumn(s) : "bar" === s.type ? C = this.renderBar(s) : "area" === s.type ? C = this.renderArea(s) : "stepArea" === s.type ? C = this.renderStepArea(s) :
                    "splineArea" === s.type ? C = this.renderSplineArea(s) : "stackedColumn" === s.type ? C = this.renderStackedColumn(s) : "stackedColumn100" === s.type ? C = this.renderStackedColumn100(s) : "stackedBar" === s.type ? C = this.renderStackedBar(s) : "stackedBar100" === s.type ? C = this.renderStackedBar100(s) : "stackedArea" === s.type ? C = this.renderStackedArea(s) : "stackedArea100" === s.type ? C = this.renderStackedArea100(s) : "bubble" === s.type ? C = C = this.renderBubble(s) : "scatter" === s.type ? C = this.renderScatter(s) : "pie" === s.type ? this.renderPie(s) : "doughnut" ===
                      s.type ? this.renderPie(s) : "funnel" === s.type ? C = this.renderFunnel(s) : "pyramid" === s.type ? C = this.renderFunnel(s) : "candlestick" === s.type ? C = this.renderCandlestick(s) : "ohlc" === s.type ? C = this.renderCandlestick(s) : "rangeColumn" === s.type ? C = this.renderRangeColumn(s) : "error" === s.type ? C = this.renderError(s) : "rangeBar" === s.type ? C = this.renderRangeBar(s) : "rangeArea" === s.type ? C = this.renderRangeArea(s) : "rangeSplineArea" === s.type ? C = this.renderRangeSplineArea(s) : "waterfall" === s.type ? C = this.renderWaterfall(s) : "boxAndWhisker" ===
                        s.type && (C = this.renderBoxAndWhisker(s)); for (var k = 0; k < s.dataSeriesIndexes.length; k++)this._dataInRenderedOrder.push(this.data[s.dataSeriesIndexes[k]]); this.animatedRender && (s.targetCanvasCtx.miterLimit = e, C && c.push(C))
                ...
                (e = va(this.width, this.height).getContext("2d"), c.push(this.renderIndexLabels(e))); var n = this; if (0 < c.length) n.disableToolTip = !0, n._animator.animate(200, n.animationDuration, function (a) {
                  n.ctx.clearRect(0, 0, n.width, n.height); n.ctx.drawImage(b, 0, 0, Math.floor(n.width * la), Math.floor(n.height * la), 0, 0, n.width, n.height); for (var e = 0; e < c.length; e++)C = c[e], 1 > a && "undefined" !== typeof C.startTimePercent ? a >= C.startTimePercent && C.animationCallback(C.easingFunction(a - C.startTimePercent, 0, 1, 1 - C.startTimePercent), C) :
                    C.animationCallback(C.easingFunction(a, 0, 1, 1), C); n.dispatchEvent("dataAnimationIterationEnd", { chart: n })
                }, function () { c = []; for (var a = 0; a < n.plotInfo.plotTypes.length; a++)for (var e = n.plotInfo.plotTypes[a], d = 0; d < e.plotUnits.length; d++) { var f = e.plotUnits[d]; f.targetCanvas && ya(f.targetCanvas); f.targetCanvas = null } b = null; n.disableToolTip = !1; n.dispatchEvent("dataAnimationEnd", { chart: n }) }); else {
          ...
          } this.attachPlotAreaEventHandlers(); this.zoomEnabled || (this.panEnabled || !this._zoomButton || "none" === this._zoomButton.style.display) || wa(this._zoomButton, this._resetButton); this.toolTip._updateToolTip(); this.renderCount++; Ha && (n = this, setTimeout(function () {
        ...
        }; m.prototype.render = function (a) { a && (this.options = a); this._initialize(); this.setLayout(); this.renderElements(); this._preRenderCanvas && ya(this._preRenderCanvas) }; m.prototype.attachPlotAreaEventHandlers = function () {
          this.attachEvent({
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
            var s = this.data[a.dataSeriesIndexes[l]],
              C = 0, k = !1, n = !1, p; if ("normal" === s.axisPlacement || "xySwapped" === s.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity, g = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ?
                this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (s.dataPoints[C].x && s.dataPoints[C].x.getTime || "dateTime" === s.xValueType) f = !0; for (C = 0; C < s.dataPoints.length; C++) {
                  "undefined" === typeof s.dataPoints[C].x && (s.dataPoints[C].x = C + (a.axisX.logarithmic ? 1 : 0)); s.dataPoints[C].x.getTime ? (f = !0, b = s.dataPoints[C].x.getTime()) : b = s.dataPoints[C].x; e = s.dataPoints[C].y; b < c.min && (c.min = b); b > c.max && (c.max = b); e < d.min && "number" === typeof e && (d.min = e);
                  e > d.max && "number" === typeof e && (d.max = e); if (0 < C) { if (a.axisX.logarithmic) { var t = b / s.dataPoints[C - 1].x; 1 > t && (t = 1 / t); c.minDiff > t && 1 !== t && (c.minDiff = t) } else t = b - s.dataPoints[C - 1].x, 0 > t && (t *= -1), c.minDiff > t && 0 !== t && (c.minDiff = t); null !== e && null !== s.dataPoints[C - 1].y && (a.axisY.logarithmic ? (t = e / s.dataPoints[C - 1].y, 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t)) : (t = e - s.dataPoints[C - 1].y, 0 > t && (t *= -1), d.minDiff > t && 0 !== t && (d.minDiff = t))) } if (b < q && !k) null !== e && (p = b); else {
                    if (!k && (k = !0, 0 < C)) { C -= 2; continue } if (b > g &&
                      !n) n = !0; else if (b > g && n) continue; s.dataPoints[C].label && (a.axisX.labels[b] = s.dataPoints[C].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); null === e ? c.viewPortMin === b && p < b && (c.viewPortMin = p) : (e < d.viewPortMin && "number" === typeof e && (d.viewPortMin = e), e > d.viewPortMax && "number" === typeof e && (d.viewPortMax = e))
                  }
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var d =
              ...
              var p = this.data[a.dataSeriesIndexes[n]], q = 0, g = !1, t = !1, h; if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement) var L = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
              ...
              (a < d.viewPortMin && (d.viewPortMin = Math.min(a, C)), a > d.viewPortMax && (d.viewPortMax = a))); for (q in s) s.hasOwnProperty(q) && !isNaN(q) && (a = s[q], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, k)), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, k))))
          }
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, s = !1, C = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                this.data[a.dataSeriesIndexes[k]], p = 0, q = !1, g = !1, t; if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement) var h = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity, L = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ?
                  this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (n.dataPoints[p].x && n.dataPoints[p].x.getTime || "dateTime" === n.xValueType) f = !0; for (p = 0; p < n.dataPoints.length; p++) {
                    "undefined" === typeof n.dataPoints[p].x && (n.dataPoints[p].x = p + (a.axisX.logarithmic ? 1 : 0)); n.dataPoints[p].x.getTime ? (f = !0, b = n.dataPoints[p].x.getTime()) : b = n.dataPoints[p].x; e = r(n.dataPoints[p].y) ? null : n.dataPoints[p].y; b < c.min && (c.min = b); b > c.max && (c.max = b); if (0 < p) {
                      ...
                      if (!q && (q = !0, 0 < p)) { p -= 2; continue } if (b > L && !g) g = !0; else if (b > L && g) continue; n.dataPoints[p].label && (a.axisX.labels[b] = n.dataPoints[p].label);
                      b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); null === e ? c.viewPortMin === b && t < b && (c.viewPortMin = t) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l = !0 : 0 > e && (s = !0), C[b] = C[b] ? C[b] + Math.abs(e) : Math.abs(e))
                    }
              ...
              r(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : l && !s ? (d.max = r(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = r(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : l && s ? (d.max = r(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = r(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)) : !l && s && (d.max = r(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1), d.min = r(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)); d.viewPortMin = d.min; d.viewPortMax = d.max; a.dataPointYSums = C
          }
        }; m.prototype._processMultiYPlotUnit = function (a) {
          if (a.dataSeriesIndexes &&
            !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, s = !1, C = 0; C < a.dataSeriesIndexes.length; C++) {
              var k = this.data[a.dataSeriesIndexes[C]], n = 0, p = !1, q = !1, g, t, h; if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement) var r = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum :
                a.axisX.logarithmic ? 0 : -Infinity, u = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (k.dataPoints[n].x && k.dataPoints[n].x.getTime || "dateTime" === k.xValueType) s = !0; for (n = 0; n < k.dataPoints.length; n++) {
                  "undefined" === typeof k.dataPoints[n].x && (k.dataPoints[n].x = n + (a.axisX.logarithmic ? 1 : 0)); k.dataPoints[n].x.getTime ?
                    (s = !0, b = k.dataPoints[n].x.getTime()) : b = k.dataPoints[n].x; if ((e = k.dataPoints[n].y) && e.length) { f = Math.min.apply(null, e); l = Math.max.apply(null, e); t = !0; for (var y = 0; y < e.length; y++)null === e.k && (t = !1); t && (p || (h = g), g = b) } b < c.min && (c.min = b); b > c.max && (c.max = b); f < d.min && (d.min = f); l > d.max && (d.max = l); 0 < n && (a.axisX.logarithmic ? (t = b / k.dataPoints[n - 1].x, 1 > t && (t = 1 / t), c.minDiff > t && 1 !== t && (c.minDiff = t)) : (t = b - k.dataPoints[n - 1].x, 0 > t && (t *= -1), c.minDiff > t && 0 !== t && (c.minDiff = t)), e && (null !== e[0] && k.dataPoints[n - 1].y && null !==
                      k.dataPoints[n - 1].y[0]) && (a.axisY.logarithmic ? (t = e[0] / k.dataPoints[n - 1].y[0], 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t)) : (t = e[0] - k.dataPoints[n - 1].y[0], 0 > t && (t *= -1), d.minDiff > t && 0 !== t && (d.minDiff = t)))); if (!(b < r) || p) {
                        if (!p && (p = !0, 0 < n)) { n -= 2; g = h; continue } if (b > u && !q) q = !0; else if (b > u && q) continue; k.dataPoints[n].label && (a.axisX.labels[b] = k.dataPoints[n].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); if (c.viewPortMin === b && e) for (y = 0; y < e.length; y++)if (null === e[y] && g < b) {
                          c.viewPortMin =
                            g; break
          ...
          if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
            var s = this.data[a.dataSeriesIndexes[l]], C = 0, k = !1, n = !1, p = b = 0; if ("normal" === s.axisPlacement || "xySwapped" ===
        ...
        m.prototype.calculateAutoBreaks = function () {
          function a(a, b, c, e) { if (e) return c = Math.pow(Math.min(c * a / b, b / a), 0.2), 1 >= c && (c = Math.pow(1 > a ? 1 / a : Math.min(b / a, a), 0.25)), { startValue: a * c, endValue: b / c }; c = 0.2 * Math.min(c - b + a, b - a); 0 >= c && (c = 0.25 * Math.min(b - a, Math.abs(a))); return { startValue: a + c, endValue: b - c } } function d(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
              var b = a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks, c = a.axisY.scaleBreaks && a.axisY.scaleBreaks.autoCalculate &&
                1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks; if (b || c) for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, l = f.min, k = f.max, n = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, q, s = 0, C = 0; C < a.dataSeriesIndexes.length; C++) {
                  var h = e.data[a.dataSeriesIndexes[C]]; if (!(4 > h.dataPoints.length)) for (s = 0; s < h.dataPoints.length; s++)if (b && (q = (k + 1 - l) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = h.dataPoints[s].x.getTime ? h.dataPoints[s].x.getTime() : h.dataPoints[s].x, q = Math.floor((g - l) / q), g < f[q].min &&
            ...
            for (l = 0; l < this.plotInfo.plotTypes.length; l++)for (f = this.plotInfo.plotTypes[l], s = 0; s < f.plotUnits.length; s++)b =
              f.plotUnits[s], "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "bar" === b.type || "bubble" === b.type || "scatter" === b.type || "candlestick" === b.type || "ohlc" === b.type || "rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type || "waterfall" === b.type || "error" === b.type || "boxAndWhisker" === b.type ? d(b) : 0 <= b.type.indexOf("stacked") && c(b); for (l = 0; l < this._axes.length; l++)if (this._axes[l].dataInfo._dataRanges) {
                var C =
                  this._axes[l].dataInfo.min; b = (this._axes[l].dataInfo.max + 1 - C) * Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold) || 10, 10) / 100; var k = this._axes[l].dataInfo._dataRanges, n, p, f = []; if (this._axes[l].dataInfo.dataPointYPositiveSums) { var q = this._axes[l].dataInfo.dataPointYPositiveSums; n = k; for (s in q) if (q.hasOwnProperty(s) && !isNaN(s) && (p = q[s], !r(p))) { var g = Math.floor((p - C) / b); p < n[g].min && (n[g].min = p); p > n[g].max && (n[g].max = p) } delete this._axes[l].dataInfo.dataPointYPositiveSums } if (this._axes[l].dataInfo.dataPointYNegativeSums) {
                    q =
                      this._axes[l].dataInfo.dataPointYNegativeSums; n = k; for (s in q) q.hasOwnProperty(s) && !isNaN(s) && (p = -1 * q[s], r(p) || (g = Math.floor((p - C) / b), p < n[g].min && (n[g].min = p), p > n[g].max && (n[g].max = p))); delete this._axes[l].dataInfo.dataPointYNegativeSums
                  } for (s = 0; s < k.length - 1; s++)if (n = k[s].max, isFinite(n)) for (; s < k.length - 1;)if (C = k[s + 1].min, isFinite(C)) { p = C - n; p > b && f.push({ diff: p, start: n, end: C }); break } else s++; if (this._axes[l].scaleBreaks.customBreaks) for (s = 0; s < this._axes[l].scaleBreaks.customBreaks.length; s++)for (b =
          ...
          }; m.prototype.getObjectAtXY = function (a, d, c) { var b = null; if (c = this.getDataPointAtXY(a, d, c || !1)) b = c.dataSeries.dataPointIds[c.dataPointIndex]; else if (v) b = Za(a, d, this._eventManager.ghostCtx); else for (c = 0; c < this.legend.items.length; c++) { var e = this.legend.items[c]; a >= e.x1 && (a <= e.x2 && d >= e.y1 && d <= e.y2) && (b = e.id) } return b }; m.prototype.getAutoFontSize = mb; m.prototype.resetOverlayedCanvas =
        ...
        m.prototype._dispatchRangeEvent = function (a, d) {
          ...
          e = e || !1; for (var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), s = !1, C = [], k = [], n = [], p = 0; p < this._axes.length; p++)("axisX" === this._axes[p].type &&
            f || "axisY" === this._axes[p].type && l) && k.push(this._axes[p]); for (l = 0; l < k.length; l++) {
              var p = k[l], f = !1, q = p.convertPixelToValue({ x: a, y: d }), g = p.convertPixelToValue({ x: c, y: b }); if (q > g) var t = g, g = q, q = t; if (p.scaleBreaks) for (t = 0; !f && t < p.scaleBreaks._appliedBreaks.length; t++)f = p.scaleBreaks._appliedBreaks[t].startValue <= q && p.scaleBreaks._appliedBreaks[t].endValue >= g; if (isFinite(p.dataInfo.minDiff)) if (t = p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) &&
                (p.logarithmic && t < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && t < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum)) C.push(p), n.push({ val1: q, val2: g }), s = !0; else if (!e) { s = !1; break }
            } return { isValid: s, axesWithValidRange: C, axesRanges: n }
          ...
          } else d = this.layoutManager.getFreeSpace(), a.x1 = d.x1, a.x2 = d.x2, a.y1 = d.y1, a.y2 = d.y2, a.width = d.width, a.height = d.height; v || (a.canvas.width = a.width, a.canvas.height = a.height, a.canvas.style.left = a.x1 + "px", a.canvas.style.top = a.y1 + "px", (0 < a.x1 || 0 < a.y1) && a.ctx.translate(-a.x1, -a.y1)); a.layoutManager = new Ea(a.x1, a.y1, a.x2, a.y2, 2)
        }; m.prototype.renderIndexLabels = function (a) {
          var d = a || this.plotArea.ctx, c = this.plotArea,
            b = 0, e = 0, f = 0, l = f = e = 0, s = 0, C = b = 0, k = 0; for (a = 0; a < this._indexLabels.length; a++) {
              var n = this._indexLabels[a], p = n.chartType.toLowerCase(), q, g, l = ma("indexLabelFontColor", n.dataPoint, n.dataSeries), t = ma("indexLabelFontSize", n.dataPoint, n.dataSeries), s = ma("indexLabelFontFamily", n.dataPoint, n.dataSeries), C = ma("indexLabelFontStyle", n.dataPoint, n.dataSeries), k = ma("indexLabelFontWeight", n.dataPoint, n.dataSeries), h = ma("indexLabelBackgroundColor", n.dataPoint, n.dataSeries); q = ma("indexLabelMaxWidth", n.dataPoint, n.dataSeries);
              g = ma("indexLabelWrap", n.dataPoint, n.dataSeries); var L = ma("indexLabelLineDashType", n.dataPoint, n.dataSeries), u = ma("indexLabelLineColor", n.dataPoint, n.dataSeries), m = r(n.dataPoint.indexLabelLineThickness) ? r(n.dataSeries.options.indexLabelLineThickness) ? 0 : n.dataSeries.options.indexLabelLineThickness : n.dataPoint.indexLabelLineThickness, b = 0 < m ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0, x = { percent: null, total: null }, B = null; if (0 <= n.dataSeries.type.indexOf("stacked") ||
                "pie" === n.dataSeries.type || "doughnut" === n.dataSeries.type) x = this.getPercentAndTotal(n.dataSeries, n.dataPoint); if (n.dataSeries.indexLabelFormatter || n.dataPoint.indexLabelFormatter) B = { chart: this, dataSeries: n.dataSeries, dataPoint: n.dataPoint, index: n.indexKeyword, total: x.total, percent: x.percent }; var D = n.dataPoint.indexLabelFormatter ? n.dataPoint.indexLabelFormatter(B) : n.dataPoint.indexLabel ? this.replaceKeywordsWithValue(n.dataPoint.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : n.dataSeries.indexLabelFormatter ?
                  n.dataSeries.indexLabelFormatter(B) : n.dataSeries.indexLabel ? this.replaceKeywordsWithValue(n.dataSeries.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : null; if (null !== D && "" !== D) {
                    var x = ma("indexLabelPlacement", n.dataPoint, n.dataSeries), B = ma("indexLabelOrientation", n.dataPoint, n.dataSeries), z = ma("indexLabelTextAlign", n.dataPoint, n.dataSeries), w = n.direction, e = n.dataSeries.axisX, f = n.dataSeries.axisY, E = !1, h = new ka(d, {
                      x: 0, y: 0, maxWidth: q ? q : 0.5 * this.width, maxHeight: g ? 5 * t : 1.5 * t, angle: "horizontal" ===
                        B ? 0 : -90, text: D, padding: 0, backgroundColor: h, textAlign: z, fontSize: t, fontFamily: s, fontWeight: k, fontColor: l, fontStyle: C, textBaseline: "middle"
          ...
          var d = a.targetCanvasCtx || this.plotArea.ctx, c = v ? this._preRenderCtx :
            d; if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = this._eventManager.ghostCtx; c.save(); var e = this.plotArea; c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
                var C = a.dataSeriesIndexes[s], k = this.data[C]; c.lineWidth = k.lineThickness; var n = k.dataPoints, p = "solid"; if (c.setLineDash) { var q = I(k.nullDataLineDashType, k.lineThickness), p = k.lineDashType, g = I(p, k.lineThickness); c.setLineDash(g) } var t = k.id; this._eventManager.objectMap[t] = {
                  objectType: "dataSeries",
                  dataSeriesIndex: C
                }; t = O(t); b.strokeStyle = t; b.lineWidth = 0 < k.lineThickness ? Math.max(k.lineThickness, 4) : 0; var t = k._colorSet, h = t = k.lineColor = k.options.lineColor ? k.options.lineColor : t[0]; c.strokeStyle = t; var r = !0, u = 0, m, x; c.beginPath(); if (0 < n.length) {
                  for (var B = !1, u = 0; u < n.length; u++)if (m = n[u].x.getTime ? n[u].x.getTime() : n[u].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !B))) if ("number" !== typeof n[u].y) 0 < u && !(k.connectNullData || B || r) && (c.stroke(), v && b.stroke()), B =
                    !0; else {
                    m = a.axisX.convertValueToPixel(m); x = a.axisY.convertValueToPixel(n[u].y); var D = k.dataPointIds[u]; this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: u, x1: m, y1: x }; r || B ? (!r && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(m, x), v && b.lineTo(m, x)) : (c.beginPath(), c.moveTo(m, x), v && (b.beginPath(),
                      b.moveTo(m, x))), B = r = !1) : (c.lineTo(m, x), v && b.lineTo(m, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(m, x), v && (b.stroke(), b.beginPath(), b.moveTo(m, x)))); l = { x: m, y: x }; u < n.length - 1 && (h !== (n[u].lineColor || t) || p !== (n[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(m, x), h = n[u].lineColor || t, c.strokeStyle = h, c.setLineDash && (n[u].lineDashType ? (p = n[u].lineDashType, c.setLineDash(I(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g)))); if (0 < n[u].markerSize || 0 < k.markerSize) {
                        var z = k.getMarkerProperties(u,
                          m, x, c); f.push(z); D = O(D); v && f.push({ x: m, y: x, ctx: b, type: z.type, size: z.size, color: D, borderColor: D, borderThickness: z.borderThickness })
                      } (n[u].indexLabel || k.indexLabel || n[u].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "line", dataPoint: n[u], dataSeries: k, point: { x: m, y: x }, direction: 0 > n[u].y === a.axisY.reversed ? 1 : -1, color: t })
                  } c.stroke(); v && b.stroke()
                }
              } ba.drawMarkers(f); v && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop",
          ...
          var d =
            a.targetCanvasCtx || this.plotArea.ctx, c = v ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = this._eventManager.ghostCtx; c.save(); var e = this.plotArea; c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
                var C = a.dataSeriesIndexes[s], k = this.data[C]; c.lineWidth = k.lineThickness; var n = k.dataPoints, p = "solid"; if (c.setLineDash) { var q = I(k.nullDataLineDashType, k.lineThickness), p = k.lineDashType, g = I(p, k.lineThickness); c.setLineDash(g) } var t =
                  k.id; this._eventManager.objectMap[t] = { objectType: "dataSeries", dataSeriesIndex: C }; t = O(t); b.strokeStyle = t; b.lineWidth = 0 < k.lineThickness ? Math.max(k.lineThickness, 4) : 0; var t = k._colorSet, h = t = k.lineColor = k.options.lineColor ? k.options.lineColor : t[0]; c.strokeStyle = t; var r = !0, u = 0, m, x; c.beginPath(); if (0 < n.length) {
                    for (var B = !1, u = 0; u < n.length; u++)if (m = n[u].getTime ? n[u].x.getTime() : n[u].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !B))) if ("number" !== typeof n[u].y) 0 <
                      u && !(k.connectNullData || B || r) && (c.stroke(), v && b.stroke()), B = !0; else {
                      var D = x; m = a.axisX.convertValueToPixel(m); x = a.axisY.convertValueToPixel(n[u].y); var z = k.dataPointIds[u]; this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: u, x1: m, y1: x }; r || B ? (!r && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)),
                        c.lineTo(m, D), c.lineTo(m, x), v && (b.lineTo(m, D), b.lineTo(m, x))) : (c.beginPath(), c.moveTo(m, x), v && (b.beginPath(), b.moveTo(m, x))), B = r = !1) : (c.lineTo(m, D), v && b.lineTo(m, D), c.lineTo(m, x), v && b.lineTo(m, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(m, x), v && (b.stroke(), b.beginPath(), b.moveTo(m, x)))); l = { x: m, y: x }; u < n.length - 1 && (h !== (n[u].lineColor || t) || p !== (n[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(m, x), h = n[u].lineColor || t, c.strokeStyle = h, c.setLineDash && (n[u].lineDashType ? (p = n[u].lineDashType,
                          c.setLineDash(I(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g)))); if (0 < n[u].markerSize || 0 < k.markerSize) D = k.getMarkerProperties(u, m, x, c), f.push(D), z = O(z), v && f.push({ x: m, y: x, ctx: b, type: D.type, size: D.size, color: z, borderColor: z, borderThickness: D.borderThickness }); (n[u].indexLabel || k.indexLabel || n[u].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "stepLine", dataPoint: n[u], dataSeries: k, point: { x: m, y: x }, direction: 0 > n[u].y === a.axisY.reversed ? 1 : -1, color: t })
                    } c.stroke();
                    v && b.stroke()
                  }
              } ba.drawMarkers(f); v && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), b.beginPath()); c.restore(); c.beginPath(); return {
          ...
          function d(a) {
            ...
            var f = this.plotArea; b.beginPath(); b.rect(f.x1, f.y1, f.width, f.height); b.clip(); for (var l = [], s = 0; s < a.dataSeriesIndexes.length; s++) {
              var C = a.dataSeriesIndexes[s], k = this.data[C]; b.lineWidth = k.lineThickness; var n = k.dataPoints, p = "solid"; if (b.setLineDash) { var q = I(k.nullDataLineDashType, k.lineThickness), p = k.lineDashType, g = I(p, k.lineThickness); b.setLineDash(g) } var t = k.id; this._eventManager.objectMap[t] = { objectType: "dataSeries", dataSeriesIndex: C }; t = O(t); e.strokeStyle = t; e.lineWidth = 0 < k.lineThickness ? Math.max(k.lineThickness,
            ...
            var b = null, e = this.plotArea, f = 0, l, s, C, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, n = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width,
              0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, p = a.axisX.dataInfo.minDiff; isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range)); p = this.dataPointWidth = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0; this.dataPointMaxWidth && f > n && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n)); !this.dataPointMaxWidth && (this.dataPointMinWidth && n < f) && (n = Math.max(this.options.dataPointWidth ?
                this.dataPointWidth : -Infinity, f)); p < f && (p = f); p > n && (p = n); c.save(); v && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                  var q = a.dataSeriesIndexes[n], g = this.data[q], t = g.dataPoints; if (0 < t.length) for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < t.length; f++)if (t[f].getTime ? C = t[f].x.getTime() :
                    C = t[f].x, !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[f].y) {
                    l = a.axisX.convertValueToPixel(C); s = a.axisY.convertValueToPixel(t[f].y); l = a.axisX.reversed ? l + a.plotType.totalDataSeries * p / 2 - (a.previousDataSeriesCount + n) * p << 0 : l - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount + n) * p << 0; var r = a.axisX.reversed ? l - p << 0 : l + p << 0, u; 0 <= t[f].y ? u = k : (u = s, s = k); s > u && (b = s, s = u, u = b); b = t[f].color ? t[f].color : g._colorSet[f % g._colorSet.length]; da(c, a.axisX.reversed ? r : l, s, a.axisX.reversed ?
                      l : r, u, b, 0, null, h && (a.axisY.reversed ? 0 > t[f].y : 0 <= t[f].y), (a.axisY.reversed ? 0 <= t[f].y : 0 > t[f].y) && h, !1, !1, g.fillOpacity); b = g.dataPointIds[f]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: l, y1: s, x2: r, y2: u }; b = O(b); v && da(this._eventManager.ghostCtx, a.axisX.reversed ? r : l, s, a.axisX.reversed ? l : r, u, b, 0, null, !1, !1, !1, !1); (t[f].indexLabel || g.indexLabel || t[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
            ...
            var b = null, e = this.plotArea,
              f = [], l = [], s = [], C = [], k = 0, n, p, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), k = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1; n = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0; var g = a.axisX.dataInfo.minDiff; isFinite(g) || (g = 0.3 * Math.abs(a.axisX.range)); g = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(g) /
                Math.log(a.axisX.range) : Math.abs(g) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0; this.dataPointMaxWidth && k > n && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n)); !this.dataPointMaxWidth && (this.dataPointMinWidth && n < k) && (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k)); g < k && (g = k); g > n && (g = n); c.save(); v && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1,
                  e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                    var h = a.dataSeriesIndexes[t], r = this.data[h], u = r.dataPoints; if (0 < u.length) {
                      var m = 5 < g && r.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (k = 0; k < u.length; k++)if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                        n = a.axisX.convertValueToPixel(b); var x = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, B = x + g << 0, D; if (a.axisY.logarithmic ||
                          a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) s[b] = u[k].y + (s[b] ? s[b] : 0), 0 < s[b] && (p = a.axisY.convertValueToPixel(s[b]), D = "undefined" !== typeof f[b] ? f[b] : q, f[b] = p); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) C[b] = u[k].y + (C[b] ? C[b] : 0), D = a.axisY.convertValueToPixel(C[b]), p = "undefined" !== typeof l[b] ? l[b] : q, l[b] = D; else if (p = a.axisY.convertValueToPixel(u[k].y), 0 <= u[k].y) { var z = "undefined" !== typeof f[b] ? f[b] : 0; p -= z; D = q - z; f[b] = z + (D - p) } else z =
                            l[b] ? l[b] : 0, D = p + z, p = q + z, l[b] = z + (D - p); b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length]; da(c, x, a.axisY.reversed ? D : p, B, a.axisY.reversed ? p : D, b, 0, null, m && (a.axisY.reversed ? 0 > u[k].y : 0 <= u[k].y), (a.axisY.reversed ? 0 <= u[k].y : 0 > u[k].y) && m, !1, !1, r.fillOpacity); b = r.dataPointIds[k]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: x, y1: p, x2: B, y2: D }; b = O(b); v && da(this._eventManager.ghostCtx, x, p, B, D, b, 0, null, !1, !1, !1, !1); (u[k].indexLabel || r.indexLabel || u[k].indexLabelFormatter ||
                              r.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedColumn", dataPoint: u[k], dataSeries: r, point: { x: n, y: 0 <= u[k].y ? p : D }, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: x, y1: Math.min(p, D), x2: B, y2: Math.max(p, D) }, color: b })
                      }
                    }
          ...
          var d = a.targetCanvasCtx || this.plotArea.ctx, c = v ? this._preRenderCtx :
            d; if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              c.clip(); v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                var h = a.dataSeriesIndexes[t], r = this.data[h], u = r.dataPoints; if (0 < u.length) for (var m = 5 < g && r.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                  n = a.axisX.convertValueToPixel(b); p = 0 !== a.dataPointYSums[b] ?
                    100 * (u[k].y / a.dataPointYSums[b]) : 0; var x = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, B = x + g << 0, D; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) { s[b] = p + ("undefined" !== typeof s[b] ? s[b] : 0); if (0 >= s[b]) continue; p = a.axisY.convertValueToPixel(s[b]); D = f[b] ? f[b] : q; f[b] = p } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) C[b] = p + ("undefined" !== typeof C[b] ? C[b] : 0), D = a.axisY.convertValueToPixel(C[b]), p = l[b] ? l[b] : q, l[b] = D;
                      ...
                      m, !1, !1, r.fillOpacity); b = r.dataPointIds[k]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: x, y1: p, x2: B, y2: D }; b = O(b); v && da(this._eventManager.ghostCtx, x, p, B, D, b, 0, null, !1, !1, !1, !1); (u[k].indexLabel || r.indexLabel || u[k].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                        chartType: "stackedColumn100", dataPoint: u[k], dataSeries: r, point: { x: n, y: 0 <= u[k].y ? p : D }, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: {
                          x1: x, y1: Math.min(p, D), x2: B, y2: Math.max(p,
                            D)
                        }, color: b
                      })
                }
                ...
                source: d, dest: this.plotArea.ctx,
                animationCallback: N.yScaleAnimation, easingFunction: N.easing.easeOutQuart, animationBase: q < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : q > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : q
              }
            }
        }; m.prototype.renderBar = function (a) {
          var d = a.targetCanvasCtx || this.plotArea.ctx, c = v ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, e = this.plotArea, f = 0, l, s, C, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ?
                ...
                Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n)); !this.dataPointMaxWidth && (this.dataPointMinWidth && n < f) && (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f)); p < f && (p = f); p > n && (p = n); c.save(); v && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                  var q =
                    a.dataSeriesIndexes[n], g = this.data[q], t = g.dataPoints; if (0 < t.length) {
                      var h = 5 < p && g.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (f = 0; f < t.length; f++)if (t[f].getTime ? C = t[f].x.getTime() : C = t[f].x, !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[f].y) {
                        s = a.axisX.convertValueToPixel(C); l = a.axisY.convertValueToPixel(t[f].y); s = a.axisX.reversed ? s + a.plotType.totalDataSeries * p / 2 - (a.previousDataSeriesCount + n) * p << 0 : s - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount +
          ...
          var d = a.targetCanvasCtx || this.plotArea.ctx,
            c = v ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              c.rect(e.x1, e.y1, e.width, e.height); c.clip(); v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                var h = a.dataSeriesIndexes[t], r = this.data[h], u = r.dataPoints; if (0 < u.length) {
                  var m = 5 < g && r.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (k = 0; k < u.length; k++)if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" ===
                    typeof u[k].y) {
                    p = a.axisX.convertValueToPixel(b); var x = p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, B = x + g << 0, D; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) s[b] = u[k].y + (s[b] ? s[b] : 0), 0 < s[b] && (D = f[b] ? f[b] : q, f[b] = n = a.axisY.convertValueToPixel(s[b])); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) C[b] = u[k].y + (C[b] ? C[b] : 0), n = l[b] ? l[b] : q, l[b] = D = a.axisY.convertValueToPixel(C[b]); else if (n = a.axisY.convertValueToPixel(u[k].y),
                      0 <= u[k].y) { var z = f[b] ? f[b] : 0; D = q + z; n += z; f[b] = z + (n - D) } else z = l[b] ? l[b] : 0, D = n - z, n = q - z, l[b] = z + (n - D); b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length]; da(c, a.axisY.reversed ? n : D, x, a.axisY.reversed ? D : n, B, b, 0, null, m, !1, !1, !1, r.fillOpacity); b = r.dataPointIds[k]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: D, y1: x, x2: n, y2: B }; b = O(b); v && da(this._eventManager.ghostCtx, D, x, n, B, b, 0, null, !1, !1, !1, !1); (u[k].indexLabel || r.indexLabel || u[k].indexLabelFormatter ||
                        r.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar", dataPoint: u[k], dataSeries: r, point: { x: 0 <= u[k].y ? n : D, y: p }, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(D, n), y1: x, x2: Math.max(D, n), y2: B }, color: b })
                  }
                }
            ...
            var b =
              null, e = this.plotArea, f = [], l = [], s = [], C = [], k = 0, n, p, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), k = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1; p = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.height << 0; var g = a.axisX.dataInfo.minDiff; isFinite(g) || (g = 0.3 * Math.abs(a.axisX.range)); g = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.height * (a.axisX.logarithmic ?
                Math.log(g) / Math.log(a.axisX.range) : Math.abs(g) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0; this.dataPointMaxWidth && k > p && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, p)); !this.dataPointMaxWidth && (this.dataPointMinWidth && p < k) && (p = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k)); g < k && (g = k); g > p && (g = p); c.save(); v && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); v && (this._eventManager.ghostCtx.beginPath(),
                  this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                    var h = a.dataSeriesIndexes[t], r = this.data[h], u = r.dataPoints; if (0 < u.length) {
                      var m = 5 < g && r.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (k = 0; k < u.length; k++)if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                        p = a.axisX.convertValueToPixel(b); var x; x = 0 !== a.dataPointYSums[b] ? 100 *
                          (u[k].y / a.dataPointYSums[b]) : 0; var B = p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, D = B + g << 0; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) { s[b] = x + (s[b] ? s[b] : 0); if (0 >= s[b]) continue; x = f[b] ? f[b] : q; f[b] = n = a.axisY.convertValueToPixel(s[b]) } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) C[b] = x + (C[b] ? C[b] : 0), n = l[b] ? l[b] : q, l[b] = x = a.axisY.convertValueToPixel(C[b]); else if (n = a.axisY.convertValueToPixel(x), 0 <= u[k].y) {
                            var z =
                              f[b] ? f[b] : 0; x = q + z; n += z; a.dataSeriesIndexes.length - 1 === t && 1 >= Math.abs(e.x2 - n) && (n = e.x2); f[b] = z + (n - x)
                          } else z = l[b] ? l[b] : 0, x = n - z, n = q - z, a.dataSeriesIndexes.length - 1 === t && 1 >= Math.abs(e.x1 - x) && (x = e.x1), l[b] = z + (n - x); b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length]; da(c, a.axisY.reversed ? n : x, B, a.axisY.reversed ? x : n, D, b, 0, null, m, !1, !1, !1, r.fillOpacity); b = r.dataPointIds[k]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: x, y1: B, x2: n, y2: D }; b = O(b); v && da(this._eventManager.ghostCtx,
                            x, B, n, D, b, 0, null, !1, !1, !1, !1); (u[k].indexLabel || r.indexLabel || u[k].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: u[k], dataSeries: r, point: { x: 0 <= u[k].y ? n : x, y: p }, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(x, n), y1: B, x2: Math.max(x, n), y2: D }, color: b })
                      }
                    }
          ...
          function (a) {
            var d, c; function b() { D && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? B = x : 0 > a.axisY.viewportMaximum ? B = s.y1 : 0 < a.axisY.viewportMinimum && (B = x), f.lineTo(r, B), f.lineTo(D.x, B), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, v && (l.lineTo(r, B), l.lineTo(D.x, B), l.closePath(), l.fill()), f.beginPath(), f.moveTo(r, u), l.beginPath(), l.moveTo(r, u), D = { x: r, y: u }) } var e = a.targetCanvasCtx || this.plotArea.ctx, f = v ? this._preRenderCtx :
              e; if (!(0 >= a.dataSeriesIndexes.length)) {
                var l = this._eventManager.ghostCtx, s = a.axisY.lineCoordinates, C = [], k = this.plotArea, n; f.save(); v && l.save(); f.beginPath(); f.rect(k.x1, k.y1, k.width, k.height); f.clip(); v && (l.beginPath(), l.rect(k.x1, k.y1, k.width, k.height), l.clip()); for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                  var q = a.dataSeriesIndexes[p], g = this.data[q], t = g.dataPoints, C = g.id; this._eventManager.objectMap[C] = { objectType: "dataSeries", dataSeriesIndex: q }; C = O(C); l.fillStyle = C; C = []; d = !0; var h = 0, r, u, m, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                    a.axisY.viewportMinimum : 0), B, D = null; if (0 < t.length) {
                      var z = g._colorSet[h % g._colorSet.length], w = g.lineColor = g.options.lineColor || z, E = w; f.fillStyle = z; f.strokeStyle = w; f.lineWidth = g.lineThickness; c = "solid"; if (f.setLineDash) { var T = I(g.nullDataLineDashType, g.lineThickness); c = g.lineDashType; var S = I(c, g.lineThickness); f.setLineDash(S) } for (var fa = !0; h < t.length; h++)if (m = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !fa))) if ("number" !==
                        ...
                        r = a.axisX.convertValueToPixel(m); u = a.axisY.convertValueToPixel(t[h].y); d || fa ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = r, c = u, r = n.x, u = n.y, b(), f.moveTo(n.x, n.y), r = d, u = c, D = n, c = g.nullDataLineDashType, f.setLineDash(T)), f.lineTo(r, u), v && l.lineTo(r, u)) : (f.beginPath(), f.moveTo(r, u), v && (l.beginPath(), l.moveTo(r, u)), D = { x: r, y: u }), fa = d = !1) : (f.lineTo(r, u), v && l.lineTo(r,
                          u), 0 == h % 250 && b()); n = { x: r, y: u }; h < t.length - 1 && (E !== (t[h].lineColor || w) || c !== (t[h].lineDashType || g.lineDashType)) && (b(), E = t[h].lineColor || w, f.strokeStyle = E, f.setLineDash && (t[h].lineDashType ? (c = t[h].lineDashType, f.setLineDash(I(c, g.lineThickness))) : (c = g.lineDashType, f.setLineDash(S)))); var aa = g.dataPointIds[h]; this._eventManager.objectMap[aa] = { id: aa, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: h, x1: r, y1: u }; 0 !== t[h].markerSize && (0 < t[h].markerSize || 0 < g.markerSize) && (m = g.getMarkerProperties(h,
                            r, u, f), C.push(m), aa = O(aa), v && C.push({ x: r, y: u, ctx: l, type: m.type, size: m.size, color: aa, borderColor: aa, borderThickness: m.borderThickness })); (t[h].indexLabel || g.indexLabel || t[h].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "area", dataPoint: t[h], dataSeries: g, point: { x: r, y: u }, direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1, color: z })
                      } b(); ba.drawMarkers(C)
                    }
            ...
            function d() {
              var c =
                w(y, 2); if (0 < c.length) {
                  if (0 < n.lineThickness) {
                    ...
                    x: c[0].x,
                    y: c[0].y
                  }; b.lineTo(c[c.length - 1].x, m); b.lineTo(u.x, m); b.closePath(); b.globalAlpha = n.fillOpacity; b.fill(); b.globalAlpha = 1; v && (e.lineTo(c[c.length - 1].x, m), e.lineTo(u.x, m), e.closePath(), e.fill())
                }
            } var c = a.targetCanvasCtx || this.plotArea.ctx, b = v ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = this._eventManager.ghostCtx, f = a.axisY.lineCoordinates, l = [], s = this.plotArea; b.save(); v && e.save(); b.beginPath(); b.rect(s.x1, s.y1, s.width, s.height); b.clip(); v && (e.beginPath(), e.rect(s.x1, s.y1, s.width,
                s.height), e.clip()); for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                  var k = a.dataSeriesIndexes[h], n = this.data[k], p = n.dataPoints, l = n.id; this._eventManager.objectMap[l] = { objectType: "dataSeries", dataSeriesIndex: k }; l = O(l); e.fillStyle = l; var l = [], q = 0, g, t, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), m, u = null, y = []; if (0 < p.length) {
                    var x = n._colorSet[q % n._colorSet.length], B = n.lineColor = n.options.lineColor || x, D = B; b.fillStyle = x; b.strokeStyle = B; b.lineWidth = n.lineThickness; var z = "solid";
            ...
            var d, c; function b() { D && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? B = x : 0 > a.axisY.viewportMaximum ? B = s.y1 : 0 < a.axisY.viewportMinimum && (B = x), f.lineTo(m, B), f.lineTo(D.x, B), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, v && (l.lineTo(m, B), l.lineTo(D.x, B), l.closePath(), l.fill()), f.beginPath(), f.moveTo(m, u), l.beginPath(), l.moveTo(m, u), D = { x: m, y: u }) } var e = a.targetCanvasCtx ||
              this.plotArea.ctx, f = v ? this._preRenderCtx : e; if (!(0 >= a.dataSeriesIndexes.length)) {
                var l = this._eventManager.ghostCtx, s = a.axisY.lineCoordinates, h = [], k = this.plotArea, n; f.save(); v && l.save(); f.beginPath(); f.rect(k.x1, k.y1, k.width, k.height); f.clip(); v && (l.beginPath(), l.rect(k.x1, k.y1, k.width, k.height), l.clip()); for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                  var q = a.dataSeriesIndexes[p], g = this.data[q], t = g.dataPoints, h = g.id; this._eventManager.objectMap[h] = { objectType: "dataSeries", dataSeriesIndex: q }; h = O(h); l.fillStyle =
                    h; h = []; d = !0; var r = 0, m, u, y, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), B, D = null; c = !1; if (0 < t.length) {
                      var z = g._colorSet[r % g._colorSet.length], w = g.lineColor = g.options.lineColor || z, E = w; f.fillStyle = z; f.strokeStyle = w; f.lineWidth = g.lineThickness; var T = "solid"; if (f.setLineDash) { var S = I(g.nullDataLineDashType, g.lineThickness), T = g.lineDashType, fa = I(T, g.lineThickness); f.setLineDash(fa) } for (; r < t.length; r++)if (y = t[r].x.getTime ? t[r].x.getTime() : t[r].x, !(y < a.axisX.dataInfo.viewPortMin ||
                        ...
                        var aa = u; "number" !== typeof t[r].y ? (g.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(y), u = a.axisY.convertValueToPixel(t[r].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || T === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = u, m = n.x, u = n.y, b(), f.moveTo(n.x, n.y), m = d, u = c, D = n, T = g.nullDataLineDashType, f.setLineDash(S)), f.lineTo(m, aa), f.lineTo(m, u), v && (l.lineTo(m, aa), l.lineTo(m, u))) :
                          ...
                          }, 0 !== t[r].markerSize && (0 < t[r].markerSize || 0 < g.markerSize) && (aa = g.getMarkerProperties(r, m, u, f), h.push(aa), y = O(y), v && h.push({ x: m, y: u, ctx: l, type: aa.type, size: aa.size, color: y, borderColor: y, borderThickness: aa.borderThickness })), (t[r].indexLabel || g.indexLabel || t[r].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "stepArea", dataPoint: t[r], dataSeries: g, point: { x: m, y: u }, direction: 0 > t[r].y === a.axisY.reversed ? 1 : -1, color: z }))
                      } b(); ba.drawMarkers(h)
                    }
                } v &&
            ...
            function d() { if (!(1 > k.length)) { for (0 < z.lineThickness && b.stroke(); 0 < k.length;) { var a = k.pop(); b.lineTo(a.x, a.y); v && m.lineTo(a.x, a.y) } b.closePath(); b.globalAlpha = z.fillOpacity; b.fill(); b.globalAlpha = 1; b.beginPath(); v && (m.closePath(), m.fill(), m.beginPath()); k = [] } } var c = a.targetCanvasCtx || this.plotArea.ctx, b = v ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, f = null, l = [], s = this.plotArea, h = [],
                k = [], n = [], p = [], q = 0, g, t, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), m = this._eventManager.ghostCtx, u, y, x; v && m.beginPath(); b.save(); v && m.save(); b.beginPath(); b.rect(s.x1, s.y1, s.width, s.height); b.clip(); v && (m.beginPath(), m.rect(s.x1, s.y1, s.width, s.height), m.clip()); for (var e = [], B = 0; B < a.dataSeriesIndexes.length; B++) {
                  var D = a.dataSeriesIndexes[B], z = this.data[D], w = z.dataPoints; z.dataPointIndexes = []; for (q = 0; q < w.length; q++)D = w[q].x.getTime ? w[q].x.getTime() : w[q].x, z.dataPointIndexes[D] =
                    q, e[D] || (n.push(D), e[D] = !0); n.sort(Qa)
                } for (B = 0; B < a.dataSeriesIndexes.length; B++) {
                  D = a.dataSeriesIndexes[B]; z = this.data[D]; w = z.dataPoints; y = !0; k = []; q = z.id; this._eventManager.objectMap[q] = { objectType: "dataSeries", dataSeriesIndex: D }; q = O(q); m.fillStyle = q; if (0 < n.length) {
                    var e = z._colorSet[0], E = z.lineColor = z.options.lineColor || e, T = E; b.fillStyle = e; b.strokeStyle = E; b.lineWidth = z.lineThickness; x = "solid"; if (b.setLineDash) {
                      var S = I(z.nullDataLineDashType, z.lineThickness); x = z.lineDashType; var fa = I(x, z.lineThickness);
                      b.setLineDash(fa)
                    } for (var aa = !0, q = 0; q < n.length; q++) {
                      var f = n[q], ia = null, ia = 0 <= z.dataPointIndexes[f] ? w[z.dataPointIndexes[f]] : { x: f, y: null }; if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !aa))) if ("number" !== typeof ia.y) z.connectNullData || (aa || y) || d(), aa = !0; else {
                        g = a.axisX.convertValueToPixel(f); var oa = h[f] ? h[f] : 0; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                          p[f] = ia.y + (p[f] ? p[f] : 0); if (0 >= p[f] && a.axisY.logarithmic) continue;
                          t = a.axisY.convertValueToPixel(p[f])
                        } else t = a.axisY.convertValueToPixel(ia.y), t -= oa; k.push({ x: g, y: r - oa }); h[f] = r - t; y || aa ? (!y && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || x === z.lineDashType && z.lineDashType !== z.nullDataLineDashType) && (y = k.pop(), x = k[k.length - 1], d(), b.moveTo(u.x, u.y), k.push(x), k.push(y), x = z.nullDataLineDashType, b.setLineDash(S)), b.lineTo(g, t), v && m.lineTo(g, t)) : (b.beginPath(), b.moveTo(g, t), v && (m.beginPath(), m.moveTo(g, t))), aa = y = !1) : (b.lineTo(g, t), v && m.lineTo(g, t),
                          0 == q % 250 && (d(), b.moveTo(g, t), v && m.moveTo(g, t), k.push({ x: g, y: r - oa }))); u = { x: g, y: t }; q < w.length - 1 && (T !== (w[q].lineColor || E) || x !== (w[q].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, t), k.push({ x: g, y: r - oa }), T = w[q].lineColor || E, b.strokeStyle = T, b.setLineDash && (w[q].lineDashType ? (x = w[q].lineDashType, b.setLineDash(I(x, z.lineThickness))) : (x = z.lineDashType, b.setLineDash(fa)))); if (0 <= z.dataPointIndexes[f]) {
                            var A = z.dataPointIds[z.dataPointIndexes[f]]; this._eventManager.objectMap[A] = {
                              id: A, objectType: "dataPoint",
                              dataSeriesIndex: D, dataPointIndex: z.dataPointIndexes[f], x1: g, y1: t
                            }
                          } 0 <= z.dataPointIndexes[f] && 0 !== ia.markerSize && (0 < ia.markerSize || 0 < z.markerSize) && (oa = z.getMarkerProperties(z.dataPointIndexes[f], g, t, b), l.push(oa), f = O(A), v && l.push({ x: g, y: t, ctx: m, type: oa.type, size: oa.size, color: f, borderColor: f, borderThickness: oa.borderThickness })); (ia.indexLabel || z.indexLabel || ia.indexLabelFormatter || z.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "stackedArea", dataPoint: ia, dataSeries: z, point: { x: g, y: t }, direction: 0 >
                              w[q].y === a.axisY.reversed ? 1 : -1, color: e
                          })
                      }
                    } d(); b.moveTo(g, t); v && m.moveTo(g, t)
            ...
            function d() { for (0 < z.lineThickness && b.stroke(); 0 < k.length;) { var a = k.pop(); b.lineTo(a.x, a.y); v && x.lineTo(a.x, a.y) } b.closePath(); b.globalAlpha = z.fillOpacity; b.fill(); b.globalAlpha = 1; b.beginPath(); v && (x.closePath(), x.fill(), x.beginPath()); k = [] } var c = a.targetCanvasCtx || this.plotArea.ctx,
              b = v ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, l = this.plotArea, s = [], h = [], k = [], n = [], p = [], q = 0, g, t, r, m, u, y = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), x = this._eventManager.ghostCtx; b.save(); v && x.save(); b.beginPath(); b.rect(l.x1, l.y1, l.width, l.height); b.clip(); v && (x.beginPath(), x.rect(l.x1, l.y1, l.width, l.height), x.clip()); for (var e = [], B = 0; B < a.dataSeriesIndexes.length; B++) {
                  var D = a.dataSeriesIndexes[B], z = this.data[D], w = z.dataPoints; z.dataPointIndexes =
                    []; for (q = 0; q < w.length; q++)D = w[q].x.getTime ? w[q].x.getTime() : w[q].x, z.dataPointIndexes[D] = q, e[D] || (n.push(D), e[D] = !0); n.sort(Qa)
                } for (B = 0; B < a.dataSeriesIndexes.length; B++) {
                  D = a.dataSeriesIndexes[B]; z = this.data[D]; w = z.dataPoints; m = !0; e = z.id; this._eventManager.objectMap[e] = { objectType: "dataSeries", dataSeriesIndex: D }; e = O(e); x.fillStyle = e; k = []; if (0 < n.length) {
                    var e = z._colorSet[q % z._colorSet.length], E = z.lineColor = z.options.lineColor || e, T = E; b.fillStyle = e; b.strokeStyle = E; b.lineWidth = z.lineThickness; u = "solid";
                    if (b.setLineDash) { var S = I(z.nullDataLineDashType, z.lineThickness); u = z.lineDashType; var A = I(u, z.lineThickness); b.setLineDash(A) } for (var aa = !0, q = 0; q < n.length; q++) {
                      var f = n[q], ia = null, ia = 0 <= z.dataPointIndexes[f] ? w[z.dataPointIndexes[f]] : { x: f, y: null }; if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !aa))) if ("number" !== typeof ia.y) z.connectNullData || (aa || m) || d(), aa = !0; else {
                        var oa; oa = 0 !== a.dataPointYSums[f] ? 100 * (ia.y / a.dataPointYSums[f]) : 0; g = a.axisX.convertValueToPixel(f);
                        var na = h[f] ? h[f] : 0; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { p[f] = oa + (p[f] ? p[f] : 0); if (0 >= p[f] && a.axisY.logarithmic) continue; t = a.axisY.convertValueToPixel(p[f]) } else t = a.axisY.convertValueToPixel(oa), t -= na; k.push({ x: g, y: y - na }); h[f] = y - t; m || aa ? (!m && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || u === z.lineDashType && z.lineDashType !== z.nullDataLineDashType) && (m = k.pop(), u = k[k.length - 1], d(), b.moveTo(r.x, r.y), k.push(u), k.push(m), u = z.nullDataLineDashType,
                          b.setLineDash(S)), b.lineTo(g, t), v && x.lineTo(g, t)) : (b.beginPath(), b.moveTo(g, t), v && (x.beginPath(), x.moveTo(g, t))), aa = m = !1) : (b.lineTo(g, t), v && x.lineTo(g, t), 0 == q % 250 && (d(), b.moveTo(g, t), v && x.moveTo(g, t), k.push({ x: g, y: y - na }))); r = { x: g, y: t }; q < w.length - 1 && (T !== (w[q].lineColor || E) || u !== (w[q].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, t), k.push({ x: g, y: y - na }), T = w[q].lineColor || E, b.strokeStyle = T, b.setLineDash && (w[q].lineDashType ? (u = w[q].lineDashType, b.setLineDash(I(u, z.lineThickness))) : (u =
                            z.lineDashType, b.setLineDash(A)))); if (0 <= z.dataPointIndexes[f]) { var G = z.dataPointIds[z.dataPointIndexes[f]]; this._eventManager.objectMap[G] = { id: G, objectType: "dataPoint", dataSeriesIndex: D, dataPointIndex: z.dataPointIndexes[f], x1: g, y1: t } } 0 <= z.dataPointIndexes[f] && 0 !== ia.markerSize && (0 < ia.markerSize || 0 < z.markerSize) && (na = z.getMarkerProperties(q, g, t, b), s.push(na), f = O(G), v && s.push({ x: g, y: t, ctx: x, type: na.type, size: na.size, color: f, borderColor: f, borderThickness: na.borderThickness })); (ia.indexLabel || z.indexLabel ||
                              ia.indexLabelFormatter || z.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea100", dataPoint: ia, dataSeries: z, point: { x: g, y: t }, direction: 0 > w[q].y === a.axisY.reversed ? 1 : -1, color: e })
                      }
                    } d(); b.moveTo(g, t); v && x.moveTo(g, t)
                  } delete z.dataPointIndexes
                } ba.drawMarkers(s); v && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas,
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = v ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = this.plotArea, e = 0, f, l; c.save();
              v && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(b.x1, b.y1, b.width, b.height); c.clip(); v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.clip()); for (var s = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)for (var n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints, g = 0, e = 0; e < q.length; e++)f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" ===
                typeof q[e].z || (g = q[e].z, g > s && (s = g), g < h && (h = g)); for (var t = 25 * Math.PI, r = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, t), k = 0; k < a.dataSeriesIndexes.length; k++)if (n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints, 0 < q.length) for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y) {
                  ...
                  var g = q[e].z, m = 2 * Math.max(Math.sqrt((s === h ? r / 2 : t + (r - t) / (s - h) * (g - h)) / Math.PI) << 0, 1), g = p.getMarkerProperties(e, c); g.size = m; c.globalAlpha = p.fillOpacity; ba.drawMarker(f, l, c, g.type, g.size, g.color, g.borderColor, g.borderThickness); c.globalAlpha = 1; var u = p.dataPointIds[e]; this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: e, x1: f, y1: l, size: m }; m = O(u); v && ba.drawMarker(f, l, this._eventManager.ghostCtx, g.type, g.size, m, m, g.borderThickness); (q[e].indexLabel || p.indexLabel ||
                    q[e].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({ chartType: "bubble", dataPoint: q[e], dataSeries: p, point: { x: f, y: l }, direction: 1, bounds: { x1: f - g.size / 2, y1: l - g.size / 2, x2: f + g.size / 2, y2: l + g.size / 2 }, color: null })
                } v && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx &&
                  this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.restore()); c.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: N.fadeInAnimation, easingFunction: N.easing.easeInQuad, animationBase: 0 }
            }
          }; m.prototype.renderScatter = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = v ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = this.plotArea, e = 0, f, l; c.save(); v && this._eventManager.ghostCtx.save();
              c.beginPath(); c.rect(b.x1, b.y1, b.width, b.height); c.clip(); v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.clip()); for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                var h = a.dataSeriesIndexes[s], k = this.data[h], n = k.dataPoints; if (0 < n.length) {
                  c.strokeStyle = "#4572A7 "; Math.pow(0.3 * Math.min(b.height, b.width) / 2, 2); for (var p = 0, q = 0, e = 0; e < n.length; e++)if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                    f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                    f = a.axisX.convertValueToPixel(f); l = a.axisY.convertValueToPixel(n[e].y); var g = k.getMarkerProperties(e, f, l, c); c.globalAlpha = k.fillOpacity; ba.drawMarker(g.x, g.y, g.ctx, g.type, g.size, g.color, g.borderColor, g.borderThickness); c.globalAlpha = 1; Math.sqrt((p - f) * (p - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (p = k.dataPointIds[e], this._eventManager.objectMap[p] = {
                      id: p, objectType: "dataPoint", dataSeriesIndex: h,
                      dataPointIndex: e, x1: f, y1: l
                    }, p = O(p), v && ba.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness), (n[e].indexLabel || k.indexLabel || n[e].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "scatter", dataPoint: n[e], dataSeries: k, point: { x: f, y: l }, direction: 1, bounds: { x1: f - g.size / 2, y1: l - g.size / 2, x2: f + g.size / 2, y2: l + g.size / 2 }, color: null }), p = f, q = l)
                  }
                }
            ...
            function (a) {
                    ...
                    l.height), b.clip()); for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                      var L = a.dataSeriesIndexes[m], u = this.data[L], y = u.dataPoints; if (0 < y.length) for (var x = 5 < t && u.bevelEnabled ? !0 : !1, s = 0; s < y.length; s++)if (y[s].getTime ? g = y[s].x.getTime() : g = y[s].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(y[s].y) && y[s].y.length && "number" === typeof y[s].y[0] && "number" === typeof y[s].y[1] && "number" === typeof y[s].y[2] && "number" === typeof y[s].y[3]) {
                        ...
                        c.lineWidth = z; b.lineWidth = Math.max(z, 4); "candlestick" === u.type ? (c.moveTo(h - w, n), c.lineTo(h - w, Math.min(k, q)), c.stroke(), c.moveTo(h - w, Math.max(k, q)), c.lineTo(h - w, p), c.stroke(), da(c, B, Math.min(k, q), D, Math.max(k, q), y[s].y[0] <= y[s].y[3] ? u.risingColor : f, z, e, x, x, !1, !1, u.fillOpacity), v && (e = O(E), b.strokeStyle = e, b.moveTo(h - w, n), b.lineTo(h - w, Math.min(k, q)), b.stroke(), b.moveTo(h - w, Math.max(k, q)), b.lineTo(h - w, p), b.stroke(), da(b, B, Math.min(k, q), D, Math.max(k, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === u.type && (c.moveTo(h -
                          w, n), c.lineTo(h - w, p), c.stroke(), c.beginPath(), c.moveTo(h, k), c.lineTo(B, k), c.stroke(), c.beginPath(), c.moveTo(h, q), c.lineTo(D, q), c.stroke(), v && (e = O(E), b.strokeStyle = e, b.moveTo(h - w, n), b.lineTo(h - w, p), b.stroke(), b.beginPath(), b.moveTo(h, k), b.lineTo(B, k), b.stroke(), b.beginPath(), b.moveTo(h, q), b.lineTo(D, q), b.stroke())); (y[s].indexLabel || u.indexLabel || y[s].indexLabelFormatter || u.indexLabelFormatter) && this._indexLabels.push({
                            chartType: u.type, dataPoint: y[s], dataSeries: u, point: {
                              x: B + (D - B) / 2, y: a.axisY.reversed ?
                                p : n
                            }, direction: 1, bounds: { x1: B, y1: Math.min(n, p), x2: D, y2: Math.max(n, p) }, color: e
                          })
                      }
                    } v && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(l.x1, l.y1, l.width, l.height), b.restore());
                c.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: N.fadeInAnimation, easingFunction: N.easing.easeInQuad, animationBase: 0 }
              }
            }; m.prototype.renderBoxAndWhisker = function (a) {
              var d = a.targetCanvasCtx || this.plotArea.ctx, c = v ? this._preRenderCtx : d, b = this._eventManager.ghostCtx; if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = this.plotArea, l = 0, s, h, k, n, p, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, l = this.options.dataPointMaxWidth ?
                  this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, t = a.axisX.dataInfo.minDiff; isFinite(t) || (t = 0.3 * Math.abs(a.axisX.range)); t = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * f.width * (a.axisX.logarithmic ? Math.log(t) / Math.log(a.axisX.range) : Math.abs(t) / Math.abs(a.axisX.range)) << 0; this.dataPointMaxWidth && e > l && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, l)); !this.dataPointMaxWidth && (this.dataPointMinWidth && l < e) && (l = Math.max(this.options.dataPointWidth ?
                    this.dataPointWidth : -Infinity, e)); t < e && (t = e); t > l && (t = l); c.save(); v && b.save(); c.beginPath(); c.rect(f.x1, f.y1, f.width, f.height); c.clip(); v && (b.beginPath(), b.rect(f.x1, f.y1, f.width, f.height), b.clip()); for (var m = !1, m = !!a.axisY.reversed, L = 0; L < a.dataSeriesIndexes.length; L++) {
                      var u = a.dataSeriesIndexes[L], y = this.data[u], x = y.dataPoints; if (0 < x.length) for (var B = 5 < t && y.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++)if (x[l].getTime ? g = x[l].x.getTime() : g = x[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) &&
                        ...
                        s = a.axisX.convertValueToPixel(g); h = a.axisY.convertValueToPixel(x[l].y[0]); k = a.axisY.convertValueToPixel(x[l].y[1]); n = a.axisY.convertValueToPixel(x[l].y[2]); p = a.axisY.convertValueToPixel(x[l].y[3]); q = a.axisY.convertValueToPixel(x[l].y[4]); var D = s - t / 2 << 0, z = s + t / 2 << 0, e = x[l].color ? x[l].color : y._colorSet[0], w = Math.round(Math.max(1,
                          0.15 * t)), E = 0 === w % 2 ? 0 : 0.5, T = x[l].whiskerColor ? x[l].whiskerColor : x[l].color ? y.whiskerColor ? y.whiskerColor : x[l].color : y.whiskerColor ? y.whiskerColor : e, S = "number" === typeof x[l].whiskerThickness ? x[l].whiskerThickness : "number" === typeof y.options.whiskerThickness ? y.whiskerThickness : w, A = x[l].whiskerDashType ? x[l].whiskerDashType : y.whiskerDashType, aa = r(x[l].whiskerLength) ? r(y.options.whiskerLength) ? t : y.whiskerLength : x[l].whiskerLength, aa = "number" === typeof aa ? 0 >= aa ? 0 : aa >= t ? t : aa : "string" === typeof aa ? parseInt(aa) *
                            t / 100 > t ? t : parseInt(aa) * t / 100 : t, ia = 1 === Math.round(S) % 2 ? 0.5 : 0, oa = x[l].stemColor ? x[l].stemColor : x[l].color ? y.stemColor ? y.stemColor : x[l].color : y.stemColor ? y.stemColor : e, na = "number" === typeof x[l].stemThickness ? x[l].stemThickness : "number" === typeof y.options.stemThickness ? y.stemThickness : w, G = 1 === Math.round(na) % 2 ? 0.5 : 0, F = x[l].stemDashType ? x[l].stemDashType : y.stemDashType, K = x[l].lineColor ? x[l].lineColor : x[l].color ? y.lineColor ? y.lineColor : x[l].color : y.lineColor ? y.lineColor : e, J = "number" === typeof x[l].lineThickness ?
                              x[l].lineThickness : "number" === typeof y.options.lineThickness ? y.lineThickness : w, Q = x[l].lineDashType ? x[l].lineDashType : y.lineDashType, M = 1 === Math.round(J) % 2 ? 0.5 : 0, P = y.upperBoxColor, U = y.lowerBoxColor, ua = r(y.options.fillOpacity) ? 1 : y.fillOpacity, R = y.dataPointIds[l]; this._eventManager.objectMap[R] = {
                                id: R, objectType: "dataPoint", dataSeriesIndex: u, dataPointIndex: l, x1: D, y1: h, x2: z, y2: k, x3: s, y3: n, x4: s, y4: p, y5: q, borderThickness: w, color: e, stemThickness: na, stemColor: oa, whiskerThickness: S, whiskerLength: aa, whiskerColor: T,
                                lineThickness: J, lineColor: K
                              }; c.save(); 0 < na && (c.beginPath(), c.strokeStyle = oa, c.lineWidth = na, c.setLineDash && c.setLineDash(I(F, na)), c.moveTo(s - G, k), c.lineTo(s - G, h), c.stroke(), c.moveTo(s - G, p), c.lineTo(s - G, n), c.stroke()); c.restore(); b.lineWidth = Math.max(w, 4); c.beginPath(); da(c, D, Math.min(q, k), z, Math.max(k, q), U, 0, e, m ? B : !1, m ? !1 : B, !1, !1, ua); c.beginPath(); da(c, D, Math.min(n, q), z, Math.max(q, n), P, 0, e, m ? !1 : B, m ? B : !1, !1, !1, ua); c.beginPath(); c.lineWidth = w; c.strokeStyle = e; c.rect(D - E, Math.min(k, n) - E, z - D + 2 * E, Math.max(k,
                                n) - Math.min(k, n) + 2 * E); c.stroke(); c.save(); 0 < J && (c.beginPath(), c.globalAlpha = 1, c.setLineDash && c.setLineDash(I(Q, J)), c.strokeStyle = K, c.lineWidth = J, c.moveTo(D, q - M), c.lineTo(z, q - M), c.stroke()); c.restore(); c.save(); 0 < S && (c.beginPath(), c.setLineDash && c.setLineDash(I(A, S)), c.strokeStyle = T, c.lineWidth = S, c.moveTo(s - aa / 2 << 0, p - ia), c.lineTo(s + aa / 2 << 0, p - ia), c.stroke(), c.moveTo(s - aa / 2 << 0, h + ia), c.lineTo(s + aa / 2 << 0, h + ia), c.stroke()); c.restore(); v && (e = O(R), b.strokeStyle = e, b.lineWidth = na, 0 < na && (b.moveTo(s - E - G, k), b.lineTo(s -
                                  E - G, Math.max(h, p)), b.stroke(), b.moveTo(s - E - G, Math.min(h, p)), b.lineTo(s - E - G, n), b.stroke()), da(b, D, Math.max(k, n), z, Math.min(k, n), e, 0, null, !1, !1, !1, !1), 0 < S && (b.beginPath(), b.lineWidth = S, b.moveTo(s + aa / 2, p - ia), b.lineTo(s - aa / 2, p - ia), b.stroke(), b.moveTo(s + aa / 2, h + ia), b.lineTo(s - aa / 2, h + ia), b.stroke())); (x[l].indexLabel || y.indexLabel || x[l].indexLabelFormatter || y.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: y.type, dataPoint: x[l], dataSeries: y, point: { x: D + (z - D) / 2, y: a.axisY.reversed ? h : p }, direction: 1,
                                    bounds: { x1: D, y1: Math.min(h, p), x2: z, y2: Math.max(h, p) }, color: e
                                  })
                      }
                    } v && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(f.x1, f.y1, f.width, f.height), b.restore()); c.restore(); return {
                      source: d,
                      dest: this.plotArea.ctx, animationCallback: N.fadeInAnimation, easingFunction: N.easing.easeInQuad, animationBase: 0
                    }
              }
            }; m.prototype.renderRangeColumn = function (a) {
              var d = a.targetCanvasCtx || this.plotArea.ctx, c = v ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, l, s, h, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1; l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth :
                  0.03 * this.width; var k = a.axisX.dataInfo.minDiff; isFinite(k) || (k = 0.3 * Math.abs(a.axisX.range)); k = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(k) / Math.log(a.axisX.range) : Math.abs(k) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0; this.dataPointMaxWidth && f > l && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, l)); !this.dataPointMaxWidth && (this.dataPointMinWidth && l < f) && (l = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity,
                    f)); k < f && (k = f); k > l && (k = l); c.save(); v && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                      var p = a.dataSeriesIndexes[n], q = this.data[p], g = q.dataPoints; if (0 < g.length) for (var t = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)if (g[f].getTime ? h = g[f].x.getTime() : h = g[f].x, !(h < a.axisX.dataInfo.viewPortMin ||
                        ...
                        b = a.axisX.convertValueToPixel(h); l = a.axisY.convertValueToPixel(g[f].y[0]); s = a.axisY.convertValueToPixel(g[f].y[1]); var m = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + n) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount + n) * k << 0, L = a.axisX.reversed ? m - k << 0 : m + k << 0, b = g[f].color ? g[f].color : q._colorSet[f % q._colorSet.length]; if (l > s) {
                          var u = l; l =
                            s; s = u
                        } u = q.dataPointIds[f]; this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: p, dataPointIndex: f, x1: m, y1: l, x2: L, y2: s }; da(c, a.axisX.reversed ? L : m, l, a.axisX.reversed ? m : L, s, b, 0, b, t, t, !1, !1, q.fillOpacity); b = O(u); v && da(this._eventManager.ghostCtx, a.axisX.reversed ? L : m, l, a.axisX.reversed ? m : L, s, b, 0, null, !1, !1, !1, !1); if (g[f].indexLabel || q.indexLabel || g[f].indexLabelFormatter || q.indexLabelFormatter) this._indexLabels.push({
                          chartType: "rangeColumn", dataPoint: g[f], dataSeries: q, indexKeyword: 0,
                          point: { x: m + (L - m) / 2, y: g[f].y[1] >= g[f].y[0] ? s : l }, direction: g[f].y[1] >= g[f].y[0] ? -1 : 1, bounds: { x1: m, y1: Math.min(l, s), x2: L, y2: Math.max(l, s) }, color: b
                        }), this._indexLabels.push({ chartType: "rangeColumn", dataPoint: g[f], dataSeries: q, indexKeyword: 1, point: { x: m + (L - m) / 2, y: g[f].y[1] >= g[f].y[0] ? l : s }, direction: g[f].y[1] >= g[f].y[0] ? 1 : -1, bounds: { x1: m, y1: Math.min(l, s), x2: L, y2: Math.max(l, s) }, color: b })
                      }
              ...
              var d =
                a.targetCanvasCtx || this.plotArea.ctx, c = v ? this._preRenderCtx : d, b = a.axisY._position ? "left" === a.axisY._position || "right" === a.axisY._position ? !1 : !0 : !1; if (!(0 >= a.dataSeriesIndexes.length)) {
                  var e = null, f = !1, l = this.plotArea, s = 0, h, k, n, p, q, g, t, m = a.axisX.dataInfo.minDiff; isFinite(m) || (m = 0.3 * Math.abs(a.axisX.range)); c.save(); v && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(l.x1, l.y1, l.width, l.height); c.clip(); v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(l.x1, l.y1, l.width,
                    l.height), this._eventManager.ghostCtx.clip()); for (var L = 0, u = 0; u < this.data.length; u++)!this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && L || L++; for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
                      var x = a.dataSeriesIndexes[y], B = this.data[x], D = B.dataPoints, z = r(B._linkedSeries) ? !1 : B._linkedSeries.type.match(/(bar|column)/ig) && B._linkedSeries.visible ? !0 : !1, w = 0; if (z) for (e = B._linkedSeries.id, u = 0; u < e; u++)!this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible ||
                        this.data[u].type.match(/(stacked)/ig) && w || (this.data[u].type.match(/(range)/ig) && (f = !0), w++); e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1; s = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? L : 1))) << 0 : 0.3 * this.width; f && (s = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 *
                          this.height, 0.9 * (this.plotArea.height / (z ? L : 1))) << 0 : 0.03 * this.width); u = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? l.height : l.width) * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) / (z ? L : 1)) << 0; this.dataPointMaxWidth && e > s && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, s)); !this.dataPointMaxWidth && (this.dataPointMinWidth && s < e) && (s = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); u < e && (u = e); u > s && (u =
                            s); if (0 < D.length) for (var E = B._colorSet, s = 0; s < D.length; s++) {
                              var e = B.lineColor = B.options.color ? B.options.color : E[0], T = {
                                color: D[s].whiskerColor ? D[s].whiskerColor : D[s].color ? B.whiskerColor ? B.whiskerColor : D[s].color : B.whiskerColor ? B.whiskerColor : e, thickness: r(D[s].whiskerThickness) ? B.whiskerThickness : D[s].whiskerThickness, dashType: D[s].whiskerDashType ? D[s].whiskerDashType : B.whiskerDashType, length: r(D[s].whiskerLength) ? r(B.options.whiskerLength) ? u : B.options.whiskerLength : D[s].whiskerLength, trimLength: r(D[s].whiskerLength) ?
                                ...
                                color: D[s].stemColor ? D[s].stemColor : D[s].color ? B.stemColor ? B.stemColor : D[s].color : B.stemColor ? B.stemColor : e, thickness: D[s].stemThickness ? D[s].stemThickness : B.stemThickness, dashType: D[s].stemDashType ? D[s].stemDashType :
                                  B.stemDashType
                              }; S.thickness = "number" === typeof S.thickness ? 0 > S.thickness ? 0 : Math.round(S.thickness) : 2; D[s].getTime ? t = D[s].x.getTime() : t = D[s].x; if (!(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax) && !r(D[s].y) && D[s].y.length && "number" === typeof D[s].y[0] && "number" === typeof D[s].y[1]) {
                                var fa = a.axisX.convertValueToPixel(t); b ? k = fa : h = fa; fa = a.axisY.convertValueToPixel(D[s].y[0]); b ? n = fa : q = fa; fa = a.axisY.convertValueToPixel(D[s].y[1]); b ? p = fa : g = fa; b ? (q = a.axisX.reversed ? k + (z ? L : 1) * u / 2 - (z ? w - 1 : 0) * u <<
                                  0 : k - (z ? L : 1) * u / 2 + (z ? w - 1 : 0) * u << 0, g = a.axisX.reversed ? q - u << 0 : q + u << 0) : (n = a.axisX.reversed ? h + (z ? L : 1) * u / 2 - (z ? w - 1 : 0) * u << 0 : h - (z ? L : 1) * u / 2 + (z ? w - 1 : 0) * u << 0, p = a.axisX.reversed ? n - u << 0 : n + u << 0); !b && q > g && (fa = q, q = g, g = fa); b && n > p && (fa = n, n = p, p = fa); fa = B.dataPointIds[s]; this._eventManager.objectMap[fa] = { id: fa, objectType: "dataPoint", dataSeriesIndex: x, dataPointIndex: s, x1: Math.min(n, p), y1: Math.min(q, g), x2: Math.max(p, n), y2: Math.max(g, q), isXYSwapped: b, stemProperties: S, whiskerProperties: T }; A(c, Math.min(n, p), Math.min(q, g), Math.max(p,
                                    n), Math.max(g, q), e, T, S, b); v && A(this._eventManager.ghostCtx, n, q, p, g, e, T, S, b); if (D[s].indexLabel || B.indexLabel || D[s].indexLabelFormatter || B.indexLabelFormatter) this._indexLabels.push({ chartType: "error", dataPoint: D[s], dataSeries: B, indexKeyword: 0, point: { x: b ? D[s].y[1] >= D[s].y[0] ? n : p : n + (p - n) / 2, y: b ? q + (g - q) / 2 : D[s].y[1] >= D[s].y[0] ? g : q }, direction: D[s].y[1] >= D[s].y[0] ? -1 : 1, bounds: { x1: b ? Math.min(n, p) : n, y1: b ? q : Math.min(q, g), x2: b ? Math.max(n, p) : p, y2: b ? g : Math.max(q, g) }, color: e, axisSwapped: b }), this._indexLabels.push({
                                      chartType: "error",
                                      dataPoint: D[s], dataSeries: B, indexKeyword: 1, point: { x: b ? D[s].y[1] >= D[s].y[0] ? p : n : n + (p - n) / 2, y: b ? q + (g - q) / 2 : D[s].y[1] >= D[s].y[0] ? q : g }, direction: D[s].y[1] >= D[s].y[0] ? 1 : -1, bounds: { x1: b ? Math.min(n, p) : n, y1: b ? q : Math.min(q, g), x2: b ? Math.max(n, p) : p, y2: b ? g : Math.max(q, g) }, color: e, axisSwapped: b
                                    })
                              }
                            }
                    } v && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas,
                      ...
                      e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                        var q = a.dataSeriesIndexes[p], g = this.data[q], t = g.dataPoints; if (0 < t.length) {
                          var m = 5 < n && g.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (f = 0; f < t.length; f++)if (t[f].getTime ? k = t[f].x.getTime() : k = t[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !r(t[f].y) && t[f].y.length && "number" === typeof t[f].y[0] && "number" === typeof t[f].y[1]) {
                            ...
                            h = a.axisX.convertValueToPixel(k); h = a.axisX.reversed ? h + a.plotType.totalDataSeries * n / 2 - (a.previousDataSeriesCount + p) * n << 0 : h - a.plotType.totalDataSeries * n / 2 + (a.previousDataSeriesCount + p) * n << 0; var L = a.axisX.reversed ? h - n << 0 : h + n << 0; l > s && (b = l, l = s, s = b); b = t[f].color ? t[f].color : g._colorSet[f % g._colorSet.length]; da(c, l, a.axisX.reversed ? L : h, s, a.axisX.reversed ? h : L, b, 0, null, m, !1, !1, !1, g.fillOpacity); b = g.dataPointIds[f]; this._eventManager.objectMap[b] = {
                              id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f,
                              x1: l, y1: h, x2: s, y2: L
                            }; b = O(b); v && da(this._eventManager.ghostCtx, l, a.axisX.reversed ? L : h, s, a.axisX.reversed ? h : L, b, 0, null, !1, !1, !1, !1); if (t[f].indexLabel || g.indexLabel || t[f].indexLabelFormatter || g.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeBar", dataPoint: t[f], dataSeries: g, indexKeyword: 0, point: { x: t[f].y[1] >= t[f].y[0] ? l : s, y: h + (L - h) / 2 }, direction: t[f].y[1] >= t[f].y[0] ? -1 : 1, bounds: { x1: Math.min(l, s), y1: h, x2: Math.max(l, s), y2: L }, color: b }), this._indexLabels.push({
                              chartType: "rangeBar", dataPoint: t[f],
                              dataSeries: g, indexKeyword: 1, point: { x: t[f].y[1] >= t[f].y[0] ? s : l, y: h + (L - h) / 2 }, direction: t[f].y[1] >= t[f].y[0] ? 1 : -1, bounds: { x1: Math.min(l, s), y1: h, x2: Math.max(l, s), y2: L }, color: b
                            })
                          }
                        }
                      } v && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
              ...
              function d() {
                ...
                var e = this._eventManager.ghostCtx, f = [], l = this.plotArea; b.save(); v && e.save(); b.beginPath(); b.rect(l.x1, l.y1, l.width, l.height); b.clip(); v && (e.beginPath(),
                  e.rect(l.x1, l.y1, l.width, l.height), e.clip()); for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                    var h = [], k = a.dataSeriesIndexes[s], n = this.data[k], p = n.dataPoints, f = n.id; this._eventManager.objectMap[f] = { objectType: "dataSeries", dataSeriesIndex: k }; f = O(f); e.fillStyle = f; var f = [], q = !0, g = 0, t, r, m, u, y = null; if (0 < p.length) {
                      var x = n._colorSet[g % n._colorSet.length], B = n.lineColor = n.options.lineColor || x, w = B; b.fillStyle = x; b.strokeStyle = B; b.lineWidth = n.lineThickness; var z = "solid"; if (b.setLineDash) {
                        var E = I(n.nullDataLineDashType,
                          n.lineThickness), z = n.lineDashType, A = I(z, n.lineThickness); b.setLineDash(A)
                      } for (var T = !0; g < p.length; g++)if (u = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !T))) if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                        t = a.axisX.convertValueToPixel(u); r = a.axisY.convertValueToPixel(p[g].y[0]); m = a.axisY.convertValueToPixel(p[g].y[1]); q || T ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType ||
                          z === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = A, z = n.nullDataLineDashType, b.setLineDash(E)), b.lineTo(t, r), v && e.lineTo(t, r), h.push({ x: t, y1: r, y2: m })) : (b.beginPath(), b.moveTo(t, r), y = { x: t, y: r }, h = [], h.push({ x: t, y1: r, y2: m }), v && (e.beginPath(), e.moveTo(t, r))), T = q = !1) : (b.lineTo(t, r), h.push({ x: t, y1: r, y2: m }), v && e.lineTo(t, r), 0 == g % 250 && d()); u = n.dataPointIds[g]; this._eventManager.objectMap[u] = {
                            id: u, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: g, x1: t, y1: r,
                            y2: m
                          }; g < p.length - 1 && (w !== (p[g].lineColor || B) || z !== (p[g].lineDashType || n.lineDashType)) && (d(), w = p[g].lineColor || B, h[h.length - 1].newStrokeStyle = w, b.strokeStyle = w, b.setLineDash && (p[g].lineDashType ? (z = p[g].lineDashType, h[h.length - 1].newLineDashArray = I(z, n.lineThickness), b.setLineDash(h[h.length - 1].newLineDashArray)) : (z = n.lineDashType, h[h.length - 1].newLineDashArray = A, b.setLineDash(A)))); if (0 !== p[g].markerSize && (0 < p[g].markerSize || 0 < n.markerSize)) {
                            var S = n.getMarkerProperties(g, t, m, b); f.push(S); var fa = O(u);
                            v && f.push({ x: t, y: m, ctx: e, type: S.type, size: S.size, color: fa, borderColor: fa, borderThickness: S.borderThickness }); S = n.getMarkerProperties(g, t, r, b); f.push(S); fa = O(u); v && f.push({ x: t, y: r, ctx: e, type: S.type, size: S.size, color: fa, borderColor: fa, borderThickness: S.borderThickness })
                          } if (p[g].indexLabel || n.indexLabel || p[g].indexLabelFormatter || n.indexLabelFormatter) this._indexLabels.push({
                            chartType: "rangeArea", dataPoint: p[g], dataSeries: n, indexKeyword: 0, point: { x: t, y: r }, direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ?
                              -1 : 1, color: x
                      ...
                      } else T || q || d(), T = !0; d(); ba.drawMarkers(f)
                    }
              ...
              function d(a, c) {
                var d = w(r, 2); if (0 < d.length) {
                  ...
                  } b.beginPath(); b.moveTo(d[0].x, d[0].y); v && (e.beginPath(), e.moveTo(d[0].x, d[0].y)); for (f = 0; f < d.length - 3; f += 3)b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y), v && e.bezierCurveTo(d[f +
                    1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y); d = w(m, 2); b.lineTo(m[m.length - 1].x, m[m.length - 1].y); for (f = d.length - 1; 2 < f; f -= 3)b.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y), v && e.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y); b.closePath(); b.globalAlpha = k.fillOpacity; b.fill(); v && (e.closePath(), e.fill()); b.globalAlpha = 1; if (0 < k.lineThickness) {
                ...
                var e = this._eventManager.ghostCtx, f = [], l = this.plotArea; b.save(); v && e.save(); b.beginPath(); b.rect(l.x1, l.y1, l.width, l.height); b.clip(); v && (e.beginPath(), e.rect(l.x1, l.y1, l.width, l.height), e.clip()); for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                  var h =
                    a.dataSeriesIndexes[s], k = this.data[h], n = k.dataPoints, f = k.id; this._eventManager.objectMap[f] = { objectType: "dataSeries", dataSeriesIndex: h }; f = O(f); e.fillStyle = f; var f = [], p = 0, q, g, t, r = [], m = []; if (0 < n.length) {
                      var u = k._colorSet[p % k._colorSet.length], y = k.lineColor = k.options.lineColor || u, x = y; b.fillStyle = u; b.lineWidth = k.lineThickness; var B = "solid", D; if (b.setLineDash) { var z = I(k.nullDataLineDashType, k.lineThickness), B = k.lineDashType; D = I(B, k.lineThickness) } for (g = !1; p < n.length; p++)if (q = n[p].x.getTime ? n[p].x.getTime() :
                        n[p].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g))) if (null !== n[p].y && n[p].y.length && "number" === typeof n[p].y[0] && "number" === typeof n[p].y[1]) {
                          q = a.axisX.convertValueToPixel(q); g = a.axisY.convertValueToPixel(n[p].y[0]); t = a.axisY.convertValueToPixel(n[p].y[1]); var E = k.dataPointIds[p]; this._eventManager.objectMap[E] = { id: E, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: p, x1: q, y1: g, y2: t }; r[r.length] = { x: q, y: g }; m[m.length] = { x: q, y: t }; p < n.length - 1 && (x !==
                            (n[p].lineColor || y) || B !== (n[p].lineDashType || k.lineDashType)) && (x = n[p].lineColor || y, r[r.length - 1].newStrokeStyle = x, b.setLineDash && (n[p].lineDashType ? (B = n[p].lineDashType, r[r.length - 1].newLineDashArray = I(B, k.lineThickness)) : (B = k.lineDashType, r[r.length - 1].newLineDashArray = D))); if (0 !== n[p].markerSize && (0 < n[p].markerSize || 0 < k.markerSize)) {
                              var A = k.getMarkerProperties(p, q, g, b); f.push(A); var T = O(E); v && f.push({ x: q, y: g, ctx: e, type: A.type, size: A.size, color: T, borderColor: T, borderThickness: A.borderThickness });
                              A = k.getMarkerProperties(p, q, t, b); f.push(A); T = O(E); v && f.push({ x: q, y: t, ctx: e, type: A.type, size: A.size, color: T, borderColor: T, borderThickness: A.borderThickness })
                        ...
                        } else 0 < p && !g && (k.connectNullData ? b.setLineDash && (0 < r.length && (k.options.nullDataLineDashType || !n[p - 1].lineDashType)) && (r[r.length - 1].newLineDashArray = z, B = k.nullDataLineDashType) : (d(D, y), r = [], m = [])), g = !0; d(D, y); ba.drawMarkers(f)
                    }
              ...
              var d = a.targetCanvasCtx || this.plotArea.ctx, c = v ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                c.clip(); v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(f.x1, f.y1, f.width, f.height), this._eventManager.ghostCtx.clip()); for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                  var t = a.dataSeriesIndexes[g], r = this.data[t], m = r.dataPoints, e = r._colorSet[0]; r.risingColor = r.options.risingColor ? r.options.risingColor : e; r.fallingColor = r.options.fallingColor ? r.options.fallingColor : "#e40a0a"; var u = "number" === typeof r.options.lineThickness ? Math.round(r.lineThickness) : 1, y = 1 === Math.round(u) %
                    2 ? -0.5 : 0; if (0 < m.length) for (var x = 5 < q && r.bevelEnabled ? !0 : !1, B = !1, w = null, z = null, l = 0; l < m.length; l++)if (m[l].getTime ? n = m[l].x.getTime() : n = m[l].x, "number" !== typeof m[l].y) { if (0 < l && !B && r.connectNullData) var E = r.options.nullDataLineDashType || !m[l - 1].lineDashType ? r.nullDataLineDashType : m[l - 1].lineDashType; B = !0 } else {
                      ...
                      s = a.axisX.reversed ? s + a.plotType.totalDataSeries * q / 2 - (a.previousDataSeriesCount + g) * q << 0 : s - a.plotType.totalDataSeries * q / 2 + (a.previousDataSeriesCount + g) * q << 0; var A = a.axisX.reversed ? s - q << 0 : s + q << 0; h > k && (e = h, h = k, k = e); a.axisY.reversed && (e = h, h = k, k = e); e = r.dataPointIds[l]; this._eventManager.objectMap[e] = { id: e, objectType: "dataPoint", dataSeriesIndex: t, dataPointIndex: l, x1: s, y1: h, x2: A, y2: k }; var T = m[l].color ? m[l].color : 0 < m[l].y ? r.risingColor : r.fallingColor; da(c, a.axisX.reversed ? A : s, a.axisY.reversed ? k : h, a.axisX.reversed ?
                        s : A, a.axisY.reversed ? h : k, T, 0, T, x, x, !1, !1, r.fillOpacity); e = O(e); v && da(this._eventManager.ghostCtx, a.axisX.reversed ? A : s, h, a.axisX.reversed ? s : A, k, e, 0, null, !1, !1, !1, !1); var S, T = s; S = "undefined" !== typeof m[l].isIntermediateSum && !0 === m[l].isIntermediateSum || "undefined" !== typeof m[l].isCumulativeSum && !0 === m[l].isCumulativeSum ? 0 < m[l].y ? h : k : 0 < m[l].y ? k : h; 0 < l && w && (!B || r.connectNullData) && (B && c.setLineDash && c.setLineDash(I(E, u)), c.beginPath(), c.moveTo(w, z - y), c.lineTo(T, S - y), 0 < u && c.stroke(), v && (b.beginPath(), b.moveTo(w,
                          z - y), b.lineTo(T, S - y), 0 < u && b.stroke())); B = !1; w = A; z = 0 < m[l].y ? h : k; T = m[l].lineDashType ? m[l].lineDashType : r.options.lineDashType ? r.options.lineDashType : "shortDash"; c.strokeStyle = m[l].lineColor ? m[l].lineColor : r.options.lineColor ? r.options.lineColor : "#9e9e9e"; c.lineWidth = u; c.setLineDash && (T = I(T, u), c.setLineDash(T)); (m[l].indexLabel || r.indexLabel || m[l].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "waterfall", dataPoint: m[l], dataSeries: r, point: { x: s + (A - s) / 2, y: 0 <= m[l].y ? h : k },
                            direction: 0 > m[l].y === a.axisY.reversed ? 1 : -1, bounds: { x1: s, y1: Math.min(h, k), x2: A, y2: Math.max(h, k) }, color: e
                          })
                    }
              ...
              if (!(0 > c)) {
                "undefined" === typeof h && (h = 1); if (!v) { var k = Number((l % (2 * Math.PI)).toFixed(8)); Number((f % (2 * Math.PI)).toFixed(8)) === k && (l -= 1E-4) } a.save(); a.globalAlpha = h; "pie" === e ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, c, f, l, !1), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth =
              ...
              function d() {
                    ...
                    h.indexLabelLineColor = f.indexLabelLineColor ? f.indexLabelLineColor : k.options.indexLabelLineColor ? k.options.indexLabelLineColor : f.color ? f.color : k._colorSet[e % k._colorSet.length]; h.indexLabelLineThickness = r(f.indexLabelLineThickness) ? k.indexLabelLineThickness : f.indexLabelLineThickness; h.indexLabelLineDashType = f.indexLabelLineDashType ? f.indexLabelLineDashType : k.indexLabelLineDashType; h.indexLabelFontColor = f.indexLabelFontColor ? f.indexLabelFontColor : k.indexLabelFontColor; h.indexLabelFontStyle = f.indexLabelFontStyle ?
                      f.indexLabelFontStyle : k.indexLabelFontStyle; h.indexLabelFontWeight = f.indexLabelFontWeight ? f.indexLabelFontWeight : k.indexLabelFontWeight; h.indexLabelFontSize = r(f.indexLabelFontSize) ? k.indexLabelFontSize : f.indexLabelFontSize; h.indexLabelFontFamily = f.indexLabelFontFamily ? f.indexLabelFontFamily : k.indexLabelFontFamily; h.indexLabelBackgroundColor = f.indexLabelBackgroundColor ? f.indexLabelBackgroundColor : k.options.indexLabelBackgroundColor ? k.options.indexLabelBackgroundColor : k.indexLabelBackgroundColor; h.indexLabelMaxWidth =
                        f.indexLabelMaxWidth ? f.indexLabelMaxWidth : k.indexLabelMaxWidth ? k.indexLabelMaxWidth : 0.33 * q.width; h.indexLabelWrap = "undefined" !== typeof f.indexLabelWrap ? f.indexLabelWrap : k.indexLabelWrap; h.indexLabelTextAlign = f.indexLabelTextAlign ? f.indexLabelTextAlign : k.indexLabelTextAlign ? k.indexLabelTextAlign : "left"; h.startAngle = 0 === e ? k.startAngle ? k.startAngle / 180 * Math.PI : 0 : g[e - 1].endAngle; h.startAngle = (h.startAngle + 2 * Math.PI) % (2 * Math.PI); h.endAngle = h.startAngle + 2 * Math.PI / B * Math.abs(f.y); f = (h.endAngle + h.startAngle) /
                          2; f = (f + 2 * Math.PI) % (2 * Math.PI); h.midAngle = f; if (h.midAngle > Math.PI / 2 - u && h.midAngle < Math.PI / 2 + u) { if (0 === a || g[c].midAngle > h.midAngle) c = e; a++ } else if (h.midAngle > 3 * Math.PI / 2 - u && h.midAngle < 3 * Math.PI / 2 + u) { if (0 === b || g[d].midAngle > h.midAngle) d = e; b++ } h.hemisphere = f > Math.PI / 2 && f <= 3 * Math.PI / 2 ? "left" : "right"; h.indexLabelTextBlock = new ka(m.plotArea.ctx, {
                ...
                var b = m.plotArea.ctx; b.clearRect(q.x1, q.y1, q.width, q.height); b.fillStyle = m.backgroundColor; b.fillRect(q.x1, q.y1, q.width, q.height); for (b = 0; b < n.length; b++) {
                  ...
                  "round"; for (b = b = 0; b < n.length; b++)c = g[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "inside" !== k.indexLabelPlacement ? -(c.indexLabelTextBlock.width + p) : -c.indexLabelTextBlock.width / 2 : "inside" !== k.indexLabelPlacement ? p : -c.indexLabelTextBlock.width / 2, c.indexLabelTextBlock.x += d, c.indexLabelTextBlock.render(!0), c.indexLabelTextBlock.x -= d, c.indexLabelTextBlock.y += c.indexLabelTextBlock.height / 2, "inside" !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness &&
                    (d = c.center.x + z * Math.cos(c.midAngle), e = c.center.y + z * Math.sin(c.midAngle), a.strokeStyle = c.indexLabelLineColor, a.lineWidth = c.indexLabelLineThickness, a.setLineDash && a.setLineDash(I(c.indexLabelLineDashType, c.indexLabelLineThickness)), a.beginPath(), a.moveTo(d, e), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -p : p), c.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter"); a.save()
              } function b(a, b) {
                ...
                d = (d || 0) + 1; if (1E3 < d) return 0; c = c || 0; var l = 0, k = x.y - 1 * v, h = x.y + 1 * v; if (0 <= a && a < n.length) {
                ...
                var a = m.plotArea.ctx; a.fillStyle = "grey"; a.strokeStyle = "grey"; a.font = "16px Arial"; a.textBaseline = "middle"; for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                  if (k.radius || !k.radius && "undefined" !== typeof k.innerRadius && null !== k.innerRadius &&
                    z - d <= E) l = !1; l && (z -= d); d = 0; if ("inside" !== k.indexLabelPlacement) {
                      v = z * w; for (a = 0; a < n.length; a++) { var h = g[a]; h.indexLabelTextBlock.x = x.x + v * Math.cos(h.midAngle); h.indexLabelTextBlock.y = x.y + v * Math.sin(h.midAngle); h.indexLabelAngle = h.midAngle; h.radius = z; h.percentInnerRadius = A } for (var s, r, a = 0; a < n.length; a++) {
                        var h = g[a], u = e(a); if (null !== u) {
                          s = g[a]; r = g[u]; var B = 0, B = b(s, r) - t; if (0 > B) {
                            for (var D = r = 0, F = 0; F < n.length; F++)F !== a && g[F].hemisphere === h.hemisphere && (g[F].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? r++ :
                              D++); r = B / (r + D || 1) * D; var D = -1 * (B - r), I = F = 0; "right" === h.hemisphere ? (F = f(a, r), D = -1 * (B - F), I = f(u, D), +I.toFixed(y) < +D.toFixed(y) && +F.toFixed(y) <= +r.toFixed(y) && f(a, -(D - I))) : (F = f(u, r), D = -1 * (B - F), I = f(a, D), +I.toFixed(y) < +D.toFixed(y) && +F.toFixed(y) <= +r.toFixed(y) && f(u, -(D - I)))
                          }
                        }
                      }
                    } else for (a = 0; a < n.length; a++)h = g[a], v = "pie" === k.type ? 0.7 * z : 0.8 * z, u = x.x + v * Math.cos(h.midAngle), r = x.y + v * Math.sin(h.midAngle), h.indexLabelTextBlock.x = u, h.indexLabelTextBlock.y = r; for (a = 0; a < n.length; a++)if (h = g[a], u = h.indexLabelTextBlock.measureText(),
                            ...
                            for (var a = -1, c = -1, d = 0, f = !1, k = 0; k < n.length; k++)if (f = !1, s = g[k], s.indexLabelText) {
                              var l = e(k); if (null !== l) {
                                ...
                                B = b(s, h); var q; if (q = 0 > B) { q = s.indexLabelTextBlock.x; var r = s.indexLabelTextBlock.y - s.indexLabelTextBlock.height / 2, m = s.indexLabelTextBlock.y + s.indexLabelTextBlock.height / 2, t = h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2, u = h.indexLabelTextBlock.x + h.indexLabelTextBlock.width, C = h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2; q = s.indexLabelTextBlock.x + s.indexLabelTextBlock.width < h.indexLabelTextBlock.x - p || q > u + p || r > C + p || m < t - p ? !1 : !0 } q ? (0 > a && (a = k), l !== a && (c = l, d += -B), 0 === k % Math.max(n.length /
                                  10, 3) && (f = !0)) : f = !0; f && (0 < d && 0 <= a && 0 <= c) && (M(d, a, c), c = a = -1, d = 0)
                              }
                            } 0 < d && M(d, a, c)
                          })()
                }
              ...
              function d() { for (var a = 0, b = [], c = 0; c < y.length; c++) { if ("undefined" === typeof y[c].y) return -1; y[c].y = "number" === typeof y[c].y ? y[c].y : 0; a += Math.abs(y[c].y) } if (0 === a) return -1; for (c = b[0] = 0; c < y.length; c++)b.push(Math.abs(y[c].y) * E / a); return b } function c() {
                var a = V, b = $, c = M, d = ba, e, f; e = K; f = Q - O; d = Math.abs((f - e) * (b - a + (d - c)) / 2); c = ba - M; e = f - e; f = c * (f - Q); f = Math.abs(f);
                f = d + f; for (var d = [], g = 0, k = 0; k < y.length; k++) { if ("undefined" === typeof y[k].y) return -1; y[k].y = "number" === typeof y[k].y ? y[k].y : 0; g += Math.abs(y[k].y) } if (0 === g) return -1; for (var l = d[0] = 0, h = 0, n, p, b = b - a, l = !1, k = 0; k < y.length; k++)a = Math.abs(y[k].y) * f / g, l ? n = 0 == Number(c.toFixed(3)) ? 0 : a / c : (p = ca * ca * b * b - 4 * Math.abs(ca) * a, 0 > p ? (p = c, l = (b + p) * (e - h) / 2, a -= l, n = e - h, h += e - h, n += 0 == p ? 0 : a / p, h += a / p, l = !0) : (n = (Math.abs(ca) * b - Math.sqrt(p)) / 2, p = b - 2 * n / Math.abs(ca), h += n, h > e && (h -= n, p = c, l = (b + p) * (e - h) / 2, a -= l, n = e - h, h += e - h, n += a / p, h += a / p, l = !0),
                  b = p)), d.push(n); return d
              } function b() {
                if (u && y) {
                  for (var a, b, c, d, e, f, k, l, h, n, p, q, s, m, t, C = [], x = [], B = { percent: null, total: null }, w = null, z = 0; z < y.length; z++)t = R[z], t = "undefined" !== typeof t.x5 ? (t.y2 + t.y4) / 2 : (t.y2 + t.y3) / 2, t = g(t).x2 + 1, C[z] = J - t - X; t = 0.5 * X; for (var z = 0, D = y.length - 1; z < y.length || 0 <= D; z++, D--) {
                    b = u.reversed ? y[D] : y[z]; a = b.color ? b.color : u.reversed ? u._colorSet[(y.length - 1 - z) % u._colorSet.length] : u._colorSet[z % u._colorSet.length]; c = b.indexLabelPlacement || u.indexLabelPlacement || "outside"; m = b.indexLabelTextAlign ||
                ...
                function a(b, c) { var d; if (0 > b || b >= H.length) return 0; var e, f = H[b].textBlock; if (0 > c) { c *= -1; e = p(b); d = h(e, b); if (d >= c) return f.y -= c, c; if (0 == b) return 0 < d && (f.y -= d), d; d += a(e, -(c - d)); 0 < d && (f.y -= d); return d } e = q(b); d = h(b, e); if (d >= c) return f.y += c, c; if (b == R.length - 1) return 0 < d && (f.y += d), d; d += a(e, c - d); 0 < d && (f.y += d); return d } function b() {
                  var a, d, e, f, g = 0, l; f = (Q - K + 2 * B) / n; l = n; for (var k, h = 1; h < l; h++) {
                  ...
                  } for (k = R.length - 1; 0 < k; k--)if (!H[k].isDirty) {
                    e = p(k); if (0 > e && (e = 0, H[e].isDirty)) break; if (H[k].textBlock.y < H[e].textBlock.y + H[e].height) {
                      d = d || k; f = k; for (l = 0; H[f].textBlock.y < H[e].textBlock.y + H[e].height + ea;) {
                        a = a || H[f].textBlock.y + H[f].height; l += H[f].height; l += ea; f = e; if (0 >= f) { f = 0; l += H[f].height; break } e = p(f);
                        if (0 > e) { f = 0; l += H[f].height; break }
                      } if (f != k) { g = H[f].textBlock.y; a -= g; a = l - a; g = c(a, d, f); break }
                    }
                  } return g
                } function c(a, b, d) { var e = [], f = 0, g = 0; for (a = Math.abs(a); d <= b; d++)e.push(R[d]); e.sort(function (a, b) { return a.height - b.height }); for (d = 0; d < e.length; d++)if (b = e[d], f < a) g++, f += H[b.id].height + ea, H[b.id].textBlock.text = "", H[b.id].indexLabelText = "", H[b.id].isDirty = !0, H[b.id].textBlock.measureText(); else break; return g } for (var d, e, f, g, l, k, n = 1, r = 0; r < 2 * n; r++) {
                  for (var m = H.length - 1; 0 <= m && !(0 <= p(m) && p(m), f = H[m], g = f.textBlock,
                    k = (l = q(m) < R.length ? H[q(m)] : null) ? l.textBlock : null, d = +f.height.toFixed(6), e = +g.y.toFixed(6), !f.isDirty && (l && e + d + ea > +k.y.toFixed(6)) && (d = g.y + d + ea - k.y, e = a(m, -d), e < d && (0 < e && (d -= e), e = a(q(m), d), e != d))); m--); b()
                }
              } function h(a, b) { return (b < R.length ? H[b].textBlock.y : u.reversed ? pa + B : ua + B) - (0 > a ? u.reversed ? ua - B : pa - B : H[a].textBlock.y + H[a].height + ea) } function m(a, b, c) {
                var d, e, g, l = [], h = B, p = []; -1 !== b && (0 <= Z.indexOf(b) ? (e = Z.indexOf(b), Z.splice(e, 1)) : (Z.push(b), Z = Z.sort(function (a, b) { return a - b }))); if (0 === Z.length) l =
                  ja; else { e = B * (1 != Z.length || 0 != Z[0] && Z[0] != R.length - 1 ? 2 : 1) / k(); for (var s = 0; s < R.length; s++) { if (1 == Z.length && 0 == Z[0]) { if (0 === s) { l.push(ja[s]); d = h; continue } } else 0 === s && (d = -1 * h); l.push(ja[s] + d); if (0 <= Z.indexOf(s) || s < R.length && 0 <= Z.indexOf(s + 1)) d += e } } g = function () { for (var a = [], b = 0; b < R.length; b++)a.push(l[b] - R[b].y1); return a }(); var q = {
                    ...
                    for (e = 0; e < R.length; e++)ta(d, R[e], u.fillOpacity); w(d); F && ("inside" !== u.indexLabelPlacement ? n(d) : f(), t(d)); 1 <= c && (ha = !1)
                  }, null, N.easing.easeOutQuart)
              } function k() { for (var a = 0, b = 0; b < R.length - 1; b++)(0 <= Z.indexOf(b) || 0 <= Z.indexOf(b + 1)) && a++; return a } function n(a) {
              ...
              } function p(a) { for (a -= 1; -1 <= a && -1 != a && H[a].isDirty; a--); return a } function q(a) { for (a += 1; a <= R.length && a != R.length && H[a].isDirty; a++); return a } function g(a) {
                for (var b, c = 0; c < y.length; c++)if (R[c].y1 < a && R[c].y4 > a) { b = R[c]; break } return b ? (a = b.y6 ? a > b.y6 ? b.x3 + (b.x4 - b.x3) / (b.y4 - b.y3) * (a - b.y3) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2),
                  { x1: a, x2: a }) : -1
              } function t(a) { for (var b = 0; b < R.length; b++)H[b].isDirty || (a && (H[b].textBlock.ctx = a), H[b].textBlock.render(!0)) } function w(a) {
                L.plotArea.layoutManager.reset(); a.roundRect || Ca(a); L.title && (L.title.dockInsidePlotArea || "center" === L.title.horizontalAlign && "center" === L.title.verticalAlign) && (L.title.ctx = a, L.title.render()); if (L.subtitles) for (var b = 0; b < L.subtitles.length; b++) {
                  var c = L.subtitles[b]; if (c.dockInsidePlotArea || "center" === c.horizontalAlign && "center" === c.verticalAlign) L.subtitles.ctx =
                    a, c.render()
                } L.legend && (L.legend.dockInsidePlotArea || "center" === L.legend.horizontalAlign && "center" === L.legend.verticalAlign) && (L.legend.ctx = a, L.legend.setLayout(), L.legend.render()); U.fNg && U.fNg(L)
              } var L = this; if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var u = this.data[a.dataSeriesIndexes[0]], y = u.dataPoints, x = this.plotArea, B = 0.025 * x.width, D = 0.01 * x.width, z = 0, E = x.height - 2 * B, A = Math.min(x.width - 2 * D, 2.8 * x.height), F = !1, S = 0; S < y.length; S++)if (!F && ("undefined" !== typeof y[S].indexLabel && null !== y[S].indexLabel &&
                  ...
                  var O, G; a = 75 * A / 100; var X = 30 * (J - a) / 100; "funnel" === u.type ? (O = r(u.options.neckHeight) ? 0.35 * E : u.neckHeight, G = r(u.options.neckWidth) ? 0.25 * a : u.neckWidth, "string" === typeof O && O.match(/%$/) ? (O = parseInt(O), O = O * E / 100) : O = parseInt(O), "string" === typeof G && G.match(/%$/) ? (G = parseInt(G), G = G * a / 100) : G = parseInt(G), O > E ? O = E : 0 >= O && (O = 0), G > a ? G = a - 0.5 : 0 >= G && (G = 0)) : "pyramid" === u.type && (G = O = 0, u.reversed = u.reversed ? !1 : !0); var D = S + a / 2, V = S, $ = S + a, pa = u.reversed ? Q : K, M = D - G / 2, ba = D + G / 2, Y = u.reversed ? K + O : Q - O,
                    ua = u.reversed ? K : Q; a = []; var D = [], R = [], A = [], W = K, da, ca = (Y - pa) / (M - V), ga = -ca, S = "area" === (u.valueRepresents ? u.valueRepresents : "height") ? c() : d(); if (-1 !== S) {
                      if (u.reversed) for (A.push(W), G = S.length - 1; 0 < G; G--)W += S[G], A.push(W); else for (G = 0; G < S.length; G++)W += S[G], A.push(W); if (u.reversed) for (G = 0; G < S.length; G++)A[G] < Y ? (a.push(M), D.push(ba), da = G) : (a.push((A[G] - pa + ca * V) / ca), D.push((A[G] - pa + ga * $) / ga)); else for (G = 0; G < S.length; G++)A[G] < Y ? (a.push((A[G] - pa + ca * V) / ca), D.push((A[G] - pa + ga * $) / ga), da = G) : (a.push(M), D.push(ba));
                      for (G = 0; G < S.length - 1; G++)W = u.reversed ? y[y.length - 1 - G].color ? y[y.length - 1 - G].color : u._colorSet[(y.length - 1 - G) % u._colorSet.length] : y[G].color ? y[G].color : u._colorSet[G % u._colorSet.length], G === da ? R.push({ x1: a[G], y1: A[G], x2: D[G], y2: A[G], x3: ba, y3: Y, x4: D[G + 1], y4: A[G + 1], x5: a[G + 1], y5: A[G + 1], x6: M, y6: Y, id: G, height: A[G + 1] - A[G], color: W }) : R.push({ x1: a[G], y1: A[G], x2: D[G], y2: A[G], x3: D[G + 1], y3: A[G + 1], x4: a[G + 1], y4: A[G + 1], id: G, height: A[G + 1] - A[G], color: W }); var ea = 2, H = [], ha = !1, Z = [], ja = [], S = !1; a = a = 0; Da(Z); for (G = 0; G < y.length; G++)y[G].exploded &&
                        (S = !0, u.reversed ? Z.push(y.length - 1 - G) : Z.push(G)); P.clearRect(x.x1, x.y1, x.width, x.height); P.fillStyle = L.backgroundColor; P.fillRect(x.x1, x.y1, x.width, x.height); if (F && u.visible && (b(), f(), e(), "inside" !== u.indexLabelPlacement)) { l(); for (G = 0; G < y.length; G++)H[G].isDirty || (a = H[G].textBlock.x + H[G].width, a = (J - a) / 2, 0 == G && (z = a), z > a && (z = a)); for (G = 0; G < R.length; G++)R[G].x1 += z, R[G].x2 += z, R[G].x3 += z, R[G].x4 += z, R[G].x5 && (R[G].x5 += z, R[G].x6 += z), H[G].textBlock.x += z } for (G = 0; G < R.length; G++)z = R[G], ta(P, z, u.fillOpacity),
                          ja.push(z.y1); w(P); F && u.visible && ("inside" === u.indexLabelPlacement || L.animationEnabled || n(P), L.animationEnabled || t()); if (!F) for (G = 0; G < y.length; G++)z = u.dataPointIds[G], a = { id: z, objectType: "dataPoint", dataPointIndex: G, dataSeriesIndex: 0, funnelSection: R[u.reversed ? y.length - 1 - G : G] }, L._eventManager.objectMap[z] = a; !L.animationEnabled && S ? m(L, -1, 0) : L.animationEnabled && !L.animatedRender && m(L, -1, 0); this.funnelPyramidClickHandler = function (a) {
                            var b = -1; if (!ha && !L.isAnimating && (r(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) &&
                              (b = u.reversed ? y.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) { a = b; if ("funnel" === u.type || "pyramid" === u.type) u.reversed ? y[y.length - 1 - a].exploded = y[y.length - 1 - a].exploded ? !1 : !0 : y[a].exploded = y[a].exploded ? !1 : !0; m(L, b, 500) }
                          }; return { source: P, dest: this.plotArea.ctx, animationCallback: function (a, b) { N.fadeInAnimation(a, b); 1 <= a && (m(L, -1, 500), w(L.plotArea.ctx || L.ctx)) }, easingFunction: N.easing.easeInQuad, animationBase: 0 }
                    }
                }
              }
              ...
              c = "undefined" === typeof c ? !0 : c; "options" === a ? (this.options = d, c && this.render()) : m.base.set.call(this,
                a, d, c)
              ...
              a = "undefined" === typeof a ? {} : a; var d = a.format ? a.format : "png", c = a.fileName ? a.fileName : this.exportFileName; if (a.toDataURL) return this.canvas.toDataURL("image/" + d); var b = this.canvas; if (b && d && c) {
                c = c + "." + d; a = "image/" + d; var b = b.toDataURL(a), e = !1, f = document.createElement("a"); f.download = c; f.href = b; if ("undefined" !== typeof Blob && new Blob) {
                  for (var l = b.replace(/^data:[a-z\/]*;base64,/, ""), l = atob(l), h = new ArrayBuffer(l.length), h = new Uint8Array(h), r = 0; r < l.length; r++)h[r] =
                    l.charCodeAt(r); d = new Blob([h.buffer], { type: "image/" + d }); try { window.navigator.msSaveBlob(d, c), e = !0 } catch (k) { f.dataset.downloadurl = [a, f.download, f.href].join(":"), f.href = window.URL.createObjectURL(d) }
              ...
              var a = this.exportChart({ toDataURL: !0 }), d = document.createElement("iframe"); d.setAttribute("class", "canvasjs-chart-print-frame"); V(d, { position: "absolute", width: "100%", border: "0px", margin: "0px 0px 0px 0px", padding: "0px 0px 0px 0px" }); d.style.height = this.height + "px"; this._canvasJSContainer.appendChild(d); var c = this, b = d.contentWindow || d.contentDocument.document || d.contentDocument; b.document.open(); b.document.write('<!DOCTYPE HTML>\n<html><body><img src="' +
                ...
                this.dockInsidePlotArea ? this.chart.plotArea : this.chart, d = a.layoutManager.getFreeSpace(), c = null, b = 0, e = 0, f = 0, l = 0, h = this.markerMargin = this.chart.options.legend && !r(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin : 0.3 * this.fontSize; this.height = 0; var m = [], k = []; if ("top" === this.verticalAlign || "bottom" === this.verticalAlign) this.orientation = "horizontal", c = this.verticalAlign, f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width, l = this.maxHeight = null !== this.maxHeight ? this.maxHeight :
                  0.5 * d.height; else if ("center" === this.verticalAlign) { this.orientation = "vertical"; if ("left" === this.horizontalAlign || "center" === this.horizontalAlign || "right" === this.horizontalAlign) c = this.horizontalAlign; f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : 0.5 * d.width; l = this.maxHeight = null !== this.maxHeight ? this.maxHeight : d.height } this.errorMarkerColor = []; for (var n = 0; n < this.dataSeries.length; n++) {
                    var p = this.dataSeries[n]; if (p.dataPoints && p.dataPoints.length) if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !==
                      ...
                      var q = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? "error" === p.type && p._linkedSeries ? p._linkedSeries.legendMarkerType ? p._linkedSeries.legendMarkerType : X.getDefaultLegendMarker(p._linkedSeries.type) : X.getDefaultLegendMarker(p.type) : p.markerType, g = p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                        ...
                        p.type && this.errorMarkerColor.push(t); g = this.chart.replaceKeywordsWithValue(g, p.dataPoints[0], p, n); q = { markerType: q, markerColor: t, text: g, textBlock: null, chartType: p.type, markerSize: v, lineColor: p._colorSet[0], dataSeriesIndex: p.index, dataPointIndex: null, markerBorderColor: w, markerBorderThickness: u }; m.push(q)
                    } else for (var y = 0; y < p.dataPoints.length; y++) {
                      var x = p.dataPoints[y], q = x.legendMarkerType ? x.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : X.getDefaultLegendMarker(p.type), g = x.legendText ? x.legendText :
                        ...
                        u = x.legendMarkerBorderThickness ? x.legendMarkerBorderThickness : p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : x.markerBorderThickness || p.markerBorderThickness ? Math.max(1, Math.round(0.2 * v)) : 0, g = this.chart.replaceKeywordsWithValue(g, x, p, y), q = { markerType: q, markerColor: t, text: g, textBlock: null, chartType: p.type, markerSize: v, dataSeriesIndex: n, dataPointIndex: y, markerBorderColor: w, markerBorderThickness: u }; (x.showInLegend || p.showInLegend && !1 !== x.showInLegend) && m.push(q)
                    }
                  } !0 === this.reversed && m.reverse();
              if (0 < m.length) {
                p = null; t = g = x = y = 0; x = null !== this.itemWidth ? null !== this.itemMaxWidth ? Math.min(this.itemWidth, this.itemMaxWidth, f) : this.itemMaxWidth = Math.min(this.itemWidth, f) : null !== this.itemMaxWidth ? Math.min(this.itemMaxWidth, f) : this.itemMaxWidth = f; v = 0 === v ? 0.75 * this.lineHeight : v; x -= v + h; for (n = 0; n < m.length; n++) {
                  q = m[n]; w = x; if ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType) w -= 2 * 0.1 * this.lineHeight; if (!(0 >= l || "undefined" === typeof l || 0 >= w || "undefined" === typeof w)) {
                    if ("horizontal" ===
                      this.orientation) {
                      q.textBlock = new ka(this.ctx, { x: 0, y: 0, maxWidth: w, maxHeight: this.itemWrap ? l : this.lineHeight, angle: 0, text: q.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily, fontWeight: this.fontWeight, fontColor: this.fontColor, fontStyle: this.fontStyle, textBaseline: "middle" }); q.textBlock.measureText(); null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (v + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))); if (!p || p.width +
                        Math.round(q.textBlock.width + v + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) p = { items: [], width: 0 }, k.push(p), this.height += g, g = 0; g = Math.max(g, q.textBlock.height)
                      ...
                      q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)); p.items.push(q); this.width = Math.max(p.width, this.width); t = q.textBlock.width + (v + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))
                  }
                ...
                this.width : d.x1 + d.width / 2 - this.width / 2, b = d.y1) : "center" === this.verticalAlign ? (e = "left" === this.horizontalAlign ? d.x1 : "right" === this.horizontalAlign ? d.x2 - this.width : d.x1 + d.width / 2 - this.width / 2, b = d.y1 + d.height / 2 - this.height / 2) : "bottom" === this.verticalAlign && (e = "left" === this.horizontalAlign ? d.x1 : "right" === this.horizontalAlign ? d.x2 - this.width : d.x1 + d.width / 2 - this.width / 2, b = d.y2 - this.height); this.items = m; for (n = 0; n < this.items.length; n++)q = m[n], q.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[q.id] =
                  { id: q.id, objectType: "legendItem", legendItemIndex: n, dataSeriesIndex: q.dataSeriesIndex, dataPointIndex: q.dataPointIndex }; this.markerSize = v; this.rows = k; 0 < m.length && a.layoutManager.registerSpace(c, { width: this.width + 2 + 2, height: this.height + 5 + 5 }); this.bounds = { x1: e, y1: b, x2: e + this.width, y2: b + this.height }
              ...
              var a = this.bounds.x1, d = this.bounds.y1, c = this.markerMargin, b = this.maxWidth, e = this.maxHeight, f = this.markerSize, l = this.rows; (0 < this.borderThickness && this.borderColor || this.backgroundColor) &&
                this.ctx.roundRect(a, d, this.width, this.height, this.cornerRadius, this.borderThickness, this.backgroundColor, this.borderColor); for (var h = 0, r = 0; r < l.length; r++) {
                  for (var k = l[r], n = 0, p = 0; p < k.items.length; p++) {
                    var q = k.items[p], g = q.textBlock.x + a + (0 === p ? 0.2 * f : this.horizontalSpacing), m = d + h, v = g; this.chart.data[q.dataSeriesIndex].visible || (this.ctx.globalAlpha = 0.5); this.ctx.save(); this.ctx.beginPath(); this.ctx.rect(a, d, b, Math.max(e - e % this.lineHeight, 0)); this.ctx.clip(); if ("line" === q.chartType || "stepLine" === q.chartType ||
                      "spline" === q.chartType) this.ctx.strokeStyle = q.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(g - 0.1 * this.lineHeight, m + this.lineHeight / 2), this.ctx.lineTo(g + 0.85 * this.lineHeight, m + this.lineHeight / 2), this.ctx.stroke(), v -= 0.1 * this.lineHeight; if ("error" === q.chartType) {
                        this.ctx.strokeStyle = this.errorMarkerColor[0]; this.ctx.lineWidth = f / 8; this.ctx.beginPath(); var w = g - 0.08 * this.lineHeight + 0.1 * this.lineHeight, u = m + 0.15 * this.lineHeight, y = 0.7 * this.lineHeight, x = y +
                          0.02 * this.lineHeight; this.ctx.moveTo(w, u); this.ctx.lineTo(w + y, u); this.ctx.stroke(); this.ctx.beginPath(); this.ctx.moveTo(w + y / 2, u); this.ctx.lineTo(w + y / 2, u + x); this.ctx.stroke(); this.ctx.beginPath(); this.ctx.moveTo(w, u + x); this.ctx.lineTo(w + y, u + x); this.ctx.stroke(); this.errorMarkerColor.shift()
                    ...
                    q.x1 = this.chart._eventManager.objectMap[q.id].x1 = v; q.y1 = this.chart._eventManager.objectMap[q.id].y1 = q.textBlock.y - this.lineHeight / 2; q.x2 = this.chart._eventManager.objectMap[q.id].x2 = q.textBlock.x + q.textBlock.width; q.y2 = this.chart._eventManager.objectMap[q.id].y2 = q.textBlock.y + q.textBlock.height - this.lineHeight / 2
                  } h += n
                }
            }; qa(X, W); X.prototype.getDefaultAxisPlacement = function () {
                ...
                f = 0 < l ? p + e : p - e; if (0 <= f && f < this.dataPoints.length) {
                  var q = this.chart._eventManager.objectMap[this.dataPointIds[f]], g = this.dataPoints[f], m = null; if (q) {
                    switch (this.type) {
                      ...
                      }), h = !0); break; case "line": case "stepLine": case "spline": case "area": case "stepArea": case "stackedArea": case "stackedArea100": case "splineArea": case "scatter": var v = ma("markerSize", g, this) || 4, w = c ? 20 : v, m = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2)); m <= w && b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: m }); q = Math.abs(q.x1 - a); q <= r ? r = q : 0 < l ? k++ : n++; m <= v / 2 && (h = !0); break; case "rangeArea": case "rangeSplineArea": v = ma("markerSize", g, this) ||
        ...
        }; qa(E, W); E.prototype.createExtraLabelsForLog = function (a) {
          a = (a || 0) + 1; if (!(5 < a)) {
            ...
            e =
              this.viewportMaximum; if (this.labels) { a = Math.ceil(b); for (var b = Math.ceil(this.intervalStartPosition), g = !1, c = b; c < this.viewportMaximum; c += a)if (this.labels[c]) g = !0; else { g = !1; break } g && (this.interval = a, this.intervalStartPosition = b) } if (this.logarithmic && !this.equidistantInterval) for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, g = q; b < this.logLabelValues.length; b++)if (c = this.logLabelValues[b], c < this.viewportMinimum) b++; else {
                for (; g < p.length && c > p[g].endValue; g++); a = g < p.length &&
                  c >= p[g].startValue && c <= p[g].endValue; n = c; a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: n, label: this.labels[n] ? this.labels[n] : null }) : "axisX" === this.type && this.labels[n] ? this.labels[n] : ha(n, this.valueFormatString, this.chart._cultureInfo), a = new ka(this.ctx, {
              ...
              this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) : this.lineCoordinates.height / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * K[this.intervalType + "Duration"] * this.interval, this.chart.panEnabled || (f = "undefined" === typeof this.options.labelMaxWidth ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth), l = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >>
                0 : 1.5 * this.labelFontSize; for (b = 0; b < this._labels.length; b++) { a = this._labels[b].textBlock; a.maxWidth = f; a.maxHeight = l; var t = a.measureText(); m = t.height } e = []; q = p = 0; if (this.labelAutoFit || this.options.labelAutoFit) if (r(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position) if (f = 0.9 * h >> 0, q = 0, !this.chart.panEnabled && 1 <=
                  ...
                  this.sessionVariables.labelFontSize = this.labelFontSize; this.sessionVariables.labelMaxWidth = f; this.sessionVariables.labelMaxHeight = l; this.sessionVariables.labelAngle = this.labelAngle; this.sessionVariables.labelWrap = this.labelWrap; for (c = 0; c < this._labels.length; c++)if (!this._labels[c].breaksLabelType) {
                    a = this._labels[c].textBlock; for (var w, g = a.text.split(" "), b = 0; b < g.length; b++)n = g[b], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, n = this.ctx.measureText(n),
                  ...
                  a.measureText(); else if ("left" === this._position || "right" === this._position) if (f = r(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, l = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
                    ...
                    this.labelFontSize : this.sessionVariables.labelFontSize : this.options.labelFontSize, a.angle = this.labelAngle = r(this.options.labelAngle) ? r(this.sessionVariables.labelAngle) ? this.sessionVariables.labelAngle = this.labelAngle : this.sessionVariables.labelAngle : this.labelAngle, a.wrap = this.labelWrap = r(this.options.labelWrap) ? r(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap, a.maxHeight = r(this.sessionVariables.labelMaxHeight) ?
                      this.sessionVariables.labelMaxHeight = l : this.sessionVariables.labelMaxHeight, a.measureText(); for (c = 0; c < this.stripLines.length; c++) {
                        var f = this.stripLines[c], E; if ("outside" === f.labelPlacement) {
                          ...
                          "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize, r(f.labelBackgroundColor) && (r(f.startValue) && 0 !== f.startValue ? f.labelBackgroundColor = v ? "transparent" : null : f.labelBackgroundColor = "#EEEEEE"); a = new ka(this.ctx, {
                            x: 0, y: 0, backgroundColor: f.labelBackgroundColor, borderColor: f.labelBorderColor, borderThickness: f.labelBorderThickness, cornerRadius: f.labelCornerRadius, maxWidth: f.options.labelMaxWidth ? f.options.labelMaxWidth : l, maxHeight: E, angle: this.labelAngle, text: f.labelFormatter ?
                                  ...
                                  b[g].lineCoordinates.height), X += D[g] + b[g].margin); if (a && 0 < a.length) for (g = 0; g < a.length; g++)a[g] && (a[g].calculateValueToPixelConversionParameters(), a[g].calculateBreaksSizeInValues(), a[g]._labels && 1 < a[g]._labels.length && (z = (a[g].logarithmic ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) / a[g].conversionParameters.lnLogarithmBase : a[g]._labels[1].position - a[g].viewportMinimum) * Math.abs(a[g].conversionParameters.pixelPerUnit) + a[g].lineCoordinates.x1, l = a[g]._labels[a[g]._labels.length - ("dateTime" ===
                                    a[g].valueType ? 2 : 1)].position, l = a[g].getApparentDifference(a[g].viewportMinimum, l), E = a[g].logarithmic ? (1 < l ? Math.log(l) / a[g].conversionParameters.lnLogarithmBase * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1 : (0 < l ? l * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1)); if (d && 0 < d.length) for (g = 0; g < d.length; g++)d[g].calculateValueToPixelConversionParameters(), d[g].calculateBreaksSizeInValues(), d[g]._labels && 1 < d[g]._labels.length && (z = (d[g].logarithmic ?
                                      Math.log(d[g]._labels[1].position / d[g].viewportMinimum) / d[g].conversionParameters.lnLogarithmBase : d[g]._labels[1].position - d[g].viewportMinimum) * Math.abs(d[g].conversionParameters.pixelPerUnit) + d[g].lineCoordinates.x1, l = d[g]._labels[d[g]._labels.length - ("dateTime" === d[g].valueType ? 2 : 1)].position, l = d[g].getApparentDifference(d[g].viewportMinimum, l), E = d[g].logarithmic ? (1 < l ? Math.log(l) / d[g].conversionParameters.lnLogarithmBase * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1 :
                                        (0 < l ? l * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1); for (g = 0; g < q.length; g++)"axisY" === q[g].type && (q[g].calculateValueToPixelConversionParameters(), q[g].calculateBreaksSizeInValues()); if (0 < v) {
                                          if (a && 0 < a.length) for (g = 0; g < a.length; g++)t = K[v - 1][g] === K[v][g] ? !0 : !1; else t = !0; if (d && 0 < d.length) for (g = 0; g < d.length; g++)F = N[v - 1][g] === N[v][g] ? !0 : !1; else F = !0; if (c && 0 < c.length) for (g = 0; g < c.length; g++)I = O[v - 1][g] === O[v][g] ? !0 : !1; else I = !0; if (b && 0 < b.length) for (g = 0; g < b.length; g++)J = P[v -
                                            1][g] === P[v][g] ? !0 : !1; else J = !0
                                        } if (t && F && I && J) break; v++
                      ...
                      k, b[g].lineCoordinates.y2 = k, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = k - z[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)), b[g].bounds = { x1: l, y1: h + (b[g].margin + G), x2: m, y2: k, width: m - l, height: Q }, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width), G += z[g] + b[g].margin); if (a && 0 < a.length) for (g = 0; g < a.length; g++) {
                        M = a[g]._labels && 0 < a[g]._labels.length ? a[g]._labels[0].textBlock.fontSize /
                          2 : 0; l = Math.round(f.x1 + e); h = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : f.y1 < Math.max(M, 10) ? Math.max(M, 10) : f.y1) : f.y1 < Math.max(M, 10) ? Math.max(M, 10) : f.y1; m = Math.round(f.x1 + X + e); k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - U > n.height - Math.max(M, 10) ? n.height - Math.max(M, 10) : f.y2 - U) : f.y2 > n.height - Math.max(M, 10) ? n.height - Math.max(M, 10) : f.y2; if (c && 0 < c.length) for (M = 0; M < c.length; M++)c[M] && c[M].labelAutoFit && (m = 0 > c[M].labelAngle ? Math.max(m, y) : 0 === c[M].labelAngle ? Math.max(m, y / 2) : m, l =
                            ...
                            }; a[g].title && (a[g]._titleTextBlock.maxWidth = 0 < a[g].titleMaxWidth && a[g].titleMaxWidth < a[g].lineCoordinates.height ? a[g].titleMaxWidth : a[g].lineCoordinates.height); a[g].calculateValueToPixelConversionParameters(); a[g].calculateBreaksSizeInValues(); O += A[g] + a[g].margin
                      } if (d && 0 < d.length) for (g = 0; g < d.length; g++) {
                        M = d[g]._labels && 0 < d[g]._labels.length ? d[g]._labels[0].textBlock.fontSize / 2 : 0; l = Math.round(f.x1 - e); h = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : f.y1 <
                          Math.max(M, 10) ? Math.max(M, 10) : f.y1) : f.y1 < Math.max(M, 10) ? Math.max(M, 10) : f.y1; m = Math.round(f.x2 - W - V); k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - U > n.height - Math.max(M, 10) ? n.height - Math.max(M, 10) : f.y2 - U) : f.y2 > n.height - Math.max(M, 10) ? n.height - Math.max(M, 10) : f.y2; if (c && 0 < c.length) for (M = 0; M < c.length; M++)c[M] && c[M].labelAutoFit && (m = 0 > c[M].labelAngle ? Math.max(m, y) : 0 === c[M].labelAngle ? Math.max(m, y / 2) : m, l = 0 > c[M].labelAngle || 0 === c[M].labelAngle ? m - W : l); if (b && 0 < b.length) for (M = 0; M < b.length; M++)b[M] &&
                            b[M].labelAutoFit && (m = b[M].lineCoordinates.x2, l = m - W); d[g].lineCoordinates = { x1: m + P, y1: h, x2: m + P, y2: k, height: Math.abs(k - h) }; "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.x1 = d[g].lineCoordinates.x1 + (w[g] - (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0) - 2) - ("outside" === d[g].tickPlacement ? d[g].tickLength : 0), d[g].lineCoordinates.x2 = d[g].lineCoordinates.x1 + d[g].lineThickness / 2); d[g].bounds = { x1: d[g].lineCoordinates.x1, y1: h, x2: m + w[g] + P, y2: k, width: m - l, height: k - h }; d[g].title && (d[g]._titleTextBlock.maxWidth =
                              0 < d[g].titleMaxWidth && d[g].titleMaxWidth < d[g].lineCoordinates.height ? d[g].titleMaxWidth : d[g].lineCoordinates.height); d[g].calculateValueToPixelConversionParameters(); d[g].calculateBreaksSizeInValues(); P += w[g] + d[g].margin
                      } for (g = 0; g < q.length; g++)"axisY" === q[g].type && (q[g].calculateValueToPixelConversionParameters(), q[g].calculateBreaksSizeInValues()); if (0 < v) {
                        if (a && 0 < a.length) for (g = 0; g < a.length; g++)t = K[v - 1][g] === K[v][g] ? !0 : !1; else t = !0; if (d && 0 < d.length) for (g = 0; g < d.length; g++)F = N[v - 1][g] === N[v][g] ? !0 :
                          !1; else F = !0; if (c && 0 < c.length) for (g = 0; g < c.length; g++)I = E[v - 1][g] === E[v][g] ? !0 : !1; else I = !0; if (b && 0 < b.length) for (g = 0; g < b.length; g++)J = u[v - 1][g] === u[v][g] ? !0 : !1; else J = !0
                      } if (t && F && I && J) break; v++
          ...
          function () {
            ...
            function () {
              ...
              if (this.scaleBreaks &&
                ...
                var a = this.scaleBreaks._appliedBreaks; v ? (this.maskCanvas = va(this.chart.width, this.chart.height), this.maskCtx = this.maskCanvas.getContext("2d")) : (this.maskCanvas = this.chart.plotArea.canvas, this.maskCtx = this.chart.plotArea.ctx); this.maskCtx.save(); this.maskCtx.beginPath(); this.maskCtx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height); this.maskCtx.clip(); for (var d = 0; d < a.length; d++)a[d].endValue < this.viewportMinimum ||
              ...
              var a = this.chart.ctx, d = v ? this.chart._preRenderCtx : a, c = Math.ceil(this.tickThickness / (this.reversed ? -2 : 2)), b = Math.ceil(this.tickThickness / (this.reversed ? 2 : -2)), e, f; d.save(); if ("bottom" === this._position || "top" === this._position) {
                ...
                this.reversed ? (e = this.lineCoordinates.y1, f = this.lineCoordinates.y2) : (e = this.lineCoordinates.y2, f = this.lineCoordinates.y1); d.lineWidth = this.lineThickness; d.strokeStyle = this.lineColor; d.setLineDash && d.setLineDash(I(this.lineDashType, this.lineThickness)); l = 1 === this.lineThickness %
        ...
        E.prototype.getLabelStartPoint = function () {
        ...
        }; qa(Q, W); Q.prototype.createUserOptions = function (a) {
          ...
          this.ctx.save(); var a = this.parent.getPixelCoordinatesOnAxis(this.value), d = Math.abs("pixel" === this._thicknessType ? this.thickness : Math.abs(this.parent.convertValueToPixel(this.endValue) - this.parent.convertValueToPixel(this.startValue))); if (0 < d) {
            var c = null === this.opacity ? 1 : this.opacity; this.ctx.strokeStyle = this.color; this.ctx.beginPath(); var b = this.ctx.globalAlpha; this.ctx.globalAlpha = c; O(this.id); var e, f, h,
        ...
        }; qa(ca, W); ca.prototype.showAt = function (a) {
          ...
          var b, e, f, h, m = null, v = null, k = null, n = ""; if (!this.valueFormatString) if ("dateTime" === this.parent.valueType) this.valueFormatString = this.parent.valueFormatString; else {
            var p = 0, p = "xySwapped" === this.chart.plotInfo.axisPlacement ?
              50 < this.parent.range ? 0 : 500 < this.chart.width && 25 > this.parent.range ? 2 : Math.floor(Math.abs(Math.log(this.parent.range) / Math.LN10)) + (5 > this.parent.range ? 2 : 10 > this.parent.range ? 1 : 0) : 50 < this.parent.range ? 0 : Math.floor(Math.abs(Math.log(this.parent.range) / Math.LN10)) + (5 > this.parent.range ? 2 : 10 > this.parent.range ? 1 : 0); this.valueFormatString = E.generateValueFormatString(this.parent.range, p)
              ...
              { x: 0, y: 0, padding: { top: 2, right: 3, bottom: 2, left: 4 }, backgroundColor: this.labelBackgroundColor, borderColor: this.labelBorderColor, borderThickness: this.labelBorderThickness, cornerRadius: this.labelCornerRadius, maxWidth: this.labelMaxWidth, maxHeight: this.labelMaxHeight, angle: this.labelAngle, text: n, horizontalAlign: "left", fontSize: this.labelFontSize, fontFamily: this.labelFontFamily, fontWeight: this.labelFontWeight, fontColor: this.labelFontColor, fontStyle: this.labelFontStyle, textBaseline: "middle" }); if (this.snapToDataPoint) {
                var t =
                  0, n = []; if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    var w = null; if ("bottom" === this.parent._position || "top" === this.parent._position) t = this.parent.dataSeries[0].axisX.convertPixelToValue({ y: d }); else if ("left" === this.parent._position || "right" === this.parent._position) t = this.parent.convertPixelToValue({ y: d }); for (var A = 0; A < this.parent.dataSeries.length; A++)(w = this.parent.dataSeries[A].getDataPointAtX(t, !0)) && 0 <= w.index && (w.dataSeries = this.parent.dataSeries[A], null !== w.dataPoint.y && w.dataSeries.visible &&
                      n.push(w)); w = null; if (0 === n.length) return; n.sort(function (a, b) { return a.distance - b.distance }); w = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)); A = 0; if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type) for (var w = Math.abs(a - this.parent.convertValueToPixel(n[A].dataPoint.y[0])), u = 0, t = 0; t < n.length; t++)if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (var y = 0; y < n[t].dataPoint.y.length; y++)u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t); else u =
                        Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y)), u < w && (w = u, A = t); else if ("stackedBar" === n[0].dataSeries.type) for (var w = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), x = u = 0, t = A = 0; t < n.length; t++)if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++)u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t); else x += n[t].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(x)), u < w && (w = u, A = t); else if ("stackedBar100" === n[0].dataSeries.type) for (var w =
                          Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), B = x = u = 0, t = 0; t < n.length; t++)if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++)u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t); else x += n[t].dataPoint.y, B = n[t].dataPoint.x.getTime ? n[t].dataPoint.x.getTime() : n[t].dataPoint.x, B = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[B]), u = Math.abs(a - this.parent.convertValueToPixel(B)), u < w && (w = u, A = t); else for (w = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)),
                            t = A = u = 0; t < n.length; t++)if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++)u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t); else u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y)), u < w && (w = u, A = t); y = n[A]; if ("bottom" === this.parent._position || "top" === this.parent._position) {
                              b = 0; if ("rangeBar" === this.parent.dataSeries[A].type || "error" === this.parent.dataSeries[A].type) {
                                ...
                                w = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)); B = x = u = 0; for (t = A; 0 <= t; t--)x += n[t].dataPoint.y, B = n[t].dataPoint.x.getTime ? n[t].dataPoint.x.getTime() : n[t].dataPoint.x, B = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[B]), u = Math.abs(a - this.parent.convertValueToPixel(B)), u < w && (w = u, b = t); m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(B) << 0) + 0.5 :
                                  this.parent.convertValueToPixel(B) << 0; this.value = B; k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: B }) : r(this.options.label) ? ha(r(c) ? B : c, this.valueFormatString, this.chart._cultureInfo) : this.label
                              ...
                              f = h = v = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataPoint.x) << 0; b = this.chart.plotArea.x1; e = this.chart.plotArea.x2; this.bounds = { x1: b, y1: f - p / 2, x2: e, y2: h + p / 2 }; B = !1; if (this.parent.labels) for (n = Math.ceil(this.parent.interval), t = 0; t < this.parent.viewportMaximum; t +=
                                ...
                                }) : r(this.options.label) ? Ba(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x }) : r(this.options.label) ? ha(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label); this.value = y.dataPoint.x; k.y = h + k.fontSize / 2 - k.measureText().height /
                    ...
                    t = this.parent.convertPixelToValue({ x: a }); for (A = 0; A < this.parent.dataSeries.length; A++)(w =
                      ...
                      "boxAndWhisker" === n[0].dataSeries.type) for (w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])), t = u = 0; t < n.length; t++)if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++)u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t); else u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y)), u < w && (w = u, A = t); else if ("stackedColumn" === n[0].dataSeries.type || "stackedArea" === n[0].dataSeries.type) for (w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)),
                        t = x = u = 0; t < n.length; t++)if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++)u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t); else x += n[t].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(x)), u < w && (w = u, A = t); else if ("stackedColumn100" === n[0].dataSeries.type || "stackedArea100" === n[0].dataSeries.type) for (w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), t = B = x = u = 0; t < n.length; t++)if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y =
                          0; y < n[t].dataPoint.y.length; y++)u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t); else x += n[t].dataPoint.y, B = n[t].dataPoint.x.getTime ? n[t].dataPoint.x.getTime() : n[t].dataPoint.x, B = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[B]), u = Math.abs(d - this.parent.convertValueToPixel(B)), u < w && (w = u, A = t); else for (w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), t = u = 0; t < n.length; t++)if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++)u =
                            Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t); else u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y)), u < w && (w = u, A = t); y = n[A]; b = 0; if ("rangeColumn" === this.parent.dataSeries[A].type || "rangeArea" === this.parent.dataSeries[A].type || "error" === this.parent.dataSeries[A].type || "rangeSplineArea" === this.parent.dataSeries[A].type || "candlestick" === this.parent.dataSeries[A].type || "ohlc" === this.parent.dataSeries[A].type || "boxAndWhisker" === this.parent.dataSeries[A].type) {
                              w =
                              ...
                              w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)); x = u = 0; for (t = A; 0 <= t; t--)x += n[t].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(x)), u < w && (w = u, b = t); v = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x) << 0) + 0.5 : this.parent.convertValueToPixel(x) << 0; k.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options, crosshair: this.options, value: y.dataPoint.y
                              }) : r(this.options.label) ? ha(r(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label; this.value = x
                            } else if ("stackedColumn100" === this.parent.dataSeries[A].type || "stackedArea100" === this.parent.dataSeries[A].type) {
                              w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)); x = u = 0; for (t = A; 0 <= t; t--)x += n[t].dataPoint.y, B = n[t].dataPoint.x.getTime ? n[t].dataPoint.x.getTime() : n[t].dataPoint.x, B = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[B]),
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = m = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, h = this.chart.plotArea.y2, this.bounds = { x1: b - p / 2, y1: f, x2: e + p / 2, y2: h }; else if ("left" === this.parent._position || "right" === this.parent._position) f = h = v = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0, b = this.chart.plotArea.x1, e = this.chart.plotArea.x2, this.bounds = { x1: b, y1: f - p / 2, x2: e, y2: h + p / 2 }; if ("xySwapped" === this.chart.plotInfo.axisPlacement) if ("left" ===
              ...
              B = !1; if (this.parent.labels) for (n = Math.ceil(this.parent.interval), t = 0; t < this.parent.viewportMaximum; t += n)if (this.parent.labels[t]) B = !0; else { B = !1; break } if (B) {
                if ("axisX" === this.parent.type) for (t = this.parent.convertPixelToValue({ y: d }), w = null, A = 0; A < this.parent.dataSeries.length; A++)(w = this.parent.dataSeries[A].getDataPointAtX(t, !0)) && 0 <= w.index && (k.text = this.labelFormatter ? this.labelFormatter({
              ...
              } else "dateTime" === this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(d) : c }) : r(this.options.label) ? Ba(r(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
                chart: this.chart,
                axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(d) : c
              }) : r(this.options.label) ? ha(r(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label); k.y = d + k.fontSize / 2 - k.measureText().height / 2 + 2; k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y = this.chart.bounds.y1 + k.fontSize / 2 + 2 : k.y + k.measureText().height - k.fontSize / 2 > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.measureText().height + k.fontSize / 2); "left" === this.parent._position ?
                k.x = this.parent.lineCoordinates.x1 - k.measureText().width : "right" === this.parent._position && (k.x = this.parent.lineCoordinates.x2)
            } else {
              if ("bottom" === this.parent._position || "top" === this.parent._position) k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(a) : c }) : r(this.options.label) ? ha(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label, k.x = b - k.measureText().width /
              ...
              B = !1; n = ""; if (this.parent.labels) for (n = Math.ceil(this.parent.interval), t = 0; t < this.parent.viewportMaximum; t += n)if (this.parent.labels[t]) B =
                !0; else { B = !1; break } if (B) { if ("axisX" === this.parent.type) for (t = this.parent.convertPixelToValue({ x: a }), w = null, A = 0; A < this.parent.dataSeries.length; A++)(w = this.parent.dataSeries[A].getDataPointAtX(t, !0)) && 0 <= w.index && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(a) : c }) : r(this.options.label) ? r(c) ? w.dataPoint.label : c : this.label) } else "dateTime" === this.parent.valueType ? k.text = this.labelFormatter ?
                  this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(a) : c }) : r(this.options.label) ? Ba(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? 0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) : "" : c }) : r(this.options.label) ?
                    ha(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label); k.x = b - k.measureText().width / 2; k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width); k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1); "bottom" === this.parent._position ? k.y = this.parent.lineCoordinates.y2 + k.fontSize / 2 + 2 : "top" === this.parent._position && (k.y = this.parent.lineCoordinates.y1 - k.height + k.fontSize / 2 + 2)
            ...
            "right" === this.parent._position) this._updatedValue = this.parent.convertPixelToValue(v); this._textBlock = k; r(c) || this.renderLabel(); q.globalAlpha = g
        }; ca.prototype.renderLabel = function () { r(this._textBlock) || (r(this._textBlock.text) || !("number" === typeof this._textBlock.text.valueOf() || 0 < this._textBlock.text.length) || this._hidden) || this._textBlock.render(!0) }; qa($, W); $.prototype._initialize = function () {
          ...
          c = "undefined" === typeof c ? !0 : c; this.container || this._initialize(); this.enabled || this.hide(); if (!this.chart.disableToolTip) {
            if ("undefined" === typeof a || "undefined" === typeof d) { if (isNaN(this._prevX) || isNaN(this._prevY)) return; a = this._prevX; d = this._prevY } else this._prevX = a, this._prevY = d; var b = null, e = null, f = [], h = 0; if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
              var m =
                []; if (this.chart.axisX) for (var w = 0; w < this.chart.axisX.length; w++) { for (var h = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX[w].convertPixelToValue({ y: d }) : this.chart.axisX[w].convertPixelToValue({ x: a }), k = null, b = 0; b < this.chart.axisX[w].dataSeries.length; b++)(k = this.chart.axisX[w].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[w].dataSeries[b], null !== k.dataPoint.y && k.dataSeries.visible && m.push(k)); k = null } if (this.chart.axisX2) for (w = 0; w < this.chart.axisX2.length; w++) {
                  h =
                    "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX2[w].convertPixelToValue({ y: d }) : this.chart.axisX2[w].convertPixelToValue({ x: a }); k = null; for (b = 0; b < this.chart.axisX2[w].dataSeries.length; b++)(k = this.chart.axisX2[w].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[w].dataSeries[b], null !== k.dataPoint.y && k.dataSeries.visible && m.push(k)); k = null
          ...
          function () { return ++this.lastObjectId }; Z.prototype.mouseEventHandler = function (a) {
            ...
            var f = this; this.chart.isAnimating = !0; e = e || N.easing.linear; c && this.animations.push({ startTime: (new Date).getTime() + (a ? a : 0), duration: d, animationCallback: c, onComplete: b }); for (a = []; 0 < this.animations.length;)if (d = this.animations.shift(), c = (new Date).getTime(), b = 0, d.startTime <= c && (b = e(Math.min(c - d.startTime, d.duration), 0, 1, d.duration), b = Math.min(b, 1), isNaN(b) || !isFinite(b)) && (b = 1),
              1 > b && a.push(d), d.animationCallback(b), 1 <= b && d.onComplete) d.onComplete(); this.animations = a; 0 < this.animations.length ? this.animationRequestId = this.chart.requestAnimFrame.call(window, function () { f.animate.call(f) }) : this.chart.isAnimating = !1
          }; ja.prototype.cancelAllAnimations = function () { this.animations = []; this.animationRequestId && this.chart.cancelRequestAnimFrame.call(window, this.animationRequestId); this.animationRequestId = null; this.chart.isAnimating = !1 }; var N = {
